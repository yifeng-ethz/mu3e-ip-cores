...
namespace eval ::fe_scifi::board_bring_up::csr_meta::mts_processor::v26_0_9_0501 {}

proc ::fe_scifi::board_bring_up::csr_meta::mts_processor::v26_0_9_0501::get_metadata {} {
    set registers [list \
        [::fe_scifi::board_bring_up::csr_meta::register \
            ...
            [list \
                ...
                [::fe_scifi::board_bring_up::csr_meta::field "drop_delay_error" "Drop hit_type1 payload beats whose timestamp-delay error sideband is asserted; default forwards marked hits to downstream filters." {[5:5]} "read-write"] \
        ...
        [::fe_scifi::board_bring_up::csr_meta::register \
            ...
            "0x8" \
            [list \
                [::fe_scifi::board_bring_up::csr_meta::field "expected_latency" "Expected hit latency. Default is 2000 and does not tune overflow lookback." {[31:0]} "read-write"]]] \
        [::fe_scifi::board_bring_up::csr_meta::register \
            "total_hit_cnt_hi" \
        ...
        [::fe_scifi::board_bring_up::csr_meta::register \
            ...
            "Post-wrap epoch-disambiguation lookback in 8 ns units." \
            "0x14" \
            [list \
                [::fe_scifi::board_bring_up::csr_meta::field "overflow_lookback" "Runtime lapse/overflow lookback. Writes are clamped by the MTS IP to the non-negative MuTRiG wrap range." {[31:0]} "read-write"]]]]
