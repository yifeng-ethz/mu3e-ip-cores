...
namespace eval ::fe_scifi::board_bring_up::csr_meta::histogram_statistics::v26_1_4_0429 {}

proc ::fe_scifi::board_bring_up::csr_meta::histogram_statistics::v26_1_4_0429::get_metadata {} {
    set registers [list \
        ...
        [::fe_scifi::board_bring_up::csr_meta::register \
            ...
            [list \
                ...
                [::fe_scifi::board_bring_up::csr_meta::field "mode" "Histogram operating mode selector. Negative two's-complement values select debug inputs." {[7:4]} "read-write"] \
