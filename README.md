...
| [**MuTRiG Lane Source Mux**](./misc/mutrig_lane_source_mux/) | Runtime CSR per-lane selector and diagnostic counter block for real MuTRiG, emulator, or mixed FEB datapath bring-up. | <img src="https://img.shields.io/badge/version-26.1.0.0427-blue" alt="version 26.1.0.0427 badge" width="200" /> | [Contract](firmware_builds/doc/CONTRACT.md) |
