...
|---|---|:---:|:---:|:---:|:---:|
| [**Altera Temperature Sensor Controller**](https://github.com/yifeng-ethz/alt_temp_sense_controller) | Wraps the on-chip alt_temp_sense IP on 28 nm devices and stores the last temperature result. | `1.1` | 2026-04-27 | — | `ddf0332d` |
| [**Board Test System**](https://github.com/yifeng-ethz/board_test_system) | DAQ bring-up and management-plane test system for exercising FPGA registers, links, and board services during validation. | `Prototype` | 2025-12-17 | Prototype / no VERSION surface | `8c6c9aae` |
| [**CAM (Content Addressable Memory)**](https://github.com/yifeng-ethz/CAM) | Primitive content-addressable memory core. Use as a building block for caches, correlators and address decoders. | `Prototype` | 2024-08-22 | — | `0cebc03e` (HEAD) |
| [**Charge Injection (MuTRiG Injector)**](https://github.com/yifeng-ethz/charge_injection) | Generates calibration pulses and digital/analog stimuli for MuTRiG injection tests. | `26.0.3.0429` | 2026-04-29 | — | `78d780e7` (codex/phase5-checkpoint-20260429-195949) |
| [**FEB MAX10 Communication Bridge**](https://github.com/yifeng-ethz/feb_max10_comm) | FEB-side Arria V bridge that stages one flash page, crosses it into the MAX10 link domain, and preserves the downstream FEBSPI programming contract. | `Prototype` | 2026-04-27 | — | `419010a0` (main) |
| [**Firefly Transceiver I2C Master**](https://github.com/yifeng-ethz/firefly_xcvr_i2c_master) | Interfaces with the Samtec Firefly optical transceiver module via I2C. Periodically reads temperature and RX power and can be halted. | `26.0.330` | 2026-04-27 | — | `28658f08` |
| [**Frontend-Board Frame Assembly**](https://github.com/yifeng-ethz/feb_frame_assembly) | Assembles time-interleaved subframes from the ring-buffer CAM into Mu3e-standard data frames and schedules packet transmission. | `26.0.328` | 2026-04-27 | — | `2e94a89f` |
| [**High Performance Counter Array**](https://github.com/yifeng-ethz/high_performance_counter_array) | Parallel counters supporting concurrent inputs with Avalon-MM readout. Features synchronous clear and reset. | `1.4.1` | 2026-04-27 | — | `2f9e12f2` (codex/toolkit-infra-paths) |
| [**Histogram Statistics**](https://github.com/yifeng-ethz/histogram_statistics) | Builds histograms from a selected data stream using SAR bin calculation and DP-RAM counters. | `26.0.2.0425` | 2026-04-29 | [DV](https://github.com/yifeng-ethz/histogram_statistics/blob/c035c35a96478387e21d692c2a17554bcff20806/VERIFICATION_SIGNOFF.md) / [Syn](https://github.com/yifeng-ethz/histogram_statistics/blob/c035c35a96478387e21d692c2a17554bcff20806/SYNTHESIS_SIGNOFF.md) | `c035c35a` (codex/phase5-checkpoint-20260429-195949) |
| [**IP 8b/10b Decoder**](https://github.com/yifeng-ethz/ip_8b10b_decoder) | Standard 8b/10b decoder for parallel LVDS rxout data. Derives parity and decoding errors. | `Prototype` | 2024-08-23 | — | `5d6dfcd0` (HEAD) |
| [**LVDS Error Counter Fabric**](https://github.com/yifeng-ethz/lvds_error_counter_fabric) | Accumulates parity and decode error counts from the LVDS receiver sideband. | `Prototype` | 2024-08-23 | — | `24977182` |
| [**Mu3e LVDS Controller**](https://github.com/yifeng-ethz/mu3e_lvds_controller) | Provides high-speed LVDS links to the MuPix sensors using FPGA vendor IP. Includes 28 nm LVDS RX and Pro variants. | `26.2.1.0506` | 2026-05-06 | — | `1a7e96a2` (codex/lvds-controller-svd) |
| [**MuPix Inbound**](https://github.com/yifeng-ethz/mupix_inbound) | Deserializes data from MuPix chips, decodes and buffers hits. | `Prototype` | 2025-06-30 | — | `618cb636` |
| [**MuTRiG Channel Counter Fabric**](https://github.com/yifeng-ethz/mutrig_channel_counter_fabric) | Connects hit type 0 from the frame deassembly IP to the counter array. Decodes channel IDs into one-hot update signals. | `1.0.0` | 2026-04-27 | — | `67b1d86e` |
| [**MuTRiG Controller**](https://github.com/yifeng-ethz/mutrig_controller) | SPI master for configuring MuTRiG ASICs. Automatically scans T- and E-thresholds and stores results locally. | `24.0.817` | 2026-04-27 | — | `6f33fc1a` |
| [**MuTRiG Emulator**](https://github.com/yifeng-ethz/emulator_mutrig) | FPGA emulator of MuTRiG 3 ASIC digital output. Produces 8b/1k frames bit-compatible with real ASIC output for FPGA-internal verification. | `26.1.13.0425` | 2026-05-10 | [Standalone](https://github.com/yifeng-ethz/emulator_mutrig/blob/d20aa6ab4d130c435c4e0adaa587dbe0dd7299d4/doc/SIGNOFF.md) | `8152797e` (main) |
| [**MuTRiG Frame Deassembly**](https://github.com/yifeng-ethz/mutrig_frame_deassembly) | Parses MuTRiG frames into header and hit payloads and flags individual hit errors and frame CRC errors. | `26.1.0.0506` | 2026-05-06 | [DV](https://github.com/yifeng-ethz/mutrig_frame_deassembly/blob/92ef8fe50e9e0b0e9d2911f3b747f385157f6cfb/tb/DV_REPORT.md) | `d61762a8` |
| [**MuTRiG Reset Controller**](https://github.com/yifeng-ethz/mutrig_reset_controller) | Issues reset pulses for the MuTRiG based on run-state changes. Provides programmable phase shift via alt_pll_reconfig. | `1.0.8` | 2026-04-29 | — | `16eb065c` (codex/phase5-checkpoint-20260429-195949) |
| [**MuTRiG Timestamp Processor**](https://github.com/yifeng-ethz/mutrig_timestamp_processor) | Tracks MuTRiG timestamp overflow and maps MuTRiG-local timestamps to global timestamps. | `26.1.0.0506` | 2026-05-10 | [DV](https://github.com/yifeng-ethz/mutrig_timestamp_processor/blob/16c0282748d3f2bd59a5d7759238e652ae14b9d8/tb/DV_REPORT.md) | `4d800456` |
| [**Onewire Temperature Sensor Controller**](https://github.com/yifeng-ethz/onewire_temp_sense) | Periodically polls 1-Wire temperature sensors; implements reset, presence detect and bit-level timing. | `26.2.1` | 2026-04-28 | — | `501ade8d` |
| [**Packet Scheduler**](https://github.com/yifeng-ethz/packet_scheduler) | Orders packets via an interface adapter and ordered-priority queues to achieve deterministic DAQ multiplexing. | `26.5.1.0509` | 2026-05-10 | [DV](https://github.com/yifeng-ethz/packet_scheduler/blob/ed249da8c251cebcde33d69e0b1fb35fc03fc232/doc/VERIFICATION_SIGNOFF.md) | `d487f955` |
| [**Ring-buffer CAM**](https://github.com/yifeng-ethz/ring-buffer_cam) | Circular buffer variant of CAM with push-to-stack write semantics and cache-like read-through. Used to build the hit stack. | `26.2.7.0506` | 2026-05-08 | [Standalone](https://github.com/yifeng-ethz/ring-buffer_cam/blob/d40779350403be8862fb1e57f5c9f8d449081b2b/doc/SIGNOFF.md) | `b9672f61` |
| [**Run-Control Management**](https://github.com/yifeng-ethz/run-control_mgmt) | Manages run-state transitions for Mu3e subsystems and issues control signals. v26 adds the CSR LOCAL_CMD command-injection window and a readyless 9-bit fanout. | `26.3.0.0505` | 2026-05-05 | — | `1c668a8e` |
| [**Slow-Control Hub**](https://github.com/yifeng-ethz/slow-control_hub) | Converts Mu3e slow-control packets into Avalon Memory-Mapped transactions and handles burst count, address and response timing. | `26.6.9.0414` | 2026-04-27 | [DV](https://github.com/yifeng-ethz/slow-control_hub/blob/0c0fb5ddc20fb7051e54b59c550b1fe08f76c68c/doc/VERIFICATION_SIGNOFF.md) / [Syn](https://github.com/yifeng-ethz/slow-control_hub/blob/0c0fb5ddc20fb7051e54b59c550b1fe08f76c68c/doc/SYNTHESIS_SIGNOFF.md) | `0c0fb5dd` |
