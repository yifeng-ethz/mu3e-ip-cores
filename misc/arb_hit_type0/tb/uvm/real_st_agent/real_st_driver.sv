class real_st_driver extends uvm_driver #(hit_type0_seq_item);
  `uvm_component_utils(real_st_driver)

  virtual arb_hit_type0_hit_if vif;

  function new(string name = "real_st_driver", uvm_component parent = null);
