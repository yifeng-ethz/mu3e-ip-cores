// debug_l2_sidecar_monitor.sv
// DEBUG_LEVEL=2 sidecar monitor at emulator L2 commit.

package tb_int_debug_l2_sidecar_monitor_pkg;
    ...
    class debug_l2_sidecar_monitor extends uvm_component;
        `uvm_component_utils(debug_l2_sidecar_monitor)
        ...
        virtual function void build_phase(uvm_phase phase);
            ...
            if (!uvm_config_db#(virtual mutrig_l2_commit_if)::get(this, "", "vif", vif))
                `uvm_info("DBG_L2", "mutrig_l2_commit_if not configured; monitor disabled", UVM_LOW)
        endfunction
        ...
        virtual task run_phase(uvm_phase phase);
            ...
            forever begin
                ...
                if (vif.valid === 1'b1 && (vif.hit_id_valid || vif.root_hit_id_valid)) begin
                    ...
                    rec = hit_record::type_id::create("debug_l2_hit");
