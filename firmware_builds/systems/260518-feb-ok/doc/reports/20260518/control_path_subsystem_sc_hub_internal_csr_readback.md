...
| `+0x01C` | `GTS_SNAP_LO` | _(no reset declared)_ — Global-timestamp snapshot low word. | — | `0x89C405C1` / `0xFEE2B4D8` | BURST≠SINGLE |
| `+0x020` | `GTS_SNAP_HI` | _(no reset declared)_ — Global-timestamp snapshot high word. Reading this register captures a fresh snapshot. | — | `0x000000E2` / `0x000000EB` | BURST≠SINGLE |
...
| `+0x03C` | `EXT_PKT_RD` | _(no reset declared)_ — External read packet counter. | — | `0x00002873` / `0x00002873` | no-svd-reset |
