...
| `+0x004` | `OFFSET` | _(no reset declared)_ — Scratchpad/configuration memory offset word used by the MuTRiG controller RPC engine. | — | `0x00000000` / `0x00000000` | no-svd-reset |
