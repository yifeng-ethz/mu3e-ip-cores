...
// Version : 26.2.0
// Date    : 20260504
// Change  : Add reusable post-rbCAM monitor shell.
...
package tb_int_rbcam_egress_monitor_pkg;
    ...
    class rbcam_egress_monitor extends uvm_component;
        `uvm_component_utils(rbcam_egress_monitor)
        ...
        virtual function void build_phase(uvm_phase phase);
            ...
            if (!uvm_config_db#(virtual hit_tap_if)::get(this, "", "vif", vif))
                `uvm_fatal("RBCAM_MON", "hit_tap_if not found")
        endfunction
        ...
        virtual task run_phase(uvm_phase phase);
            forever begin
                ...
                if (vif.valid === 1'b1) begin
                    ...
                    rec = hit_record::type_id::create("post_rbcam_hit");
