// prof_rc_020_watchdog_overlap_offset_03_seq.sv
...
package prof_rc_020_watchdog_overlap_offset_03_seq_pkg;
    ...
    class prof_rc_020_watchdog_overlap_offset_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_020_watchdog_overlap_offset_03_seq)
        ...
        function new(string name = "prof_rc_020_watchdog_overlap_offset_03_seq");
            super.new(name);
            case_id = "PROF-RC-020";
            case_name = "watchdog_overlap_offset_03";
            case_number = 20;
