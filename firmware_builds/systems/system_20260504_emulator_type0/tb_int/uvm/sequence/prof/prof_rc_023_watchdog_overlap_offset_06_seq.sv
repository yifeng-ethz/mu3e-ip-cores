// prof_rc_023_watchdog_overlap_offset_06_seq.sv
...
package prof_rc_023_watchdog_overlap_offset_06_seq_pkg;
    ...
    class prof_rc_023_watchdog_overlap_offset_06_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_023_watchdog_overlap_offset_06_seq)
        ...
        function new(string name = "prof_rc_023_watchdog_overlap_offset_06_seq");
            super.new(name);
            case_id = "PROF-RC-023";
            case_name = "watchdog_overlap_offset_06";
            case_number = 23;
