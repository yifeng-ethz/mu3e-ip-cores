// prof_dt_025_poisson_emu_2mhz_cluster2_seq.sv
...
package prof_dt_025_poisson_emu_2mhz_cluster2_seq_pkg;
    ...
    class prof_dt_025_poisson_emu_2mhz_cluster2_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_025_poisson_emu_2mhz_cluster2_seq)
        ...
        function new(string name = "prof_dt_025_poisson_emu_2mhz_cluster2_seq");
            super.new(name);
            case_id = "PROF-DT-025";
            case_name = "poisson_emu_2mhz_cluster2";
            case_number = 25;
