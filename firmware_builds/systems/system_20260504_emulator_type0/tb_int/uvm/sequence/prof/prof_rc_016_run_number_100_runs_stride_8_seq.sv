// prof_rc_016_run_number_100_runs_stride_8_seq.sv
...
package prof_rc_016_run_number_100_runs_stride_8_seq_pkg;
    ...
    class prof_rc_016_run_number_100_runs_stride_8_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_016_run_number_100_runs_stride_8_seq)
        ...
        function new(string name = "prof_rc_016_run_number_100_runs_stride_8_seq");
            super.new(name);
            case_id = "PROF-RC-016";
            case_name = "run_number_100_runs_stride_8";
            case_number = 16;
