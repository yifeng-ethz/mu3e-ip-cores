// prof_dt_090_long_soak_run_bump_emu_03_seq.sv
...
package prof_dt_090_long_soak_run_bump_emu_03_seq_pkg;
    ...
    class prof_dt_090_long_soak_run_bump_emu_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_090_long_soak_run_bump_emu_03_seq)
        ...
        function new(string name = "prof_dt_090_long_soak_run_bump_emu_03_seq");
            super.new(name);
            case_id = "PROF-DT-090";
            case_name = "long_soak_run_bump_emu_03";
            case_number = 90;
