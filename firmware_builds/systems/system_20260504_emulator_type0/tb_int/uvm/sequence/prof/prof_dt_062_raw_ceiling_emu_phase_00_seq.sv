// prof_dt_062_raw_ceiling_emu_phase_00_seq.sv
...
package prof_dt_062_raw_ceiling_emu_phase_00_seq_pkg;
    ...
    class prof_dt_062_raw_ceiling_emu_phase_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_062_raw_ceiling_emu_phase_00_seq)
        ...
        function new(string name = "prof_dt_062_raw_ceiling_emu_phase_00_seq");
            super.new(name);
            case_id = "PROF-DT-062";
            case_name = "raw_ceiling_emu_phase_00";
            case_number = 62;
