// prof_dt_070_raw_ceiling_emu_phase_04_seq.sv
...
package prof_dt_070_raw_ceiling_emu_phase_04_seq_pkg;
    ...
    class prof_dt_070_raw_ceiling_emu_phase_04_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_070_raw_ceiling_emu_phase_04_seq)
        ...
        function new(string name = "prof_dt_070_raw_ceiling_emu_phase_04_seq");
            super.new(name);
            case_id = "PROF-DT-070";
            case_name = "raw_ceiling_emu_phase_04";
            case_number = 70;
