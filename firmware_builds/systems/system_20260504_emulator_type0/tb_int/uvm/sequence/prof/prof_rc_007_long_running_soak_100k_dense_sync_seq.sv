// prof_rc_007_long_running_soak_100k_dense_sync_seq.sv
...
package prof_rc_007_long_running_soak_100k_dense_sync_seq_pkg;
    ...
    class prof_rc_007_long_running_soak_100k_dense_sync_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_007_long_running_soak_100k_dense_sync_seq)
        ...
        function new(string name = "prof_rc_007_long_running_soak_100k_dense_sync_seq");
            super.new(name);
            case_id = "PROF-RC-007";
            case_name = "long_running_soak_100k_dense_sync";
            case_number = 7;
