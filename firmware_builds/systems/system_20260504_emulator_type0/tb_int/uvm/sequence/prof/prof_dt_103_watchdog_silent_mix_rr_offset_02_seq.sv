// prof_dt_103_watchdog_silent_mix_rr_offset_02_seq.sv
...
package prof_dt_103_watchdog_silent_mix_rr_offset_02_seq_pkg;
    ...
    class prof_dt_103_watchdog_silent_mix_rr_offset_02_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_103_watchdog_silent_mix_rr_offset_02_seq)
        ...
        function new(string name = "prof_dt_103_watchdog_silent_mix_rr_offset_02_seq");
            super.new(name);
            case_id = "PROF-DT-103";
            case_name = "watchdog_silent_mix_rr_offset_02";
            case_number = 103;
