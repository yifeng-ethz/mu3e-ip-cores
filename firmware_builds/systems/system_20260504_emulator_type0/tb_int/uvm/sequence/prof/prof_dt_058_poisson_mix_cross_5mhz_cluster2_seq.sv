// prof_dt_058_poisson_mix_cross_5mhz_cluster2_seq.sv
...
package prof_dt_058_poisson_mix_cross_5mhz_cluster2_seq_pkg;
    ...
    class prof_dt_058_poisson_mix_cross_5mhz_cluster2_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_058_poisson_mix_cross_5mhz_cluster2_seq)
        ...
        function new(string name = "prof_dt_058_poisson_mix_cross_5mhz_cluster2_seq");
            super.new(name);
            case_id = "PROF-DT-058";
            case_name = "poisson_mix_cross_5mhz_cluster2";
            case_number = 58;
