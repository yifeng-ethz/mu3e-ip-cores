// prof_sc_028_concurrent_dt_peak_stride_4_seq.sv
...
package prof_sc_028_concurrent_dt_peak_stride_4_seq_pkg;
    ...
    class prof_sc_028_concurrent_dt_peak_stride_4_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_028_concurrent_dt_peak_stride_4_seq)
        ...
        function new(string name = "prof_sc_028_concurrent_dt_peak_stride_4_seq");
            super.new(name);
            case_id = "PROF-SC-028";
            case_name = "concurrent_dt_peak_stride_4";
            case_number = 28;
