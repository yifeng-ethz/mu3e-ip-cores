// prof_sc_007_single_word_10k_stride_7_seq.sv
...
package prof_sc_007_single_word_10k_stride_7_seq_pkg;
    ...
    class prof_sc_007_single_word_10k_stride_7_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_007_single_word_10k_stride_7_seq)
        ...
        function new(string name = "prof_sc_007_single_word_10k_stride_7_seq");
            super.new(name);
            case_id = "PROF-SC-007";
            case_name = "single_word_10k_stride_7";
            case_number = 7;
