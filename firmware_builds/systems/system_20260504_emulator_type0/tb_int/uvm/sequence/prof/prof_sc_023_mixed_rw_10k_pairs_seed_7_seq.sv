// prof_sc_023_mixed_rw_10k_pairs_seed_7_seq.sv
...
package prof_sc_023_mixed_rw_10k_pairs_seed_7_seq_pkg;
    ...
    class prof_sc_023_mixed_rw_10k_pairs_seed_7_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_023_mixed_rw_10k_pairs_seed_7_seq)
        ...
        function new(string name = "prof_sc_023_mixed_rw_10k_pairs_seed_7_seq");
            super.new(name);
            case_id = "PROF-SC-023";
            case_name = "mixed_rw_10k_pairs_seed_7";
            case_number = 23;
