// prof_rc_015_run_number_100_runs_stride_7_seq.sv
...
package prof_rc_015_run_number_100_runs_stride_7_seq_pkg;
    ...
    class prof_rc_015_run_number_100_runs_stride_7_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_015_run_number_100_runs_stride_7_seq)
        ...
        function new(string name = "prof_rc_015_run_number_100_runs_stride_7_seq");
            super.new(name);
            case_id = "PROF-RC-015";
            case_name = "run_number_100_runs_stride_7";
            case_number = 15;
