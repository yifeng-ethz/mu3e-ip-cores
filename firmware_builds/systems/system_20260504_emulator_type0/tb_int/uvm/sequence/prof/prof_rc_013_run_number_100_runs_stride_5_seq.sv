// prof_rc_013_run_number_100_runs_stride_5_seq.sv
...
package prof_rc_013_run_number_100_runs_stride_5_seq_pkg;
    ...
    class prof_rc_013_run_number_100_runs_stride_5_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_013_run_number_100_runs_stride_5_seq)
        ...
        function new(string name = "prof_rc_013_run_number_100_runs_stride_5_seq");
            super.new(name);
            case_id = "PROF-RC-013";
            case_name = "run_number_100_runs_stride_5";
            case_number = 13;
