// prof_dt_071_raw_ceiling_real_phase_05_seq.sv
...
package prof_dt_071_raw_ceiling_real_phase_05_seq_pkg;
    ...
    class prof_dt_071_raw_ceiling_real_phase_05_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_071_raw_ceiling_real_phase_05_seq)
        ...
        function new(string name = "prof_dt_071_raw_ceiling_real_phase_05_seq");
            super.new(name);
            case_id = "PROF-DT-071";
            case_name = "raw_ceiling_real_phase_05";
            case_number = 71;
