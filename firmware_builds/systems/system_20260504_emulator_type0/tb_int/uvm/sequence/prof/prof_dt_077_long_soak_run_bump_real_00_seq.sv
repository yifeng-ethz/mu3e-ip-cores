// prof_dt_077_long_soak_run_bump_real_00_seq.sv
...
package prof_dt_077_long_soak_run_bump_real_00_seq_pkg;
    ...
    class prof_dt_077_long_soak_run_bump_real_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_077_long_soak_run_bump_real_00_seq)
        ...
        function new(string name = "prof_dt_077_long_soak_run_bump_real_00_seq");
            super.new(name);
            case_id = "PROF-DT-077";
            case_name = "long_soak_run_bump_real_00";
            case_number = 77;
