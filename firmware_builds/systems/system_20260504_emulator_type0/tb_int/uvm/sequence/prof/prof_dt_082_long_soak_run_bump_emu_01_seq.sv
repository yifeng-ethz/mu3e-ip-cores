// prof_dt_082_long_soak_run_bump_emu_01_seq.sv
...
package prof_dt_082_long_soak_run_bump_emu_01_seq_pkg;
    ...
    class prof_dt_082_long_soak_run_bump_emu_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_082_long_soak_run_bump_emu_01_seq)
        ...
        function new(string name = "prof_dt_082_long_soak_run_bump_emu_01_seq");
            super.new(name);
            case_id = "PROF-DT-082";
            case_name = "long_soak_run_bump_emu_01";
            case_number = 82;
