// prof_dt_051_poisson_mix_cross_500khz_cluster8_seq.sv
...
package prof_dt_051_poisson_mix_cross_500khz_cluster8_seq_pkg;
    ...
    class prof_dt_051_poisson_mix_cross_500khz_cluster8_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_051_poisson_mix_cross_500khz_cluster8_seq)
        ...
        function new(string name = "prof_dt_051_poisson_mix_cross_500khz_cluster8_seq");
            super.new(name);
            case_id = "PROF-DT-051";
            case_name = "poisson_mix_cross_500khz_cluster8";
            case_number = 51;
