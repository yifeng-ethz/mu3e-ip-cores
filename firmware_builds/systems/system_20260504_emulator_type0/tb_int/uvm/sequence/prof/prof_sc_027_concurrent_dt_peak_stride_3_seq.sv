// prof_sc_027_concurrent_dt_peak_stride_3_seq.sv
...
package prof_sc_027_concurrent_dt_peak_stride_3_seq_pkg;
    ...
    class prof_sc_027_concurrent_dt_peak_stride_3_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_027_concurrent_dt_peak_stride_3_seq)
        ...
        function new(string name = "prof_sc_027_concurrent_dt_peak_stride_3_seq");
            super.new(name);
            case_id = "PROF-SC-027";
            case_name = "concurrent_dt_peak_stride_3";
            case_number = 27;
