// prof_dt_127_hist_saturation_mix_rr_bin_04_seq.sv
...
package prof_dt_127_hist_saturation_mix_rr_bin_04_seq_pkg;
    ...
    class prof_dt_127_hist_saturation_mix_rr_bin_04_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_127_hist_saturation_mix_rr_bin_04_seq)
        ...
        function new(string name = "prof_dt_127_hist_saturation_mix_rr_bin_04_seq");
            super.new(name);
            case_id = "PROF-DT-127";
            case_name = "hist_saturation_mix_rr_bin_04";
            case_number = 127;
