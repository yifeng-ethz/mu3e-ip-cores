// prof_rc_022_watchdog_overlap_offset_05_seq.sv
...
package prof_rc_022_watchdog_overlap_offset_05_seq_pkg;
    ...
    class prof_rc_022_watchdog_overlap_offset_05_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_022_watchdog_overlap_offset_05_seq)
        ...
        function new(string name = "prof_rc_022_watchdog_overlap_offset_05_seq");
            super.new(name);
            case_id = "PROF-RC-022";
            case_name = "watchdog_overlap_offset_05";
            case_number = 22;
