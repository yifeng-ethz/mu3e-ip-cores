// prof_dt_101_watchdog_silent_real_offset_02_seq.sv
...
package prof_dt_101_watchdog_silent_real_offset_02_seq_pkg;
    ...
    class prof_dt_101_watchdog_silent_real_offset_02_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_101_watchdog_silent_real_offset_02_seq)
        ...
        function new(string name = "prof_dt_101_watchdog_silent_real_offset_02_seq");
            super.new(name);
            case_id = "PROF-DT-101";
            case_name = "watchdog_silent_real_offset_02";
            case_number = 101;
