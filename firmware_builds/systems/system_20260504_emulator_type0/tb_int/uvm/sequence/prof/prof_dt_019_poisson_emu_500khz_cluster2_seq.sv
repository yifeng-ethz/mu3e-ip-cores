// prof_dt_019_poisson_emu_500khz_cluster2_seq.sv
...
package prof_dt_019_poisson_emu_500khz_cluster2_seq_pkg;
    ...
    class prof_dt_019_poisson_emu_500khz_cluster2_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_019_poisson_emu_500khz_cluster2_seq)
        ...
        function new(string name = "prof_dt_019_poisson_emu_500khz_cluster2_seq");
            super.new(name);
            case_id = "PROF-DT-019";
            case_name = "poisson_emu_500khz_cluster2";
            case_number = 19;
