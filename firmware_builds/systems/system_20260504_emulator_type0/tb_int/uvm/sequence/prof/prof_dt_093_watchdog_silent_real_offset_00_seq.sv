// prof_dt_093_watchdog_silent_real_offset_00_seq.sv
...
package prof_dt_093_watchdog_silent_real_offset_00_seq_pkg;
    ...
    class prof_dt_093_watchdog_silent_real_offset_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_093_watchdog_silent_real_offset_00_seq)
        ...
        function new(string name = "prof_dt_093_watchdog_silent_real_offset_00_seq");
            super.new(name);
            case_id = "PROF-DT-093";
            case_name = "watchdog_silent_real_offset_00";
            case_number = 93;
