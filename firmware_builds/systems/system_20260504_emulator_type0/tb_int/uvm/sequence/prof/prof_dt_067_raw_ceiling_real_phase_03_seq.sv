// prof_dt_067_raw_ceiling_real_phase_03_seq.sv
...
package prof_dt_067_raw_ceiling_real_phase_03_seq_pkg;
    ...
    class prof_dt_067_raw_ceiling_real_phase_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_067_raw_ceiling_real_phase_03_seq)
        ...
        function new(string name = "prof_dt_067_raw_ceiling_real_phase_03_seq");
            super.new(name);
            case_id = "PROF-DT-067";
            case_name = "raw_ceiling_real_phase_03";
            case_number = 67;
