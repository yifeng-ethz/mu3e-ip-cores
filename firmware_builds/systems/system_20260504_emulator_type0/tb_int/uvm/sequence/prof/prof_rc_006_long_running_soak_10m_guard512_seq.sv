// prof_rc_006_long_running_soak_10m_guard512_seq.sv
...
package prof_rc_006_long_running_soak_10m_guard512_seq_pkg;
    ...
    class prof_rc_006_long_running_soak_10m_guard512_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_006_long_running_soak_10m_guard512_seq)
        ...
        function new(string name = "prof_rc_006_long_running_soak_10m_guard512_seq");
            super.new(name);
            case_id = "PROF-RC-006";
            case_name = "long_running_soak_10m_guard512";
            case_number = 6;
            case_kind = CASE_KIND_RC;
            group_index = 0;
            variant_index = 5;
            running_cycles = 10000000;
            hit_count = 64;
            sc_ops = 0;
            rate_hz = 0;
            cluster_size = 1;
