// prof_dt_111_hist_saturation_mix_rr_bin_00_seq.sv
...
package prof_dt_111_hist_saturation_mix_rr_bin_00_seq_pkg;
    ...
    class prof_dt_111_hist_saturation_mix_rr_bin_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_111_hist_saturation_mix_rr_bin_00_seq)
        ...
        function new(string name = "prof_dt_111_hist_saturation_mix_rr_bin_00_seq");
            super.new(name);
            case_id = "PROF-DT-111";
            case_name = "hist_saturation_mix_rr_bin_00";
            case_number = 111;
