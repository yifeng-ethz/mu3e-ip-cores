// prof_dt_094_watchdog_silent_emu_offset_00_seq.sv
...
package prof_dt_094_watchdog_silent_emu_offset_00_seq_pkg;
    ...
    class prof_dt_094_watchdog_silent_emu_offset_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_094_watchdog_silent_emu_offset_00_seq)
        ...
        function new(string name = "prof_dt_094_watchdog_silent_emu_offset_00_seq");
            super.new(name);
            case_id = "PROF-DT-094";
            case_name = "watchdog_silent_emu_offset_00";
            case_number = 94;
