// prof_rc_008_long_running_soak_1m_dense_sync_seq.sv
...
package prof_rc_008_long_running_soak_1m_dense_sync_seq_pkg;
    ...
    class prof_rc_008_long_running_soak_1m_dense_sync_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_008_long_running_soak_1m_dense_sync_seq)
        ...
        function new(string name = "prof_rc_008_long_running_soak_1m_dense_sync_seq");
            super.new(name);
            case_id = "PROF-RC-008";
            case_name = "long_running_soak_1m_dense_sync";
            case_number = 8;
            case_kind = CASE_KIND_RC;
            group_index = 0;
            variant_index = 7;
            running_cycles = 1000000;
            hit_count = 80;
            sc_ops = 0;
            rate_hz = 0;
            cluster_size = 1;
