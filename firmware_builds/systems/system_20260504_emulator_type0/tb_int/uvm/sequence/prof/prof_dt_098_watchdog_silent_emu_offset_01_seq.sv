// prof_dt_098_watchdog_silent_emu_offset_01_seq.sv
...
package prof_dt_098_watchdog_silent_emu_offset_01_seq_pkg;
    ...
    class prof_dt_098_watchdog_silent_emu_offset_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_098_watchdog_silent_emu_offset_01_seq)
        ...
        function new(string name = "prof_dt_098_watchdog_silent_emu_offset_01_seq");
            super.new(name);
            case_id = "PROF-DT-098";
            case_name = "watchdog_silent_emu_offset_01";
            case_number = 98;
