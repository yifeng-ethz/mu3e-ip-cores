// prof_dt_099_watchdog_silent_mix_rr_offset_01_seq.sv
...
package prof_dt_099_watchdog_silent_mix_rr_offset_01_seq_pkg;
    ...
    class prof_dt_099_watchdog_silent_mix_rr_offset_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_099_watchdog_silent_mix_rr_offset_01_seq)
        ...
        function new(string name = "prof_dt_099_watchdog_silent_mix_rr_offset_01_seq");
            super.new(name);
            case_id = "PROF-DT-099";
            case_name = "watchdog_silent_mix_rr_offset_01";
            case_number = 99;
