// prof_sc_017_mixed_rw_10k_pairs_seed_1_seq.sv
...
package prof_sc_017_mixed_rw_10k_pairs_seed_1_seq_pkg;
    ...
    class prof_sc_017_mixed_rw_10k_pairs_seed_1_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_017_mixed_rw_10k_pairs_seed_1_seq)
        ...
        function new(string name = "prof_sc_017_mixed_rw_10k_pairs_seed_1_seq");
            super.new(name);
            case_id = "PROF-SC-017";
            case_name = "mixed_rw_10k_pairs_seed_1";
            case_number = 17;
