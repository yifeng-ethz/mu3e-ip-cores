// prof_rc_003_long_running_soak_1m_guard128_seq.sv
...
package prof_rc_003_long_running_soak_1m_guard128_seq_pkg;
    ...
    class prof_rc_003_long_running_soak_1m_guard128_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_003_long_running_soak_1m_guard128_seq)
        ...
        function new(string name = "prof_rc_003_long_running_soak_1m_guard128_seq");
            super.new(name);
            case_id = "PROF-RC-003";
            case_name = "long_running_soak_1m_guard128";
            case_number = 3;
