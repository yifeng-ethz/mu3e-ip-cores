// prof_dt_123_hist_saturation_mix_rr_bin_03_seq.sv
...
package prof_dt_123_hist_saturation_mix_rr_bin_03_seq_pkg;
    ...
    class prof_dt_123_hist_saturation_mix_rr_bin_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_123_hist_saturation_mix_rr_bin_03_seq)
        ...
        function new(string name = "prof_dt_123_hist_saturation_mix_rr_bin_03_seq");
            super.new(name);
            case_id = "PROF-DT-123";
            case_name = "hist_saturation_mix_rr_bin_03";
            case_number = 123;
