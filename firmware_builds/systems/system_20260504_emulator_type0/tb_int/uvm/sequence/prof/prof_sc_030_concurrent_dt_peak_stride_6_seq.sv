// prof_sc_030_concurrent_dt_peak_stride_6_seq.sv
...
package prof_sc_030_concurrent_dt_peak_stride_6_seq_pkg;
    ...
    class prof_sc_030_concurrent_dt_peak_stride_6_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_030_concurrent_dt_peak_stride_6_seq)
        ...
        function new(string name = "prof_sc_030_concurrent_dt_peak_stride_6_seq");
            super.new(name);
            case_id = "PROF-SC-030";
            case_name = "concurrent_dt_peak_stride_6";
            case_number = 30;
