// prof_dt_120_hist_saturation_mix_cross_bin_02_seq.sv
...
package prof_dt_120_hist_saturation_mix_cross_bin_02_seq_pkg;
    ...
    class prof_dt_120_hist_saturation_mix_cross_bin_02_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_120_hist_saturation_mix_cross_bin_02_seq)
        ...
        function new(string name = "prof_dt_120_hist_saturation_mix_cross_bin_02_seq");
            super.new(name);
            case_id = "PROF-DT-120";
            case_name = "hist_saturation_mix_cross_bin_02";
            case_number = 120;
