// prof_dt_020_poisson_emu_500khz_cluster4_seq.sv
...
package prof_dt_020_poisson_emu_500khz_cluster4_seq_pkg;
    ...
    class prof_dt_020_poisson_emu_500khz_cluster4_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_020_poisson_emu_500khz_cluster4_seq)
        ...
        function new(string name = "prof_dt_020_poisson_emu_500khz_cluster4_seq");
            super.new(name);
            case_id = "PROF-DT-020";
            case_name = "poisson_emu_500khz_cluster4";
            case_number = 20;
