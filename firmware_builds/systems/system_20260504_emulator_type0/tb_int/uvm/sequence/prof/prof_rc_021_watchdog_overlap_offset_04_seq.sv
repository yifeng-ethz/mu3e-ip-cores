// prof_rc_021_watchdog_overlap_offset_04_seq.sv
...
package prof_rc_021_watchdog_overlap_offset_04_seq_pkg;
    ...
    class prof_rc_021_watchdog_overlap_offset_04_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_021_watchdog_overlap_offset_04_seq)
        ...
        function new(string name = "prof_rc_021_watchdog_overlap_offset_04_seq");
            super.new(name);
            case_id = "PROF-RC-021";
            case_name = "watchdog_overlap_offset_04";
            case_number = 21;
