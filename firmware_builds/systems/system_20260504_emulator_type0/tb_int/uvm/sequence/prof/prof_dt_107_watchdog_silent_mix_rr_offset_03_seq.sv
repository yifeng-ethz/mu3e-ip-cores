// prof_dt_107_watchdog_silent_mix_rr_offset_03_seq.sv
...
package prof_dt_107_watchdog_silent_mix_rr_offset_03_seq_pkg;
    ...
    class prof_dt_107_watchdog_silent_mix_rr_offset_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_107_watchdog_silent_mix_rr_offset_03_seq)
        ...
        function new(string name = "prof_dt_107_watchdog_silent_mix_rr_offset_03_seq");
            super.new(name);
            case_id = "PROF-DT-107";
            case_name = "watchdog_silent_mix_rr_offset_03";
            case_number = 107;
