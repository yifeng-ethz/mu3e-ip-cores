// prof_sc_021_mixed_rw_10k_pairs_seed_5_seq.sv
...
package prof_sc_021_mixed_rw_10k_pairs_seed_5_seq_pkg;
    ...
    class prof_sc_021_mixed_rw_10k_pairs_seed_5_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_021_mixed_rw_10k_pairs_seed_5_seq)
        ...
        function new(string name = "prof_sc_021_mixed_rw_10k_pairs_seed_5_seq");
            super.new(name);
            case_id = "PROF-SC-021";
            case_name = "mixed_rw_10k_pairs_seed_5";
            case_number = 21;
