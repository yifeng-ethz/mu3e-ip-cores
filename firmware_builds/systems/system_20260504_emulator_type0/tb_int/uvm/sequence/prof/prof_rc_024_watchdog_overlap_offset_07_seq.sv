// prof_rc_024_watchdog_overlap_offset_07_seq.sv
...
package prof_rc_024_watchdog_overlap_offset_07_seq_pkg;
    ...
    class prof_rc_024_watchdog_overlap_offset_07_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_024_watchdog_overlap_offset_07_seq)
        ...
        function new(string name = "prof_rc_024_watchdog_overlap_offset_07_seq");
            super.new(name);
            case_id = "PROF-RC-024";
            case_name = "watchdog_overlap_offset_07";
            case_number = 24;
