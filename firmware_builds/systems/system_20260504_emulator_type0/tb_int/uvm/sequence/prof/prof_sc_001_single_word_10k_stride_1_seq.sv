// prof_sc_001_single_word_10k_stride_1_seq.sv
...
package prof_sc_001_single_word_10k_stride_1_seq_pkg;
    ...
    class prof_sc_001_single_word_10k_stride_1_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_001_single_word_10k_stride_1_seq)
        ...
        function new(string name = "prof_sc_001_single_word_10k_stride_1_seq");
            super.new(name);
            case_id = "PROF-SC-001";
            case_name = "single_word_10k_stride_1";
            case_number = 1;
