// prof_dt_076_raw_ceiling_emu_phase_07_seq.sv
...
package prof_dt_076_raw_ceiling_emu_phase_07_seq_pkg;
    ...
    class prof_dt_076_raw_ceiling_emu_phase_07_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_076_raw_ceiling_emu_phase_07_seq)
        ...
        function new(string name = "prof_dt_076_raw_ceiling_emu_phase_07_seq");
            super.new(name);
            case_id = "PROF-DT-076";
            case_name = "raw_ceiling_emu_phase_07";
            case_number = 76;
