// prof_dt_128_hist_saturation_mix_cross_bin_04_seq.sv
...
package prof_dt_128_hist_saturation_mix_cross_bin_04_seq_pkg;
    ...
    class prof_dt_128_hist_saturation_mix_cross_bin_04_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_128_hist_saturation_mix_cross_bin_04_seq)
        ...
        function new(string name = "prof_dt_128_hist_saturation_mix_cross_bin_04_seq");
            super.new(name);
            case_id = "PROF-DT-128";
            case_name = "hist_saturation_mix_cross_bin_04";
            case_number = 128;
