// prof_dt_116_hist_saturation_mix_cross_bin_01_seq.sv
...
package prof_dt_116_hist_saturation_mix_cross_bin_01_seq_pkg;
    ...
    class prof_dt_116_hist_saturation_mix_cross_bin_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_116_hist_saturation_mix_cross_bin_01_seq)
        ...
        function new(string name = "prof_dt_116_hist_saturation_mix_cross_bin_01_seq");
            super.new(name);
            case_id = "PROF-DT-116";
            case_name = "hist_saturation_mix_cross_bin_01";
            case_number = 116;
