// prof_sc_002_single_word_10k_stride_2_seq.sv
...
package prof_sc_002_single_word_10k_stride_2_seq_pkg;
    ...
    class prof_sc_002_single_word_10k_stride_2_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_002_single_word_10k_stride_2_seq)
        ...
        function new(string name = "prof_sc_002_single_word_10k_stride_2_seq");
            super.new(name);
            case_id = "PROF-SC-002";
            case_name = "single_word_10k_stride_2";
            case_number = 2;
