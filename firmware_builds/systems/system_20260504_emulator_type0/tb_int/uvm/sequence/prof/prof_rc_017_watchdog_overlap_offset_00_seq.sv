// prof_rc_017_watchdog_overlap_offset_00_seq.sv
...
package prof_rc_017_watchdog_overlap_offset_00_seq_pkg;
    ...
    class prof_rc_017_watchdog_overlap_offset_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_017_watchdog_overlap_offset_00_seq)
        ...
        function new(string name = "prof_rc_017_watchdog_overlap_offset_00_seq");
            super.new(name);
            case_id = "PROF-RC-017";
            case_name = "watchdog_overlap_offset_00";
            case_number = 17;
