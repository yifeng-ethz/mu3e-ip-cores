// prof_sc_020_mixed_rw_10k_pairs_seed_4_seq.sv
...
package prof_sc_020_mixed_rw_10k_pairs_seed_4_seq_pkg;
    ...
    class prof_sc_020_mixed_rw_10k_pairs_seed_4_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_020_mixed_rw_10k_pairs_seed_4_seq)
        ...
        function new(string name = "prof_sc_020_mixed_rw_10k_pairs_seed_4_seq");
            super.new(name);
            case_id = "PROF-SC-020";
            case_name = "mixed_rw_10k_pairs_seed_4";
            case_number = 20;
