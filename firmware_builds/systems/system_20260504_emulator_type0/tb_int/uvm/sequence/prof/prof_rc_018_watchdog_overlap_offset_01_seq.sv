// prof_rc_018_watchdog_overlap_offset_01_seq.sv
...
package prof_rc_018_watchdog_overlap_offset_01_seq_pkg;
    ...
    class prof_rc_018_watchdog_overlap_offset_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_018_watchdog_overlap_offset_01_seq)
        ...
        function new(string name = "prof_rc_018_watchdog_overlap_offset_01_seq");
            super.new(name);
            case_id = "PROF-RC-018";
            case_name = "watchdog_overlap_offset_01";
            case_number = 18;
