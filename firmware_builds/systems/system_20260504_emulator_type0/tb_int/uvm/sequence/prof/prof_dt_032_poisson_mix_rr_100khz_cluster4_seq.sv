// prof_dt_032_poisson_mix_rr_100khz_cluster4_seq.sv
...
package prof_dt_032_poisson_mix_rr_100khz_cluster4_seq_pkg;
    ...
    class prof_dt_032_poisson_mix_rr_100khz_cluster4_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_032_poisson_mix_rr_100khz_cluster4_seq)
        ...
        function new(string name = "prof_dt_032_poisson_mix_rr_100khz_cluster4_seq");
            super.new(name);
            case_id = "PROF-DT-032";
            case_name = "poisson_mix_rr_100khz_cluster4";
            case_number = 32;
