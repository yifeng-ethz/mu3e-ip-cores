// prof_dt_083_long_soak_run_bump_mix_rr_01_seq.sv
...
package prof_dt_083_long_soak_run_bump_mix_rr_01_seq_pkg;
    ...
    class prof_dt_083_long_soak_run_bump_mix_rr_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_083_long_soak_run_bump_mix_rr_01_seq)
        ...
        function new(string name = "prof_dt_083_long_soak_run_bump_mix_rr_01_seq");
            super.new(name);
            case_id = "PROF-DT-083";
            case_name = "long_soak_run_bump_mix_rr_01";
            case_number = 83;
