// prof_rc_005_long_running_soak_10m_guard128_seq.sv
...
package prof_rc_005_long_running_soak_10m_guard128_seq_pkg;
    ...
    class prof_rc_005_long_running_soak_10m_guard128_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_005_long_running_soak_10m_guard128_seq)
        ...
        function new(string name = "prof_rc_005_long_running_soak_10m_guard128_seq");
            super.new(name);
            case_id = "PROF-RC-005";
            case_name = "long_running_soak_10m_guard128";
            case_number = 5;
