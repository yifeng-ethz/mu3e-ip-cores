// prof_sc_005_single_word_10k_stride_5_seq.sv
...
package prof_sc_005_single_word_10k_stride_5_seq_pkg;
    ...
    class prof_sc_005_single_word_10k_stride_5_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_005_single_word_10k_stride_5_seq)
        ...
        function new(string name = "prof_sc_005_single_word_10k_stride_5_seq");
            super.new(name);
            case_id = "PROF-SC-005";
            case_name = "single_word_10k_stride_5";
            case_number = 5;
