// prof_sc_032_concurrent_dt_peak_stride_8_seq.sv
...
package prof_sc_032_concurrent_dt_peak_stride_8_seq_pkg;
    ...
    class prof_sc_032_concurrent_dt_peak_stride_8_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_032_concurrent_dt_peak_stride_8_seq)
        ...
        function new(string name = "prof_sc_032_concurrent_dt_peak_stride_8_seq");
            super.new(name);
            case_id = "PROF-SC-032";
            case_name = "concurrent_dt_peak_stride_8";
            case_number = 32;
