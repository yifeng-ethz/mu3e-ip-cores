// prof_dt_063_raw_ceiling_real_phase_01_seq.sv
...
package prof_dt_063_raw_ceiling_real_phase_01_seq_pkg;
    ...
    class prof_dt_063_raw_ceiling_real_phase_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_063_raw_ceiling_real_phase_01_seq)
        ...
        function new(string name = "prof_dt_063_raw_ceiling_real_phase_01_seq");
            super.new(name);
            case_id = "PROF-DT-063";
            case_name = "raw_ceiling_real_phase_01";
            case_number = 63;
