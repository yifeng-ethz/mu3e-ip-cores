// prof_dt_066_raw_ceiling_emu_phase_02_seq.sv
...
package prof_dt_066_raw_ceiling_emu_phase_02_seq_pkg;
    ...
    class prof_dt_066_raw_ceiling_emu_phase_02_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_066_raw_ceiling_emu_phase_02_seq)
        ...
        function new(string name = "prof_dt_066_raw_ceiling_emu_phase_02_seq");
            super.new(name);
            case_id = "PROF-DT-066";
            case_name = "raw_ceiling_emu_phase_02";
            case_number = 66;
