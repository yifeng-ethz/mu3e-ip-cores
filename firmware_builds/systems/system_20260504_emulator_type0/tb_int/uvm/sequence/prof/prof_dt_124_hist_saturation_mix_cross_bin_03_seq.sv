// prof_dt_124_hist_saturation_mix_cross_bin_03_seq.sv
...
package prof_dt_124_hist_saturation_mix_cross_bin_03_seq_pkg;
    ...
    class prof_dt_124_hist_saturation_mix_cross_bin_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_124_hist_saturation_mix_cross_bin_03_seq)
        ...
        function new(string name = "prof_dt_124_hist_saturation_mix_cross_bin_03_seq");
            super.new(name);
            case_id = "PROF-DT-124";
            case_name = "hist_saturation_mix_cross_bin_03";
            case_number = 124;
            case_kind = CASE_KIND_DT;
            group_index = 4;
            variant_index = 15;
