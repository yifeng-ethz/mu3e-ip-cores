// prof_dt_039_poisson_mix_rr_1mhz_cluster8_seq.sv
...
package prof_dt_039_poisson_mix_rr_1mhz_cluster8_seq_pkg;
    ...
    class prof_dt_039_poisson_mix_rr_1mhz_cluster8_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_039_poisson_mix_rr_1mhz_cluster8_seq)
        ...
        function new(string name = "prof_dt_039_poisson_mix_rr_1mhz_cluster8_seq");
            super.new(name);
            case_id = "PROF-DT-039";
            case_name = "poisson_mix_rr_1mhz_cluster8";
            case_number = 39;
