// prof_rc_004_long_running_soak_1m_guard512_seq.sv
...
package prof_rc_004_long_running_soak_1m_guard512_seq_pkg;
    ...
    class prof_rc_004_long_running_soak_1m_guard512_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_004_long_running_soak_1m_guard512_seq)
        ...
        function new(string name = "prof_rc_004_long_running_soak_1m_guard512_seq");
            super.new(name);
            case_id = "PROF-RC-004";
            case_name = "long_running_soak_1m_guard512";
            case_number = 4;
