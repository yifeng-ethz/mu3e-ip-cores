// prof_rc_019_watchdog_overlap_offset_02_seq.sv
...
package prof_rc_019_watchdog_overlap_offset_02_seq_pkg;
    ...
    class prof_rc_019_watchdog_overlap_offset_02_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_019_watchdog_overlap_offset_02_seq)
        ...
        function new(string name = "prof_rc_019_watchdog_overlap_offset_02_seq");
            super.new(name);
            case_id = "PROF-RC-019";
            case_name = "watchdog_overlap_offset_02";
            case_number = 19;
