// prof_rc_011_run_number_100_runs_stride_3_seq.sv
...
package prof_rc_011_run_number_100_runs_stride_3_seq_pkg;
    ...
    class prof_rc_011_run_number_100_runs_stride_3_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_rc_011_run_number_100_runs_stride_3_seq)
        ...
        function new(string name = "prof_rc_011_run_number_100_runs_stride_3_seq");
            super.new(name);
            case_id = "PROF-RC-011";
            case_name = "run_number_100_runs_stride_3";
            case_number = 11;
