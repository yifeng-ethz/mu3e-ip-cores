// prof_sc_031_concurrent_dt_peak_stride_7_seq.sv
...
package prof_sc_031_concurrent_dt_peak_stride_7_seq_pkg;
    ...
    class prof_sc_031_concurrent_dt_peak_stride_7_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_031_concurrent_dt_peak_stride_7_seq)
        ...
        function new(string name = "prof_sc_031_concurrent_dt_peak_stride_7_seq");
            super.new(name);
            case_id = "PROF-SC-031";
            case_name = "concurrent_dt_peak_stride_7";
            case_number = 31;
