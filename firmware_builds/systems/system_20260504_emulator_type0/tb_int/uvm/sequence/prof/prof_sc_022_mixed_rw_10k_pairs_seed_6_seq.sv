// prof_sc_022_mixed_rw_10k_pairs_seed_6_seq.sv
...
package prof_sc_022_mixed_rw_10k_pairs_seed_6_seq_pkg;
    ...
    class prof_sc_022_mixed_rw_10k_pairs_seed_6_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_022_mixed_rw_10k_pairs_seed_6_seq)
        ...
        function new(string name = "prof_sc_022_mixed_rw_10k_pairs_seed_6_seq");
            super.new(name);
            case_id = "PROF-SC-022";
            case_name = "mixed_rw_10k_pairs_seed_6";
            case_number = 22;
