// prof_sc_024_mixed_rw_10k_pairs_seed_8_seq.sv
...
package prof_sc_024_mixed_rw_10k_pairs_seed_8_seq_pkg;
    ...
    class prof_sc_024_mixed_rw_10k_pairs_seed_8_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_024_mixed_rw_10k_pairs_seed_8_seq)
        ...
        function new(string name = "prof_sc_024_mixed_rw_10k_pairs_seed_8_seq");
            super.new(name);
            case_id = "PROF-SC-024";
            case_name = "mixed_rw_10k_pairs_seed_8";
            case_number = 24;
