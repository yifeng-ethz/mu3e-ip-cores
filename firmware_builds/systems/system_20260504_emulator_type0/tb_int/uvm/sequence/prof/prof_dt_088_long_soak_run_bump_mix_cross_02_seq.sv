// prof_dt_088_long_soak_run_bump_mix_cross_02_seq.sv
...
package prof_dt_088_long_soak_run_bump_mix_cross_02_seq_pkg;
    ...
    class prof_dt_088_long_soak_run_bump_mix_cross_02_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_088_long_soak_run_bump_mix_cross_02_seq)
        ...
        function new(string name = "prof_dt_088_long_soak_run_bump_mix_cross_02_seq");
            super.new(name);
            case_id = "PROF-DT-088";
            case_name = "long_soak_run_bump_mix_cross_02";
            case_number = 88;
