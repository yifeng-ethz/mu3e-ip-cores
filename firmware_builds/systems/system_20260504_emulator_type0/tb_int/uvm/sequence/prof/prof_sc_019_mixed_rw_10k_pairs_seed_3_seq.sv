// prof_sc_019_mixed_rw_10k_pairs_seed_3_seq.sv
...
package prof_sc_019_mixed_rw_10k_pairs_seed_3_seq_pkg;
    ...
    class prof_sc_019_mixed_rw_10k_pairs_seed_3_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_019_mixed_rw_10k_pairs_seed_3_seq)
        ...
        function new(string name = "prof_sc_019_mixed_rw_10k_pairs_seed_3_seq");
            super.new(name);
            case_id = "PROF-SC-019";
            case_name = "mixed_rw_10k_pairs_seed_3";
            case_number = 19;
