// prof_sc_018_mixed_rw_10k_pairs_seed_2_seq.sv
...
package prof_sc_018_mixed_rw_10k_pairs_seed_2_seq_pkg;
    ...
    class prof_sc_018_mixed_rw_10k_pairs_seed_2_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_018_mixed_rw_10k_pairs_seed_2_seq)
        ...
        function new(string name = "prof_sc_018_mixed_rw_10k_pairs_seed_2_seq");
            super.new(name);
            case_id = "PROF-SC-018";
            case_name = "mixed_rw_10k_pairs_seed_2";
            case_number = 18;
