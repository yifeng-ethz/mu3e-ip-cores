// prof_dt_084_long_soak_run_bump_mix_cross_01_seq.sv
...
package prof_dt_084_long_soak_run_bump_mix_cross_01_seq_pkg;
    ...
    class prof_dt_084_long_soak_run_bump_mix_cross_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_084_long_soak_run_bump_mix_cross_01_seq)
        ...
        function new(string name = "prof_dt_084_long_soak_run_bump_mix_cross_01_seq");
            super.new(name);
            case_id = "PROF-DT-084";
            case_name = "long_soak_run_bump_mix_cross_01";
            case_number = 84;
