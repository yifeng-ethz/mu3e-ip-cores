// prof_dt_095_watchdog_silent_mix_rr_offset_00_seq.sv
...
package prof_dt_095_watchdog_silent_mix_rr_offset_00_seq_pkg;
    ...
    class prof_dt_095_watchdog_silent_mix_rr_offset_00_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_095_watchdog_silent_mix_rr_offset_00_seq)
        ...
        function new(string name = "prof_dt_095_watchdog_silent_mix_rr_offset_00_seq");
            super.new(name);
            case_id = "PROF-DT-095";
            case_name = "watchdog_silent_mix_rr_offset_00";
            case_number = 95;
