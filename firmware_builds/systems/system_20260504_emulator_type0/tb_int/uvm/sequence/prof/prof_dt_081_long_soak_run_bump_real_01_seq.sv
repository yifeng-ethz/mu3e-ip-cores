// prof_dt_081_long_soak_run_bump_real_01_seq.sv
...
package prof_dt_081_long_soak_run_bump_real_01_seq_pkg;
    ...
    class prof_dt_081_long_soak_run_bump_real_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_081_long_soak_run_bump_real_01_seq)
        ...
        function new(string name = "prof_dt_081_long_soak_run_bump_real_01_seq");
            super.new(name);
            case_id = "PROF-DT-081";
            case_name = "long_soak_run_bump_real_01";
            case_number = 81;
