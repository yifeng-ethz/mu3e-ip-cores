// prof_dt_074_raw_ceiling_emu_phase_06_seq.sv
...
package prof_dt_074_raw_ceiling_emu_phase_06_seq_pkg;
    ...
    class prof_dt_074_raw_ceiling_emu_phase_06_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_074_raw_ceiling_emu_phase_06_seq)
        ...
        function new(string name = "prof_dt_074_raw_ceiling_emu_phase_06_seq");
            super.new(name);
            case_id = "PROF-DT-074";
            case_name = "raw_ceiling_emu_phase_06";
            case_number = 74;
