// prof_dt_092_long_soak_run_bump_mix_cross_03_seq.sv
...
package prof_dt_092_long_soak_run_bump_mix_cross_03_seq_pkg;
    ...
    class prof_dt_092_long_soak_run_bump_mix_cross_03_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_092_long_soak_run_bump_mix_cross_03_seq)
        ...
        function new(string name = "prof_dt_092_long_soak_run_bump_mix_cross_03_seq");
            super.new(name);
            case_id = "PROF-DT-092";
            case_name = "long_soak_run_bump_mix_cross_03";
            case_number = 92;
