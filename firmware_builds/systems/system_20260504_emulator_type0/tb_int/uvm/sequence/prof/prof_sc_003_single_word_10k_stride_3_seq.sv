// prof_sc_003_single_word_10k_stride_3_seq.sv
...
package prof_sc_003_single_word_10k_stride_3_seq_pkg;
    ...
    class prof_sc_003_single_word_10k_stride_3_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_sc_003_single_word_10k_stride_3_seq)
        ...
        function new(string name = "prof_sc_003_single_word_10k_stride_3_seq");
            super.new(name);
            case_id = "PROF-SC-003";
            case_name = "single_word_10k_stride_3";
            case_number = 3;
