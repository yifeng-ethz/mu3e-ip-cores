// prof_dt_115_hist_saturation_mix_rr_bin_01_seq.sv
...
package prof_dt_115_hist_saturation_mix_rr_bin_01_seq_pkg;
    ...
    class prof_dt_115_hist_saturation_mix_rr_bin_01_seq extends uvm_sequence#(uvm_sequence_item);
        `uvm_object_utils(prof_dt_115_hist_saturation_mix_rr_bin_01_seq)
        ...
        function new(string name = "prof_dt_115_hist_saturation_mix_rr_bin_01_seq");
            super.new(name);
            case_id = "PROF-DT-115";
            case_name = "hist_saturation_mix_rr_bin_01";
            case_number = 115;
