// error_rc_026_reset_mid_sc_single_write_test.sv
// ERROR bucket directed test for ERROR-RC-026.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
...
class error_rc_026_reset_mid_sc_single_write_test extends tb_int_base_test;
    `uvm_component_utils(error_rc_026_reset_mid_sc_single_write_test)
    ...
    virtual task run_phase(uvm_phase phase);
        ...
        seq_obj = uvm_factory::get().create_object_by_name("error_rc_026_reset_mid_sc_single_write_seq", "", "error_rc_026_reset_mid_sc_single_write_seq");
        if (!$cast(seq, seq_obj))
            `uvm_fatal("ERROR_TEST", "factory could not create error_rc_026_reset_mid_sc_single_write_seq")
        seq.start(null);
        $display("*** TEST PASSED ***");
...
module error_rc_026_reset_mid_sc_single_write_test_factory_anchor;
    uvm_object_wrapper anchor_wrapper = error_rc_026_reset_mid_sc_single_write_test::type_id::get();
endmodule

bind tb_int_top error_rc_026_reset_mid_sc_single_write_test_factory_anchor u_error_rc_026_reset_mid_sc_single_write_test_factory_anchor();
