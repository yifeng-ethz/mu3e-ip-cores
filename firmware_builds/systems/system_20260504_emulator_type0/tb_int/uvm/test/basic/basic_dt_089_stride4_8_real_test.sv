// basic_dt_089_stride4_8_real_test.sv
// BASIC bucket test wrapper for BASIC-DT-089.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_089_STRIDE4_8_REAL_TEST_SV
`define BASIC_DT_089_STRIDE4_8_REAL_TEST_SV
...
class basic_dt_089_stride4_8_real_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_089_stride4_8_real_test)

    localparam string CASE_ID = "BASIC-DT-089";
    localparam string CASE_SEQUENCE = "basic_dt_089_stride4_8_real_seq";
    localparam string CASE_SUMMARY = "Stride-4 cluster size 8 source REAL";
    localparam int unsigned HIT_COUNT = 8;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 32;
    localparam int unsigned CHANNEL_STRIDE = 4;
