// basic_rc_015_terminating_hold_100_test.sv
// BASIC bucket test wrapper for BASIC-RC-015.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_015_TERMINATING_HOLD_100_TEST_SV
`define BASIC_RC_015_TERMINATING_HOLD_100_TEST_SV
...
class basic_rc_015_terminating_hold_100_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_015_terminating_hold_100_test)

    localparam string CASE_ID = "BASIC-RC-015";
    localparam string CASE_SEQUENCE = "basic_rc_015_terminating_hold_100_seq";
