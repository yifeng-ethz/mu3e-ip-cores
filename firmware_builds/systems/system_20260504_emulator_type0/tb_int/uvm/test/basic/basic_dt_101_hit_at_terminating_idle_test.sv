// basic_dt_101_hit_at_terminating_idle_test.sv
// BASIC bucket test wrapper for BASIC-DT-101.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_101_HIT_AT_TERMINATING_IDLE_TEST_SV
`define BASIC_DT_101_HIT_AT_TERMINATING_IDLE_TEST_SV
...
class basic_dt_101_hit_at_terminating_idle_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_101_hit_at_terminating_idle_test)

    localparam string CASE_ID = "BASIC-DT-101";
    localparam string CASE_SEQUENCE = "basic_dt_101_hit_at_terminating_idle_seq";
