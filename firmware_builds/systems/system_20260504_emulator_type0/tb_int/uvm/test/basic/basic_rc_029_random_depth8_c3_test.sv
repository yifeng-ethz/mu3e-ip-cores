// basic_rc_029_random_depth8_c3_test.sv
// BASIC bucket test wrapper for BASIC-RC-029.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_029_RANDOM_DEPTH8_C3_TEST_SV
`define BASIC_RC_029_RANDOM_DEPTH8_C3_TEST_SV
...
class basic_rc_029_random_depth8_c3_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_029_random_depth8_c3_test)

    localparam string CASE_ID = "BASIC-RC-029";
    localparam string CASE_SEQUENCE = "basic_rc_029_random_depth8_c3_seq";
    localparam string CASE_SUMMARY = "Seeded random run-control sequence depth 8 seed 0xC3";
    localparam int unsigned HIT_COUNT = 5;
