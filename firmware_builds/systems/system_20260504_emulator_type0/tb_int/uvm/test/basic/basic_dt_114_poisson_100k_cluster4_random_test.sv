// basic_dt_114_poisson_100k_cluster4_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-114.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_114_POISSON_100K_CLUSTER4_RANDOM_TEST_SV
`define BASIC_DT_114_POISSON_100K_CLUSTER4_RANDOM_TEST_SV
...
class basic_dt_114_poisson_100k_cluster4_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_114_poisson_100k_cluster4_random_test)

    localparam string CASE_ID = "BASIC-DT-114";
    localparam string CASE_SEQUENCE = "basic_dt_114_poisson_100k_cluster4_random_seq";
    localparam string CASE_SUMMARY = "Poisson 100 kHz per channel cluster mean 4 random spatial spread";
    localparam int unsigned HIT_COUNT = 12;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 16;
    localparam int unsigned CHANNEL_STRIDE = 3;
    localparam int unsigned FINE_BASE = 18;
