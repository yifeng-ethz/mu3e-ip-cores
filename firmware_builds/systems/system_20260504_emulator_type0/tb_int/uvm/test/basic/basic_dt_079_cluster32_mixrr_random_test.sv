// basic_dt_079_cluster32_mixrr_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-079.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_079_CLUSTER32_MIXRR_RANDOM_TEST_SV
`define BASIC_DT_079_CLUSTER32_MIXRR_RANDOM_TEST_SV
...
class basic_dt_079_cluster32_mixrr_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_079_cluster32_mixrr_random_test)

    localparam string CASE_ID = "BASIC-DT-079";
    localparam string CASE_SEQUENCE = "basic_dt_079_cluster32_mixrr_random_seq";
    localparam string CASE_SUMMARY = "Random spatial cluster size 32 source mixrr";
    ...
    localparam int unsigned FINE_BASE = 15;
