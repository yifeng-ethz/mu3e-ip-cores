// basic_dt_121_poisson_500k_cluster16_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-121.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_121_POISSON_500K_CLUSTER16_RANDOM_TEST_SV
`define BASIC_DT_121_POISSON_500K_CLUSTER16_RANDOM_TEST_SV
...
class basic_dt_121_poisson_500k_cluster16_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_121_poisson_500k_cluster16_random_test)

    localparam string CASE_ID = "BASIC-DT-121";
    localparam string CASE_SEQUENCE = "basic_dt_121_poisson_500k_cluster16_random_seq";
    localparam string CASE_SUMMARY = "Poisson 500 kHz per channel cluster mean 16 random spatial spread";
    ...
    localparam int unsigned FINE_BASE = 25;
