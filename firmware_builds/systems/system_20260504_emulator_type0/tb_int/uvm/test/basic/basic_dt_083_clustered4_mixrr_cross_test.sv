// basic_dt_083_clustered4_mixrr_cross_test.sv
// BASIC bucket test wrapper for BASIC-DT-083.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_083_CLUSTERED4_MIXRR_CROSS_TEST_SV
`define BASIC_DT_083_CLUSTERED4_MIXRR_CROSS_TEST_SV
...
class basic_dt_083_clustered4_mixrr_cross_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_083_clustered4_mixrr_cross_test)

    localparam string CASE_ID = "BASIC-DT-083";
    localparam string CASE_SEQUENCE = "basic_dt_083_clustered4_mixrr_cross_seq";
    ...
    localparam int unsigned CHANNEL_SPAN = 12;
