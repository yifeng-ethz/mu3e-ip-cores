// basic_sc_025_sc_while_running_test.sv
// BASIC bucket test wrapper for BASIC-SC-025.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_025_SC_WHILE_RUNNING_TEST_SV
`define BASIC_SC_025_SC_WHILE_RUNNING_TEST_SV
...
class basic_sc_025_sc_while_running_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_025_sc_while_running_test)

    localparam string CASE_ID = "BASIC-SC-025";
    localparam string CASE_SEQUENCE = "basic_sc_025_sc_while_running_seq";
