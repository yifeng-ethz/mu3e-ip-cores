// basic_sc_003_w1p_write_status_test.sv
// BASIC bucket test wrapper for BASIC-SC-003.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_003_W1P_WRITE_STATUS_TEST_SV
`define BASIC_SC_003_W1P_WRITE_STATUS_TEST_SV
...
class basic_sc_003_w1p_write_status_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_003_w1p_write_status_test)

    localparam string CASE_ID = "BASIC-SC-003";
    localparam string CASE_SEQUENCE = "basic_sc_003_w1p_write_status_seq";
