// basic_dt_103_hit_cycle0_only_test.sv
// BASIC bucket test wrapper for BASIC-DT-103.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_103_HIT_CYCLE0_ONLY_TEST_SV
`define BASIC_DT_103_HIT_CYCLE0_ONLY_TEST_SV
...
class basic_dt_103_hit_cycle0_only_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_103_hit_cycle0_only_test)

    localparam string CASE_ID = "BASIC-DT-103";
    localparam string CASE_SEQUENCE = "basic_dt_103_hit_cycle0_only_seq";
    localparam string CASE_SUMMARY = "Only one hit at cycle 0 of RUNNING";
    localparam int unsigned HIT_COUNT = 1;
    localparam int unsigned CHANNEL_BASE = 4;
