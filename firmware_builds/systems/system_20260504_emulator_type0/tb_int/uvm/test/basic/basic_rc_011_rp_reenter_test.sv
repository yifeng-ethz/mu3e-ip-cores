// basic_rc_011_rp_reenter_test.sv
// BASIC bucket test wrapper for BASIC-RC-011.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_011_RP_REENTER_TEST_SV
`define BASIC_RC_011_RP_REENTER_TEST_SV
...
class basic_rc_011_rp_reenter_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_011_rp_reenter_test)

    localparam string CASE_ID = "BASIC-RC-011";
    localparam string CASE_SEQUENCE = "basic_rc_011_rp_reenter_seq";
