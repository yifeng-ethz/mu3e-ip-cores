// basic_rc_021_mid_frame_commands_test.sv
// BASIC bucket test wrapper for BASIC-RC-021.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_021_MID_FRAME_COMMANDS_TEST_SV
`define BASIC_RC_021_MID_FRAME_COMMANDS_TEST_SV
...
class basic_rc_021_mid_frame_commands_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_021_mid_frame_commands_test)

    localparam string CASE_ID = "BASIC-RC-021";
    localparam string CASE_SEQUENCE = "basic_rc_021_mid_frame_commands_seq";
