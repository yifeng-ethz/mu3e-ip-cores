// basic_dt_001_single_ch0_zero_real_test.sv
// BASIC bucket test wrapper for BASIC-DT-001.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_001_SINGLE_CH0_ZERO_REAL_TEST_SV
`define BASIC_DT_001_SINGLE_CH0_ZERO_REAL_TEST_SV
...
class basic_dt_001_single_ch0_zero_real_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_001_single_ch0_zero_real_test)

    localparam string CASE_ID = "BASIC-DT-001";
    localparam string CASE_SEQUENCE = "basic_dt_001_single_ch0_zero_real_seq";
