// basic_dt_106_hits_after_terminating_test.sv
// BASIC bucket test wrapper for BASIC-DT-106.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_106_HITS_AFTER_TERMINATING_TEST_SV
`define BASIC_DT_106_HITS_AFTER_TERMINATING_TEST_SV
...
class basic_dt_106_hits_after_terminating_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_106_hits_after_terminating_test)

    localparam string CASE_ID = "BASIC-DT-106";
    localparam string CASE_SEQUENCE = "basic_dt_106_hits_after_terminating_seq";
