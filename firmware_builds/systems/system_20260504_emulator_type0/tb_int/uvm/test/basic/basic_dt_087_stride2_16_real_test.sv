// basic_dt_087_stride2_16_real_test.sv
// BASIC bucket test wrapper for BASIC-DT-087.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_087_STRIDE2_16_REAL_TEST_SV
`define BASIC_DT_087_STRIDE2_16_REAL_TEST_SV
...
class basic_dt_087_stride2_16_real_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_087_stride2_16_real_test)

    localparam string CASE_ID = "BASIC-DT-087";
    localparam string CASE_SEQUENCE = "basic_dt_087_stride2_16_real_seq";
    localparam string CASE_SUMMARY = "Stride-2 cluster size 16 source REAL";
