// basic_dt_004_single_ch15_emu_test.sv
// BASIC bucket test wrapper for BASIC-DT-004.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_004_SINGLE_CH15_EMU_TEST_SV
`define BASIC_DT_004_SINGLE_CH15_EMU_TEST_SV
...
class basic_dt_004_single_ch15_emu_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_004_single_ch15_emu_test)

    localparam string CASE_ID = "BASIC-DT-004";
    localparam string CASE_SEQUENCE = "basic_dt_004_single_ch15_emu_seq";
    localparam string CASE_SUMMARY = "Single hit channel 15 max visible emu channel";
    localparam int unsigned HIT_COUNT = 1;
    localparam int unsigned CHANNEL_BASE = 15;
