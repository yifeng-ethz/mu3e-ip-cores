// basic_rc_013_sync_hold_1000_test.sv
// BASIC bucket test wrapper for BASIC-RC-013.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_013_SYNC_HOLD_1000_TEST_SV
`define BASIC_RC_013_SYNC_HOLD_1000_TEST_SV
...
class basic_rc_013_sync_hold_1000_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_013_sync_hold_1000_test)

    localparam string CASE_ID = "BASIC-RC-013";
    localparam string CASE_SEQUENCE = "basic_rc_013_sync_hold_1000_seq";
