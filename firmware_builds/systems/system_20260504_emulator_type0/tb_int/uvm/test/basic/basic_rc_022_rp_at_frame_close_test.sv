// basic_rc_022_rp_at_frame_close_test.sv
// BASIC bucket test wrapper for BASIC-RC-022.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_022_RP_AT_FRAME_CLOSE_TEST_SV
`define BASIC_RC_022_RP_AT_FRAME_CLOSE_TEST_SV
...
class basic_rc_022_rp_at_frame_close_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_022_rp_at_frame_close_test)

    localparam string CASE_ID = "BASIC-RC-022";
    localparam string CASE_SEQUENCE = "basic_rc_022_rp_at_frame_close_seq";
