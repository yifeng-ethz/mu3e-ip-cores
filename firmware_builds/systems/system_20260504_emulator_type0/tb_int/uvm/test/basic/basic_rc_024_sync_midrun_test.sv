// basic_rc_024_sync_midrun_test.sv
// BASIC bucket test wrapper for BASIC-RC-024.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_024_SYNC_MIDRUN_TEST_SV
`define BASIC_RC_024_SYNC_MIDRUN_TEST_SV
...
class basic_rc_024_sync_midrun_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_024_sync_midrun_test)

    localparam string CASE_ID = "BASIC-RC-024";
    localparam string CASE_SEQUENCE = "basic_rc_024_sync_midrun_seq";
    localparam string CASE_SUMMARY = "RUNNING -> SYNC -> RUNNING counter snapshot path";
