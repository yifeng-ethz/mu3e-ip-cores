// basic_dt_104_hit_cycle_n_only_test.sv
// BASIC bucket test wrapper for BASIC-DT-104.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_104_HIT_CYCLE_N_ONLY_TEST_SV
`define BASIC_DT_104_HIT_CYCLE_N_ONLY_TEST_SV
...
class basic_dt_104_hit_cycle_n_only_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_104_hit_cycle_n_only_test)

    localparam string CASE_ID = "BASIC-DT-104";
    localparam string CASE_SEQUENCE = "basic_dt_104_hit_cycle_n_only_seq";
    ...
    localparam int unsigned HIT_GAP_CYCLES = 16;
