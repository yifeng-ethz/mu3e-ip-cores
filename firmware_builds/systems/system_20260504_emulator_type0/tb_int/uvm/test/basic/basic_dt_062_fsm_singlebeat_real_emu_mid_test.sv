// basic_dt_062_fsm_singlebeat_real_emu_mid_test.sv
// BASIC bucket test wrapper for BASIC-DT-062.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_062_FSM_SINGLEBEAT_REAL_EMU_MID_TEST_SV
`define BASIC_DT_062_FSM_SINGLEBEAT_REAL_EMU_MID_TEST_SV
...
class basic_dt_062_fsm_singlebeat_real_emu_mid_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_062_fsm_singlebeat_real_emu_mid_test)

    localparam string CASE_ID = "BASIC-DT-062";
    localparam string CASE_SEQUENCE = "basic_dt_062_fsm_singlebeat_real_emu_mid_seq";
