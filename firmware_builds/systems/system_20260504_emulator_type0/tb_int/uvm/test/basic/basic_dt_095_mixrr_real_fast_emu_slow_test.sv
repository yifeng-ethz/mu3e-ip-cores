// basic_dt_095_mixrr_real_fast_emu_slow_test.sv
// BASIC bucket test wrapper for BASIC-DT-095.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_095_MIXRR_REAL_FAST_EMU_SLOW_TEST_SV
`define BASIC_DT_095_MIXRR_REAL_FAST_EMU_SLOW_TEST_SV
...
class basic_dt_095_mixrr_real_fast_emu_slow_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_095_mixrr_real_fast_emu_slow_test)

    localparam string CASE_ID = "BASIC-DT-095";
    localparam string CASE_SEQUENCE = "basic_dt_095_mixrr_real_fast_emu_slow_seq";
