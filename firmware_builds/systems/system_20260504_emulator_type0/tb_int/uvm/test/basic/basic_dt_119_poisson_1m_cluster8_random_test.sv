// basic_dt_119_poisson_1m_cluster8_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-119.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_119_POISSON_1M_CLUSTER8_RANDOM_TEST_SV
`define BASIC_DT_119_POISSON_1M_CLUSTER8_RANDOM_TEST_SV
...
class basic_dt_119_poisson_1m_cluster8_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_119_poisson_1m_cluster8_random_test)

    localparam string CASE_ID = "BASIC-DT-119";
    localparam string CASE_SEQUENCE = "basic_dt_119_poisson_1m_cluster8_random_seq";
    localparam string CASE_SUMMARY = "Poisson 1 MHz per channel cluster mean 8 random spatial spread";
    ...
    localparam int unsigned FINE_BASE = 23;
