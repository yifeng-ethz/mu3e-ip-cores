// basic_rc_027_random_depth4_a1_test.sv
// BASIC bucket test wrapper for BASIC-RC-027.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_027_RANDOM_DEPTH4_A1_TEST_SV
`define BASIC_RC_027_RANDOM_DEPTH4_A1_TEST_SV
...
class basic_rc_027_random_depth4_a1_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_027_random_depth4_a1_test)

    localparam string CASE_ID = "BASIC-RC-027";
    localparam string CASE_SEQUENCE = "basic_rc_027_random_depth4_a1_seq";
    localparam string CASE_SUMMARY = "Seeded random run-control sequence depth 4 seed 0xA1";
    localparam int unsigned HIT_COUNT = 3;
