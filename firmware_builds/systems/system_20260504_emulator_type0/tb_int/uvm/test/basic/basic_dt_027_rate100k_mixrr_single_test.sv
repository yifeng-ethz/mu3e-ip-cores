// basic_dt_027_rate100k_mixrr_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-027.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_027_RATE100K_MIXRR_SINGLE_TEST_SV
`define BASIC_DT_027_RATE100K_MIXRR_SINGLE_TEST_SV
...
class basic_dt_027_rate100k_mixrr_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_027_rate100k_mixrr_single_test)

    localparam string CASE_ID = "BASIC-DT-027";
    localparam string CASE_SEQUENCE = "basic_dt_027_rate100k_mixrr_single_seq";
    localparam string CASE_SUMMARY = "Rate sweep 100kHz per channel source mixrr channel-set single";
