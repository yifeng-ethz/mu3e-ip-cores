// basic_rc_031_random_depth16_e5_test.sv
// BASIC bucket test wrapper for BASIC-RC-031.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_031_RANDOM_DEPTH16_E5_TEST_SV
`define BASIC_RC_031_RANDOM_DEPTH16_E5_TEST_SV
...
class basic_rc_031_random_depth16_e5_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_031_random_depth16_e5_test)

    localparam string CASE_ID = "BASIC-RC-031";
    localparam string CASE_SEQUENCE = "basic_rc_031_random_depth16_e5_seq";
