// basic_dt_008_split16_mixrr_test.sv
// BASIC bucket test wrapper for BASIC-DT-008.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_008_SPLIT16_MIXRR_TEST_SV
`define BASIC_DT_008_SPLIT16_MIXRR_TEST_SV
...
class basic_dt_008_split16_mixrr_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_008_split16_mixrr_test)

    localparam string CASE_ID = "BASIC-DT-008";
    localparam string CASE_SEQUENCE = "basic_dt_008_split16_mixrr_seq";
    localparam string CASE_SUMMARY = "Sixteen-hit split-source MIX_RR cluster";
