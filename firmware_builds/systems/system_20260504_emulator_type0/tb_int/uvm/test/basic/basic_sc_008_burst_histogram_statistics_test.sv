// basic_sc_008_burst_histogram_statistics_test.sv
// BASIC bucket test wrapper for BASIC-SC-008.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_008_BURST_HISTOGRAM_STATISTICS_TEST_SV
`define BASIC_SC_008_BURST_HISTOGRAM_STATISTICS_TEST_SV
...
class basic_sc_008_burst_histogram_statistics_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_008_burst_histogram_statistics_test)

    localparam string CASE_ID = "BASIC-SC-008";
    localparam string CASE_SEQUENCE = "basic_sc_008_burst_histogram_statistics_seq";
