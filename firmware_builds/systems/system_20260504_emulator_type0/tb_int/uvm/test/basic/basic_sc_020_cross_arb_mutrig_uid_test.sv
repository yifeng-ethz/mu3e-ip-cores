// basic_sc_020_cross_arb_mutrig_uid_test.sv
// BASIC bucket test wrapper for BASIC-SC-020.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_020_CROSS_ARB_MUTRIG_UID_TEST_SV
`define BASIC_SC_020_CROSS_ARB_MUTRIG_UID_TEST_SV
...
class basic_sc_020_cross_arb_mutrig_uid_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_020_cross_arb_mutrig_uid_test)

    localparam string CASE_ID = "BASIC-SC-020";
    localparam string CASE_SEQUENCE = "basic_sc_020_cross_arb_mutrig_uid_seq";
