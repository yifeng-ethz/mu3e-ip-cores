// basic_sc_015_burst_len4_test.sv
// BASIC bucket test wrapper for BASIC-SC-015.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_015_BURST_LEN4_TEST_SV
`define BASIC_SC_015_BURST_LEN4_TEST_SV
...
class basic_sc_015_burst_len4_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_015_burst_len4_test)

    localparam string CASE_ID = "BASIC-SC-015";
    localparam string CASE_SEQUENCE = "basic_sc_015_burst_len4_seq";
    localparam string CASE_SUMMARY = "Burst read length 4";
    localparam int unsigned HIT_COUNT = 2;
    localparam int unsigned CHANNEL_BASE = 14;
