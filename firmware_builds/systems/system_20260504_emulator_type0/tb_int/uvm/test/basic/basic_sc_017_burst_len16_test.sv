// basic_sc_017_burst_len16_test.sv
// BASIC bucket test wrapper for BASIC-SC-017.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_017_BURST_LEN16_TEST_SV
`define BASIC_SC_017_BURST_LEN16_TEST_SV
...
class basic_sc_017_burst_len16_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_017_burst_len16_test)

    localparam string CASE_ID = "BASIC-SC-017";
    localparam string CASE_SEQUENCE = "basic_sc_017_burst_len16_seq";
