// basic_dt_126_poisson_1m_cluster8_mixed_phase_test.sv
// BASIC bucket test wrapper for BASIC-DT-126.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_126_POISSON_1M_CLUSTER8_MIXED_PHASE_TEST_SV
`define BASIC_DT_126_POISSON_1M_CLUSTER8_MIXED_PHASE_TEST_SV
...
class basic_dt_126_poisson_1m_cluster8_mixed_phase_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_126_poisson_1m_cluster8_mixed_phase_test)

    localparam string CASE_ID = "BASIC-DT-126";
    localparam string CASE_SEQUENCE = "basic_dt_126_poisson_1m_cluster8_mixed_phase_seq";
    localparam string CASE_SUMMARY = "Poisson 1 MHz cluster 8 with mixed temporal phase sweep";
    localparam int unsigned HIT_COUNT = 32;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 16;
    localparam int unsigned CHANNEL_STRIDE = 3;
    localparam int unsigned FINE_BASE = 30;
