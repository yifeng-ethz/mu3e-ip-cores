// basic_sc_010_burst_arb_first_half_test.sv
// BASIC bucket test wrapper for BASIC-SC-010.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_010_BURST_ARB_FIRST_HALF_TEST_SV
`define BASIC_SC_010_BURST_ARB_FIRST_HALF_TEST_SV
...
class basic_sc_010_burst_arb_first_half_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_010_burst_arb_first_half_test)

    localparam string CASE_ID = "BASIC-SC-010";
    localparam string CASE_SEQUENCE = "basic_sc_010_burst_arb_first_half_seq";
