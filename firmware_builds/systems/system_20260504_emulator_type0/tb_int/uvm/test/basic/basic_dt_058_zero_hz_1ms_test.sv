// basic_dt_058_zero_hz_1ms_test.sv
// BASIC bucket test wrapper for BASIC-DT-058.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_058_ZERO_HZ_1MS_TEST_SV
`define BASIC_DT_058_ZERO_HZ_1MS_TEST_SV
...
class basic_dt_058_zero_hz_1ms_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_058_zero_hz_1ms_test)

    localparam string CASE_ID = "BASIC-DT-058";
    localparam string CASE_SEQUENCE = "basic_dt_058_zero_hz_1ms_seq";
