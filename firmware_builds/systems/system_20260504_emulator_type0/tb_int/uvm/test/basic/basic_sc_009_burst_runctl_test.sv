// basic_sc_009_burst_runctl_test.sv
// BASIC bucket test wrapper for BASIC-SC-009.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_009_BURST_RUNCTL_TEST_SV
`define BASIC_SC_009_BURST_RUNCTL_TEST_SV
...
class basic_sc_009_burst_runctl_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_009_burst_runctl_test)

    localparam string CASE_ID = "BASIC-SC-009";
    localparam string CASE_SEQUENCE = "basic_sc_009_burst_runctl_seq";
