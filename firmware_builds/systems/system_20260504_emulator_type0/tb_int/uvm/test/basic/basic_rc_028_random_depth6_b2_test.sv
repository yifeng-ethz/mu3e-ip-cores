// basic_rc_028_random_depth6_b2_test.sv
// BASIC bucket test wrapper for BASIC-RC-028.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_028_RANDOM_DEPTH6_B2_TEST_SV
`define BASIC_RC_028_RANDOM_DEPTH6_B2_TEST_SV
...
class basic_rc_028_random_depth6_b2_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_028_random_depth6_b2_test)

    localparam string CASE_ID = "BASIC-RC-028";
    localparam string CASE_SEQUENCE = "basic_rc_028_random_depth6_b2_seq";
