// basic_dt_116_poisson_1m_cluster4_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-116.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_116_POISSON_1M_CLUSTER4_RANDOM_TEST_SV
`define BASIC_DT_116_POISSON_1M_CLUSTER4_RANDOM_TEST_SV
...
class basic_dt_116_poisson_1m_cluster4_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_116_poisson_1m_cluster4_random_test)

    localparam string CASE_ID = "BASIC-DT-116";
    localparam string CASE_SEQUENCE = "basic_dt_116_poisson_1m_cluster4_random_seq";
    localparam string CASE_SUMMARY = "Poisson 1 MHz per channel cluster mean 4 random spatial spread";
    localparam int unsigned HIT_COUNT = 20;
