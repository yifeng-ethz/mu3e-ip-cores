// basic_dt_045_rate2m_mixrr_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-045.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_045_RATE2M_MIXRR_SINGLE_TEST_SV
`define BASIC_DT_045_RATE2M_MIXRR_SINGLE_TEST_SV
...
class basic_dt_045_rate2m_mixrr_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_045_rate2m_mixrr_single_test)

    localparam string CASE_ID = "BASIC-DT-045";
    localparam string CASE_SEQUENCE = "basic_dt_045_rate2m_mixrr_single_seq";
