// basic_sc_004_ro_read_test.sv
// BASIC bucket test wrapper for BASIC-SC-004.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_004_RO_READ_TEST_SV
`define BASIC_SC_004_RO_READ_TEST_SV
...
class basic_sc_004_ro_read_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_004_ro_read_test)

    localparam string CASE_ID = "BASIC-SC-004";
    localparam string CASE_SEQUENCE = "basic_sc_004_ro_read_seq";
    localparam string CASE_SUMMARY = "Single-word read of every RO field";
