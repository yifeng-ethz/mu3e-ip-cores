// basic_dt_039_rate1m_mixrr_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-039.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_039_RATE1M_MIXRR_SINGLE_TEST_SV
`define BASIC_DT_039_RATE1M_MIXRR_SINGLE_TEST_SV
...
class basic_dt_039_rate1m_mixrr_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_039_rate1m_mixrr_single_test)

    localparam string CASE_ID = "BASIC-DT-039";
    localparam string CASE_SEQUENCE = "basic_dt_039_rate1m_mixrr_single_seq";
    localparam string CASE_SUMMARY = "Rate sweep 1mHz per channel source mixrr channel-set single";
    localparam int unsigned HIT_COUNT = 16;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 1;
    localparam int unsigned CHANNEL_STRIDE = 1;
    localparam int unsigned FINE_BASE = 7;
    localparam int unsigned FINE_STRIDE = 3;
    localparam int unsigned HIT_GAP_CYCLES = 2;
