// basic_dt_047_cluster1_duty50_test.sv
// BASIC bucket test wrapper for BASIC-DT-047.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_047_CLUSTER1_DUTY50_TEST_SV
`define BASIC_DT_047_CLUSTER1_DUTY50_TEST_SV
...
class basic_dt_047_cluster1_duty50_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_047_cluster1_duty50_test)

    localparam string CASE_ID = "BASIC-DT-047";
    localparam string CASE_SEQUENCE = "basic_dt_047_cluster1_duty50_seq";
