// basic_dt_097_no_hits_running_test.sv
// BASIC bucket test wrapper for BASIC-DT-097.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_097_NO_HITS_RUNNING_TEST_SV
`define BASIC_DT_097_NO_HITS_RUNNING_TEST_SV
...
class basic_dt_097_no_hits_running_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_097_no_hits_running_test)

    localparam string CASE_ID = "BASIC-DT-097";
    localparam string CASE_SEQUENCE = "basic_dt_097_no_hits_running_seq";
    localparam string CASE_SUMMARY = "No hits during RUNNING gate-closed path";
    localparam int unsigned HIT_COUNT = 0;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 1;
    localparam int unsigned CHANNEL_STRIDE = 1;
    localparam int unsigned FINE_BASE = 1;
