// basic_dt_086_clustered8_mixrr_test.sv
// BASIC bucket test wrapper for BASIC-DT-086.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_086_CLUSTERED8_MIXRR_TEST_SV
`define BASIC_DT_086_CLUSTERED8_MIXRR_TEST_SV
...
class basic_dt_086_clustered8_mixrr_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_086_clustered8_mixrr_test)

    localparam string CASE_ID = "BASIC-DT-086";
    localparam string CASE_SEQUENCE = "basic_dt_086_clustered8_mixrr_seq";
    localparam string CASE_SUMMARY = "Clustered contiguous size 8 source MIX_RR";
    ...
    localparam int unsigned FINE_STRIDE = 2;
