// basic_dt_060_watchdog_emu_silent_test.sv
// BASIC bucket test wrapper for BASIC-DT-060.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_060_WATCHDOG_EMU_SILENT_TEST_SV
`define BASIC_DT_060_WATCHDOG_EMU_SILENT_TEST_SV
...
class basic_dt_060_watchdog_emu_silent_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_060_watchdog_emu_silent_test)

    localparam string CASE_ID = "BASIC-DT-060";
    localparam string CASE_SEQUENCE = "basic_dt_060_watchdog_emu_silent_seq";
