// basic_dt_031_rate500k_emu_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-031.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_031_RATE500K_EMU_SINGLE_TEST_SV
`define BASIC_DT_031_RATE500K_EMU_SINGLE_TEST_SV
...
class basic_dt_031_rate500k_emu_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_031_rate500k_emu_single_test)

    localparam string CASE_ID = "BASIC-DT-031";
    localparam string CASE_SEQUENCE = "basic_dt_031_rate500k_emu_single_seq";
    localparam string CASE_SUMMARY = "Rate sweep 500kHz per channel source emu channel-set single";
    localparam int unsigned HIT_COUNT = 8;
    localparam int unsigned CHANNEL_BASE = 8;
    localparam int unsigned CHANNEL_SPAN = 1;
    localparam int unsigned CHANNEL_STRIDE = 1;
    localparam int unsigned FINE_BASE = 31;
