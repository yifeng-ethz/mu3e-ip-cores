// basic_sc_032_mass_full_aperture_test.sv
// BASIC bucket test wrapper for BASIC-SC-032.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_032_MASS_FULL_APERTURE_TEST_SV
`define BASIC_SC_032_MASS_FULL_APERTURE_TEST_SV
...
class basic_sc_032_mass_full_aperture_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_032_mass_full_aperture_test)

    localparam string CASE_ID = "BASIC-SC-032";
    localparam string CASE_SEQUENCE = "basic_sc_032_mass_full_aperture_seq";
    localparam string CASE_SUMMARY = "Mass read of every CSR slave full aperture";
