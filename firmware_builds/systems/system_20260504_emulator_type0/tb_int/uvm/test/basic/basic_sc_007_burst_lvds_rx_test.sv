// basic_sc_007_burst_lvds_rx_test.sv
// BASIC bucket test wrapper for BASIC-SC-007.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_007_BURST_LVDS_RX_TEST_SV
`define BASIC_SC_007_BURST_LVDS_RX_TEST_SV
...
class basic_sc_007_burst_lvds_rx_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_007_burst_lvds_rx_test)

    localparam string CASE_ID = "BASIC-SC-007";
    localparam string CASE_SEQUENCE = "basic_sc_007_burst_lvds_rx_seq";
