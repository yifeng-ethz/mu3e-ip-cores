// basic_rc_019_run_number_max_test.sv
// BASIC bucket test wrapper for BASIC-RC-019.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_019_RUN_NUMBER_MAX_TEST_SV
`define BASIC_RC_019_RUN_NUMBER_MAX_TEST_SV
...
class basic_rc_019_run_number_max_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_019_run_number_max_test)

    localparam string CASE_ID = "BASIC-RC-019";
    localparam string CASE_SEQUENCE = "basic_rc_019_run_number_max_seq";
    localparam string CASE_SUMMARY = "Canonical run with RUN_NUMBER 0xFFFF_FFFF";
