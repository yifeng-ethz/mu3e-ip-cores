// basic_rc_003_rp_sync_run_idle_test.sv
// BASIC bucket test wrapper for BASIC-RC-003.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_003_RP_SYNC_RUN_IDLE_TEST_SV
`define BASIC_RC_003_RP_SYNC_RUN_IDLE_TEST_SV
...
class basic_rc_003_rp_sync_run_idle_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_003_rp_sync_run_idle_test)

    localparam string CASE_ID = "BASIC-RC-003";
    localparam string CASE_SEQUENCE = "basic_rc_003_rp_sync_run_idle_seq";
