// basic_sc_024_counter_pair_intervening_write_test.sv
// BASIC bucket test wrapper for BASIC-SC-024.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_024_COUNTER_PAIR_INTERVENING_WRITE_TEST_SV
`define BASIC_SC_024_COUNTER_PAIR_INTERVENING_WRITE_TEST_SV
...
class basic_sc_024_counter_pair_intervening_write_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_024_counter_pair_intervening_write_test)

    localparam string CASE_ID = "BASIC-SC-024";
    localparam string CASE_SEQUENCE = "basic_sc_024_counter_pair_intervening_write_seq";
    localparam string CASE_SUMMARY = "Counter pair read with intervening clear write";
