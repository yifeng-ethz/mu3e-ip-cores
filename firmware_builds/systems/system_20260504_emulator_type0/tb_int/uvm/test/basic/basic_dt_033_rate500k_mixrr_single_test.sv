// basic_dt_033_rate500k_mixrr_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-033.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_033_RATE500K_MIXRR_SINGLE_TEST_SV
`define BASIC_DT_033_RATE500K_MIXRR_SINGLE_TEST_SV
...
class basic_dt_033_rate500k_mixrr_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_033_rate500k_mixrr_single_test)

    localparam string CASE_ID = "BASIC-DT-033";
    localparam string CASE_SEQUENCE = "basic_dt_033_rate500k_mixrr_single_seq";
