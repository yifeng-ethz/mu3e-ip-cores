// basic_dt_099_hit_at_sync_running_test.sv
// BASIC bucket test wrapper for BASIC-DT-099.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_099_HIT_AT_SYNC_RUNNING_TEST_SV
`define BASIC_DT_099_HIT_AT_SYNC_RUNNING_TEST_SV
...
class basic_dt_099_hit_at_sync_running_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_099_hit_at_sync_running_test)

    localparam string CASE_ID = "BASIC-DT-099";
    localparam string CASE_SEQUENCE = "basic_dt_099_hit_at_sync_running_seq";
    localparam string CASE_SUMMARY = "First hit exactly at SYNC to RUNNING transition";
    localparam int unsigned HIT_COUNT = 1;
    localparam int unsigned CHANNEL_BASE = 1;
