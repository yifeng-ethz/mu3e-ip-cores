// basic_dt_128_tdc_header_sync_cluster8_test.sv
// BASIC bucket test wrapper for BASIC-DT-128.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_128_TDC_HEADER_SYNC_CLUSTER8_TEST_SV
`define BASIC_DT_128_TDC_HEADER_SYNC_CLUSTER8_TEST_SV
...
class basic_dt_128_tdc_header_sync_cluster8_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_128_tdc_header_sync_cluster8_test)

    localparam string CASE_ID = "BASIC-DT-128";
    localparam string CASE_SEQUENCE = "basic_dt_128_tdc_header_sync_cluster8_seq";
    localparam string CASE_SUMMARY = "TDC deterministic header-synchronous contiguous cluster 8";
