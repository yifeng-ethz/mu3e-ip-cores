// basic_dt_046_rate2m_mixrr_full32_test.sv
// BASIC bucket test wrapper for BASIC-DT-046.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_046_RATE2M_MIXRR_FULL32_TEST_SV
`define BASIC_DT_046_RATE2M_MIXRR_FULL32_TEST_SV
...
class basic_dt_046_rate2m_mixrr_full32_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_046_rate2m_mixrr_full32_test)

    localparam string CASE_ID = "BASIC-DT-046";
    localparam string CASE_SEQUENCE = "basic_dt_046_rate2m_mixrr_full32_seq";
    localparam string CASE_SUMMARY = "Rate sweep 2mHz per channel source mixrr channel-set full32";
    ...
    localparam int unsigned FINE_BASE = 14;
