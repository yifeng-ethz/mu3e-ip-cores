// basic_sc_028_sc_watchdog_window_test.sv
// BASIC bucket test wrapper for BASIC-SC-028.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_028_SC_WATCHDOG_WINDOW_TEST_SV
`define BASIC_SC_028_SC_WATCHDOG_WINDOW_TEST_SV
...
class basic_sc_028_sc_watchdog_window_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_028_sc_watchdog_window_test)

    localparam string CASE_ID = "BASIC-SC-028";
    localparam string CASE_SEQUENCE = "basic_sc_028_sc_watchdog_window_seq";
    localparam string CASE_SUMMARY = "SC during watchdog firing window";
