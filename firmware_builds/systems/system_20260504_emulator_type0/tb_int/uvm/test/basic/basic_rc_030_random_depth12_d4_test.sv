// basic_rc_030_random_depth12_d4_test.sv
// BASIC bucket test wrapper for BASIC-RC-030.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_030_RANDOM_DEPTH12_D4_TEST_SV
`define BASIC_RC_030_RANDOM_DEPTH12_D4_TEST_SV
...
class basic_rc_030_random_depth12_d4_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_030_random_depth12_d4_test)

    localparam string CASE_ID = "BASIC-RC-030";
    localparam string CASE_SEQUENCE = "basic_rc_030_random_depth12_d4_seq";
