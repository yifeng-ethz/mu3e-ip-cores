// basic_dt_107_midrun_gate_seed1_test.sv
// BASIC bucket test wrapper for BASIC-DT-107.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_107_MIDRUN_GATE_SEED1_TEST_SV
`define BASIC_DT_107_MIDRUN_GATE_SEED1_TEST_SV
...
class basic_dt_107_midrun_gate_seed1_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_107_midrun_gate_seed1_test)

    localparam string CASE_ID = "BASIC-DT-107";
    localparam string CASE_SEQUENCE = "basic_dt_107_midrun_gate_seed1_seq";
