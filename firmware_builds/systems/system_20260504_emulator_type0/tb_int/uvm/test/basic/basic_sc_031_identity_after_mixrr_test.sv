// basic_sc_031_identity_after_mixrr_test.sv
// BASIC bucket test wrapper for BASIC-SC-031.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_031_IDENTITY_AFTER_MIXRR_TEST_SV
`define BASIC_SC_031_IDENTITY_AFTER_MIXRR_TEST_SV
...
class basic_sc_031_identity_after_mixrr_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_031_identity_after_mixrr_test)

    localparam string CASE_ID = "BASIC-SC-031";
    localparam string CASE_SEQUENCE = "basic_sc_031_identity_after_mixrr_seq";
