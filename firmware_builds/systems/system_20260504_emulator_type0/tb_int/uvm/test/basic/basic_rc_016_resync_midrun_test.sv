// basic_rc_016_resync_midrun_test.sv
// BASIC bucket test wrapper for BASIC-RC-016.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_016_RESYNC_MIDRUN_TEST_SV
`define BASIC_RC_016_RESYNC_MIDRUN_TEST_SV
...
class basic_rc_016_resync_midrun_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_016_resync_midrun_test)

    localparam string CASE_ID = "BASIC-RC-016";
    localparam string CASE_SEQUENCE = "basic_rc_016_resync_midrun_seq";
