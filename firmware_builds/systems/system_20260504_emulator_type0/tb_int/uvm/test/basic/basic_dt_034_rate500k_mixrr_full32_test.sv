// basic_dt_034_rate500k_mixrr_full32_test.sv
// BASIC bucket test wrapper for BASIC-DT-034.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_034_RATE500K_MIXRR_FULL32_TEST_SV
`define BASIC_DT_034_RATE500K_MIXRR_FULL32_TEST_SV
...
class basic_dt_034_rate500k_mixrr_full32_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_034_rate500k_mixrr_full32_test)

    localparam string CASE_ID = "BASIC-DT-034";
    localparam string CASE_SEQUENCE = "basic_dt_034_rate500k_mixrr_full32_seq";
    localparam string CASE_SUMMARY = "Rate sweep 500kHz per channel source mixrr channel-set full32";
    localparam int unsigned HIT_COUNT = 32;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 32;
    localparam int unsigned CHANNEL_STRIDE = 1;
    localparam int unsigned FINE_BASE = 2;
    localparam int unsigned FINE_STRIDE = 3;
    localparam int unsigned HIT_GAP_CYCLES = 4;
