// basic_sc_002_rw_write_readback_test.sv
// BASIC bucket test wrapper for BASIC-SC-002.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_002_RW_WRITE_READBACK_TEST_SV
`define BASIC_SC_002_RW_WRITE_READBACK_TEST_SV
...
class basic_sc_002_rw_write_readback_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_002_rw_write_readback_test)

    localparam string CASE_ID = "BASIC-SC-002";
    localparam string CASE_SEQUENCE = "basic_sc_002_rw_write_readback_seq";
