// basic_dt_108_midrun_gate_seed2_test.sv
// BASIC bucket test wrapper for BASIC-DT-108.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_108_MIDRUN_GATE_SEED2_TEST_SV
`define BASIC_DT_108_MIDRUN_GATE_SEED2_TEST_SV
...
class basic_dt_108_midrun_gate_seed2_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_108_midrun_gate_seed2_test)

    localparam string CASE_ID = "BASIC-DT-108";
    localparam string CASE_SEQUENCE = "basic_dt_108_midrun_gate_seed2_seq";
