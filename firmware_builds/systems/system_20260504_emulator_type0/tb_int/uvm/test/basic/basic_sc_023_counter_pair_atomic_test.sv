// basic_sc_023_counter_pair_atomic_test.sv
// BASIC bucket test wrapper for BASIC-SC-023.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_023_COUNTER_PAIR_ATOMIC_TEST_SV
`define BASIC_SC_023_COUNTER_PAIR_ATOMIC_TEST_SV
...
class basic_sc_023_counter_pair_atomic_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_023_counter_pair_atomic_test)

    localparam string CASE_ID = "BASIC-SC-023";
    localparam string CASE_SEQUENCE = "basic_sc_023_counter_pair_atomic_seq";
