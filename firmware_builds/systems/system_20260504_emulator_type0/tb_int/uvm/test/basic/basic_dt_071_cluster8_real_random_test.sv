// basic_dt_071_cluster8_real_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-071.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_071_CLUSTER8_REAL_RANDOM_TEST_SV
`define BASIC_DT_071_CLUSTER8_REAL_RANDOM_TEST_SV
...
class basic_dt_071_cluster8_real_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_071_cluster8_real_random_test)

    localparam string CASE_ID = "BASIC-DT-071";
    localparam string CASE_SEQUENCE = "basic_dt_071_cluster8_real_random_seq";
    localparam string CASE_SUMMARY = "Random spatial cluster size 8 source real";
