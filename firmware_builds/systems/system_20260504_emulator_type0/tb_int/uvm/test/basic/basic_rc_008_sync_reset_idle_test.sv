// basic_rc_008_sync_reset_idle_test.sv
// BASIC bucket test wrapper for BASIC-RC-008.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_008_SYNC_RESET_IDLE_TEST_SV
`define BASIC_RC_008_SYNC_RESET_IDLE_TEST_SV
...
class basic_rc_008_sync_reset_idle_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_008_sync_reset_idle_test)

    localparam string CASE_ID = "BASIC-RC-008";
    localparam string CASE_SEQUENCE = "basic_rc_008_sync_reset_idle_seq";
    localparam string CASE_SUMMARY = "Cancel from SYNC through RESET to IDLE";
