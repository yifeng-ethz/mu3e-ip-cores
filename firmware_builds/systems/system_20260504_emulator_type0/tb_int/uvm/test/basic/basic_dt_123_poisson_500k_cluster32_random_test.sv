// basic_dt_123_poisson_500k_cluster32_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-123.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_123_POISSON_500K_CLUSTER32_RANDOM_TEST_SV
`define BASIC_DT_123_POISSON_500K_CLUSTER32_RANDOM_TEST_SV
...
class basic_dt_123_poisson_500k_cluster32_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_123_poisson_500k_cluster32_random_test)

    localparam string CASE_ID = "BASIC-DT-123";
    localparam string CASE_SEQUENCE = "basic_dt_123_poisson_500k_cluster32_random_seq";
    localparam string CASE_SUMMARY = "Poisson 500 kHz per channel cluster mean 32 random spatial spread";
    localparam int unsigned HIT_COUNT = 48;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 32;
    localparam int unsigned CHANNEL_STRIDE = 3;
    localparam int unsigned FINE_BASE = 27;
