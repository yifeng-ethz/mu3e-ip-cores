// basic_dt_051_cluster32_duty50_test.sv
// BASIC bucket test wrapper for BASIC-DT-051.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_051_CLUSTER32_DUTY50_TEST_SV
`define BASIC_DT_051_CLUSTER32_DUTY50_TEST_SV
...
class basic_dt_051_cluster32_duty50_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_051_cluster32_duty50_test)

    localparam string CASE_ID = "BASIC-DT-051";
    localparam string CASE_SEQUENCE = "basic_dt_051_cluster32_duty50_seq";
