// basic_rc_002_rp_sync_idle_test.sv
// BASIC bucket test wrapper for BASIC-RC-002.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_002_RP_SYNC_IDLE_TEST_SV
`define BASIC_RC_002_RP_SYNC_IDLE_TEST_SV
...
class basic_rc_002_rp_sync_idle_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_002_rp_sync_idle_test)

    localparam string CASE_ID = "BASIC-RC-002";
    localparam string CASE_SEQUENCE = "basic_rc_002_rp_sync_idle_seq";
    localparam string CASE_SUMMARY = "IDLE -> RUN_PREP -> SYNC -> IDLE";
