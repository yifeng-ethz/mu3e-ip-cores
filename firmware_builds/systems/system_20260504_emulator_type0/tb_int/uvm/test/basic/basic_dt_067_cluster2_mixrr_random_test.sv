// basic_dt_067_cluster2_mixrr_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-067.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_067_CLUSTER2_MIXRR_RANDOM_TEST_SV
`define BASIC_DT_067_CLUSTER2_MIXRR_RANDOM_TEST_SV
...
class basic_dt_067_cluster2_mixrr_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_067_cluster2_mixrr_random_test)

    localparam string CASE_ID = "BASIC-DT-067";
    localparam string CASE_SEQUENCE = "basic_dt_067_cluster2_mixrr_random_seq";
    localparam string CASE_SUMMARY = "Random spatial cluster size 2 source mixrr";
    localparam int unsigned HIT_COUNT = 2;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 2;
