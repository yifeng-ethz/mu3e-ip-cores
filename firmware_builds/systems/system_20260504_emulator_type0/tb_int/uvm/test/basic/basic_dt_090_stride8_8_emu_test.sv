// basic_dt_090_stride8_8_emu_test.sv
// BASIC bucket test wrapper for BASIC-DT-090.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_090_STRIDE8_8_EMU_TEST_SV
`define BASIC_DT_090_STRIDE8_8_EMU_TEST_SV
...
class basic_dt_090_stride8_8_emu_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_090_stride8_8_emu_test)

    localparam string CASE_ID = "BASIC-DT-090";
    localparam string CASE_SEQUENCE = "basic_dt_090_stride8_8_emu_seq";
    ...
    localparam int unsigned CHANNEL_SPAN = 24;
    localparam int unsigned CHANNEL_STRIDE = 8;
