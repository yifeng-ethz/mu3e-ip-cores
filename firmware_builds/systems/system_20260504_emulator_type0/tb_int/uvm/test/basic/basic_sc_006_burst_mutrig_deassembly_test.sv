// basic_sc_006_burst_mutrig_deassembly_test.sv
// BASIC bucket test wrapper for BASIC-SC-006.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_006_BURST_MUTRIG_DEASSEMBLY_TEST_SV
`define BASIC_SC_006_BURST_MUTRIG_DEASSEMBLY_TEST_SV
...
class basic_sc_006_burst_mutrig_deassembly_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_006_burst_mutrig_deassembly_test)

    localparam string CASE_ID = "BASIC-SC-006";
    localparam string CASE_SEQUENCE = "basic_sc_006_burst_mutrig_deassembly_seq";
