// basic_dt_017_rate10k_real_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-017.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_017_RATE10K_REAL_SINGLE_TEST_SV
`define BASIC_DT_017_RATE10K_REAL_SINGLE_TEST_SV
...
class basic_dt_017_rate10k_real_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_017_rate10k_real_single_test)

    localparam string CASE_ID = "BASIC-DT-017";
    localparam string CASE_SEQUENCE = "basic_dt_017_rate10k_real_single_seq";
    localparam string CASE_SUMMARY = "Rate sweep 10kHz per channel source real channel-set single";
