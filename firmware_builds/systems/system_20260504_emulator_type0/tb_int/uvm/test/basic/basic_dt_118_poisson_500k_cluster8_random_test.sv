// basic_dt_118_poisson_500k_cluster8_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-118.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_118_POISSON_500K_CLUSTER8_RANDOM_TEST_SV
`define BASIC_DT_118_POISSON_500K_CLUSTER8_RANDOM_TEST_SV
...
class basic_dt_118_poisson_500k_cluster8_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_118_poisson_500k_cluster8_random_test)

    localparam string CASE_ID = "BASIC-DT-118";
    localparam string CASE_SEQUENCE = "basic_dt_118_poisson_500k_cluster8_random_seq";
