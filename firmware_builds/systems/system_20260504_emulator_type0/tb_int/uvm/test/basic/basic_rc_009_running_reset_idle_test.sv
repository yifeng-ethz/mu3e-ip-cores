// basic_rc_009_running_reset_idle_test.sv
// BASIC bucket test wrapper for BASIC-RC-009.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_009_RUNNING_RESET_IDLE_TEST_SV
`define BASIC_RC_009_RUNNING_RESET_IDLE_TEST_SV
...
class basic_rc_009_running_reset_idle_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_009_running_reset_idle_test)

    localparam string CASE_ID = "BASIC-RC-009";
    localparam string CASE_SEQUENCE = "basic_rc_009_running_reset_idle_seq";
