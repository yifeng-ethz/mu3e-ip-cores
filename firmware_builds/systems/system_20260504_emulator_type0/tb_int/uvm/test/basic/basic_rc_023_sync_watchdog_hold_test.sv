// basic_rc_023_sync_watchdog_hold_test.sv
// BASIC bucket test wrapper for BASIC-RC-023.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_023_SYNC_WATCHDOG_HOLD_TEST_SV
`define BASIC_RC_023_SYNC_WATCHDOG_HOLD_TEST_SV
...
class basic_rc_023_sync_watchdog_hold_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_023_sync_watchdog_hold_test)

    localparam string CASE_ID = "BASIC-RC-023";
    localparam string CASE_SEQUENCE = "basic_rc_023_sync_watchdog_hold_seq";
    localparam string CASE_SUMMARY = "SYNC held beyond watchdog window";
    localparam int unsigned HIT_COUNT = 1;
    localparam int unsigned CHANNEL_BASE = 7;
