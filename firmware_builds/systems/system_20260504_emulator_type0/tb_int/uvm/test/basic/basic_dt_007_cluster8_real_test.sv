// basic_dt_007_cluster8_real_test.sv
// BASIC bucket test wrapper for BASIC-DT-007.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_007_CLUSTER8_REAL_TEST_SV
`define BASIC_DT_007_CLUSTER8_REAL_TEST_SV
...
class basic_dt_007_cluster8_real_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_007_cluster8_real_test)

    localparam string CASE_ID = "BASIC-DT-007";
    localparam string CASE_SEQUENCE = "basic_dt_007_cluster8_real_seq";
    localparam string CASE_SUMMARY = "Eight-hit same-coarse cluster channels 0..7 REAL";
