// basic_dt_054_cluster4_duty70_test.sv
// BASIC bucket test wrapper for BASIC-DT-054.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_054_CLUSTER4_DUTY70_TEST_SV
`define BASIC_DT_054_CLUSTER4_DUTY70_TEST_SV
...
class basic_dt_054_cluster4_duty70_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_054_cluster4_duty70_test)

    localparam string CASE_ID = "BASIC-DT-054";
    localparam string CASE_SEQUENCE = "basic_dt_054_cluster4_duty70_seq";
