// basic_rc_025_double_reset_1cy_test.sv
// BASIC bucket test wrapper for BASIC-RC-025.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_025_DOUBLE_RESET_1CY_TEST_SV
`define BASIC_RC_025_DOUBLE_RESET_1CY_TEST_SV
...
class basic_rc_025_double_reset_1cy_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_025_double_reset_1cy_test)

    localparam string CASE_ID = "BASIC-RC-025";
    localparam string CASE_SEQUENCE = "basic_rc_025_double_reset_1cy_seq";
    localparam string CASE_SUMMARY = "Two RESET events spaced one cycle apart";
