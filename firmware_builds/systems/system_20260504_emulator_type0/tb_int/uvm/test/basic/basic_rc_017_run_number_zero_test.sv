// basic_rc_017_run_number_zero_test.sv
// BASIC bucket test wrapper for BASIC-RC-017.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_017_RUN_NUMBER_ZERO_TEST_SV
`define BASIC_RC_017_RUN_NUMBER_ZERO_TEST_SV
...
class basic_rc_017_run_number_zero_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_017_run_number_zero_test)

    localparam string CASE_ID = "BASIC-RC-017";
    localparam string CASE_SEQUENCE = "basic_rc_017_run_number_zero_seq";
    localparam string CASE_SUMMARY = "Canonical run with RUN_NUMBER zero";
