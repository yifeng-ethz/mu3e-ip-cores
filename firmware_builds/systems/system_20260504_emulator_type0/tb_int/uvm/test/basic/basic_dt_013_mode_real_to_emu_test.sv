// basic_dt_013_mode_real_to_emu_test.sv
// BASIC bucket test wrapper for BASIC-DT-013.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_013_MODE_REAL_TO_EMU_TEST_SV
`define BASIC_DT_013_MODE_REAL_TO_EMU_TEST_SV
...
class basic_dt_013_mode_real_to_emu_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_013_mode_real_to_emu_test)

    localparam string CASE_ID = "BASIC-DT-013";
    localparam string CASE_SEQUENCE = "basic_dt_013_mode_real_to_emu_seq";
