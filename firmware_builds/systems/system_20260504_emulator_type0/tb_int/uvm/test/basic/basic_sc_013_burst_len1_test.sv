// basic_sc_013_burst_len1_test.sv
// BASIC bucket test wrapper for BASIC-SC-013.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_013_BURST_LEN1_TEST_SV
`define BASIC_SC_013_BURST_LEN1_TEST_SV
...
class basic_sc_013_burst_len1_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_013_burst_len1_test)

    localparam string CASE_ID = "BASIC-SC-013";
    localparam string CASE_SEQUENCE = "basic_sc_013_burst_len1_seq";
