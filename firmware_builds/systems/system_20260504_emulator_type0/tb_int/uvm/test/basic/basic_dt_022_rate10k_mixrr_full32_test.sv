// basic_dt_022_rate10k_mixrr_full32_test.sv
// BASIC bucket test wrapper for BASIC-DT-022.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_022_RATE10K_MIXRR_FULL32_TEST_SV
`define BASIC_DT_022_RATE10K_MIXRR_FULL32_TEST_SV
...
class basic_dt_022_rate10k_mixrr_full32_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_022_rate10k_mixrr_full32_test)

    localparam string CASE_ID = "BASIC-DT-022";
    localparam string CASE_SEQUENCE = "basic_dt_022_rate10k_mixrr_full32_seq";
    localparam string CASE_SUMMARY = "Rate sweep 10kHz per channel source mixrr channel-set full32";
    ...
    localparam int unsigned FINE_BASE = 22;
    localparam int unsigned FINE_STRIDE = 3;
    localparam int unsigned HIT_GAP_CYCLES = 12;
