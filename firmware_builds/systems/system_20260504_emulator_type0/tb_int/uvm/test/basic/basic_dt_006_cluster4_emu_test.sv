// basic_dt_006_cluster4_emu_test.sv
// BASIC bucket test wrapper for BASIC-DT-006.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_006_CLUSTER4_EMU_TEST_SV
`define BASIC_DT_006_CLUSTER4_EMU_TEST_SV
...
class basic_dt_006_cluster4_emu_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_006_cluster4_emu_test)

    localparam string CASE_ID = "BASIC-DT-006";
    localparam string CASE_SEQUENCE = "basic_dt_006_cluster4_emu_seq";
    localparam string CASE_SUMMARY = "Four-hit same-coarse cluster channels 8..11 EMU";
