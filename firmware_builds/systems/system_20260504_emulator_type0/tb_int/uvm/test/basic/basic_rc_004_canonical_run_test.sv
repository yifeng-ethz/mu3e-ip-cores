// basic_rc_004_canonical_run_test.sv
// BASIC bucket test wrapper for BASIC-RC-004.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_004_CANONICAL_RUN_TEST_SV
`define BASIC_RC_004_CANONICAL_RUN_TEST_SV
...
class basic_rc_004_canonical_run_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_004_canonical_run_test)

    localparam string CASE_ID = "BASIC-RC-004";
    localparam string CASE_SEQUENCE = "basic_rc_004_canonical_run_seq";
