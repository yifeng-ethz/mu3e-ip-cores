// basic_dt_010_phase_offset0_test.sv
// BASIC bucket test wrapper for BASIC-DT-010.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_010_PHASE_OFFSET0_TEST_SV
`define BASIC_DT_010_PHASE_OFFSET0_TEST_SV
...
class basic_dt_010_phase_offset0_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_010_phase_offset0_test)

    localparam string CASE_ID = "BASIC-DT-010";
    localparam string CASE_SEQUENCE = "basic_dt_010_phase_offset0_seq";
    localparam string CASE_SUMMARY = "Smoke hit at frame-boundary phase offset 0";
