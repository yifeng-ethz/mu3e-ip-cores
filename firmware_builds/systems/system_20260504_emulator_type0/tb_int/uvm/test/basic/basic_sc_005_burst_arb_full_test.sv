// basic_sc_005_burst_arb_full_test.sv
// BASIC bucket test wrapper for BASIC-SC-005.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_005_BURST_ARB_FULL_TEST_SV
`define BASIC_SC_005_BURST_ARB_FULL_TEST_SV
...
class basic_sc_005_burst_arb_full_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_005_burst_arb_full_test)

    localparam string CASE_ID = "BASIC-SC-005";
    localparam string CASE_SEQUENCE = "basic_sc_005_burst_arb_full_seq";
    localparam string CASE_SUMMARY = "Burst read arb_hit_type0 full 32-word aperture";
    localparam int unsigned HIT_COUNT = 2;
    localparam int unsigned CHANNEL_BASE = 10;
