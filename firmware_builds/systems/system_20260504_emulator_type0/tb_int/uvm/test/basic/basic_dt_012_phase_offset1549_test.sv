// basic_dt_012_phase_offset1549_test.sv
// BASIC bucket test wrapper for BASIC-DT-012.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_012_PHASE_OFFSET1549_TEST_SV
`define BASIC_DT_012_PHASE_OFFSET1549_TEST_SV
...
class basic_dt_012_phase_offset1549_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_012_phase_offset1549_test)

    localparam string CASE_ID = "BASIC-DT-012";
    localparam string CASE_SEQUENCE = "basic_dt_012_phase_offset1549_seq";
    localparam string CASE_SUMMARY = "Smoke hit at frame-boundary phase offset 1549";
