// basic_sc_012_burst_arb_last_half_minus_reserved_test.sv
// BASIC bucket test wrapper for BASIC-SC-012.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_012_BURST_ARB_LAST_HALF_MINUS_RESERVED_TEST_SV
`define BASIC_SC_012_BURST_ARB_LAST_HALF_MINUS_RESERVED_TEST_SV
...
class basic_sc_012_burst_arb_last_half_minus_reserved_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_012_burst_arb_last_half_minus_reserved_test)

    localparam string CASE_ID = "BASIC-SC-012";
    localparam string CASE_SEQUENCE = "basic_sc_012_burst_arb_last_half_minus_reserved_seq";
