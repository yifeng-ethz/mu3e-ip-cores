// basic_dt_125_poisson_100k_cluster4_mixed_phase_test.sv
// BASIC bucket test wrapper for BASIC-DT-125.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_125_POISSON_100K_CLUSTER4_MIXED_PHASE_TEST_SV
`define BASIC_DT_125_POISSON_100K_CLUSTER4_MIXED_PHASE_TEST_SV
...
class basic_dt_125_poisson_100k_cluster4_mixed_phase_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_125_poisson_100k_cluster4_mixed_phase_test)

    localparam string CASE_ID = "BASIC-DT-125";
    localparam string CASE_SEQUENCE = "basic_dt_125_poisson_100k_cluster4_mixed_phase_seq";
    localparam string CASE_SUMMARY = "Poisson 100 kHz cluster 4 with mixed temporal phase sweep";
    localparam int unsigned HIT_COUNT = 16;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 16;
    localparam int unsigned CHANNEL_STRIDE = 3;
    localparam int unsigned FINE_BASE = 29;
    localparam int unsigned FINE_STRIDE = 5;
    localparam int unsigned HIT_GAP_CYCLES = 1;
