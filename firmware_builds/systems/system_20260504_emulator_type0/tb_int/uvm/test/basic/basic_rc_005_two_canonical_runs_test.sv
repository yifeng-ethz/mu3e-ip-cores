// basic_rc_005_two_canonical_runs_test.sv
// BASIC bucket test wrapper for BASIC-RC-005.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_005_TWO_CANONICAL_RUNS_TEST_SV
`define BASIC_RC_005_TWO_CANONICAL_RUNS_TEST_SV
...
class basic_rc_005_two_canonical_runs_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_005_two_canonical_runs_test)

    localparam string CASE_ID = "BASIC-RC-005";
    localparam string CASE_SEQUENCE = "basic_rc_005_two_canonical_runs_seq";
    localparam string CASE_SUMMARY = "Two back-to-back canonical runs";
    localparam int unsigned HIT_COUNT = 6;
