// basic_sc_018_burst_len32_test.sv
// BASIC bucket test wrapper for BASIC-SC-018.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_018_BURST_LEN32_TEST_SV
`define BASIC_SC_018_BURST_LEN32_TEST_SV
...
class basic_sc_018_burst_len32_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_018_burst_len32_test)

    localparam string CASE_ID = "BASIC-SC-018";
    localparam string CASE_SEQUENCE = "basic_sc_018_burst_len32_seq";
