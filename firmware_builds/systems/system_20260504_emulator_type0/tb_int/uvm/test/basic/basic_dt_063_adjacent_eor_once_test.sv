// basic_dt_063_adjacent_eor_once_test.sv
// BASIC bucket test wrapper for BASIC-DT-063.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_063_ADJACENT_EOR_ONCE_TEST_SV
`define BASIC_DT_063_ADJACENT_EOR_ONCE_TEST_SV
...
class basic_dt_063_adjacent_eor_once_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_063_adjacent_eor_once_test)

    localparam string CASE_ID = "BASIC-DT-063";
    localparam string CASE_SEQUENCE = "basic_dt_063_adjacent_eor_once_seq";
