// basic_dt_127_tdc_header_sync_single_test.sv
// BASIC bucket test wrapper for BASIC-DT-127.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_127_TDC_HEADER_SYNC_SINGLE_TEST_SV
`define BASIC_DT_127_TDC_HEADER_SYNC_SINGLE_TEST_SV
...
class basic_dt_127_tdc_header_sync_single_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_127_tdc_header_sync_single_test)

    localparam string CASE_ID = "BASIC-DT-127";
    localparam string CASE_SEQUENCE = "basic_dt_127_tdc_header_sync_single_seq";
