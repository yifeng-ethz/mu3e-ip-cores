// basic_dt_115_poisson_500k_cluster4_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-115.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_115_POISSON_500K_CLUSTER4_RANDOM_TEST_SV
`define BASIC_DT_115_POISSON_500K_CLUSTER4_RANDOM_TEST_SV
...
class basic_dt_115_poisson_500k_cluster4_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_115_poisson_500k_cluster4_random_test)

    localparam string CASE_ID = "BASIC-DT-115";
    localparam string CASE_SEQUENCE = "basic_dt_115_poisson_500k_cluster4_random_seq";
    localparam string CASE_SUMMARY = "Poisson 500 kHz per channel cluster mean 4 random spatial spread";
