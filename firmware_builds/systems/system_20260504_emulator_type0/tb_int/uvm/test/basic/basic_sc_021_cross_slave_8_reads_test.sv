// basic_sc_021_cross_slave_8_reads_test.sv
// BASIC bucket test wrapper for BASIC-SC-021.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_021_CROSS_SLAVE_8_READS_TEST_SV
`define BASIC_SC_021_CROSS_SLAVE_8_READS_TEST_SV
...
class basic_sc_021_cross_slave_8_reads_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_021_cross_slave_8_reads_test)

    localparam string CASE_ID = "BASIC-SC-021";
    localparam string CASE_SEQUENCE = "basic_sc_021_cross_slave_8_reads_seq";
