// basic_rc_006_three_canonical_runs_test.sv
// BASIC bucket test wrapper for BASIC-RC-006.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_006_THREE_CANONICAL_RUNS_TEST_SV
`define BASIC_RC_006_THREE_CANONICAL_RUNS_TEST_SV
...
class basic_rc_006_three_canonical_runs_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_006_three_canonical_runs_test)

    localparam string CASE_ID = "BASIC-RC-006";
    localparam string CASE_SEQUENCE = "basic_rc_006_three_canonical_runs_seq";
    localparam string CASE_SUMMARY = "Three canonical runs";
