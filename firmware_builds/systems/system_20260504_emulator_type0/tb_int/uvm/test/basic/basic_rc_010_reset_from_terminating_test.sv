// basic_rc_010_reset_from_terminating_test.sv
// BASIC bucket test wrapper for BASIC-RC-010.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_010_RESET_FROM_TERMINATING_TEST_SV
`define BASIC_RC_010_RESET_FROM_TERMINATING_TEST_SV
...
class basic_rc_010_reset_from_terminating_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_010_reset_from_terminating_test)

    localparam string CASE_ID = "BASIC-RC-010";
    localparam string CASE_SEQUENCE = "basic_rc_010_reset_from_terminating_seq";
