// basic_sc_029_identity_after_run_test.sv
// BASIC bucket test wrapper for BASIC-SC-029.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_029_IDENTITY_AFTER_RUN_TEST_SV
`define BASIC_SC_029_IDENTITY_AFTER_RUN_TEST_SV
...
class basic_sc_029_identity_after_run_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_029_identity_after_run_test)

    localparam string CASE_ID = "BASIC-SC-029";
    localparam string CASE_SEQUENCE = "basic_sc_029_identity_after_run_seq";
