// basic_dt_059_watchdog_disabled_test.sv
// BASIC bucket test wrapper for BASIC-DT-059.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_059_WATCHDOG_DISABLED_TEST_SV
`define BASIC_DT_059_WATCHDOG_DISABLED_TEST_SV
...
class basic_dt_059_watchdog_disabled_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_059_watchdog_disabled_test)

    localparam string CASE_ID = "BASIC-DT-059";
    localparam string CASE_SEQUENCE = "basic_dt_059_watchdog_disabled_seq";
