// basic_sc_026_sc_spans_terminating_test.sv
// BASIC bucket test wrapper for BASIC-SC-026.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_026_SC_SPANS_TERMINATING_TEST_SV
`define BASIC_SC_026_SC_SPANS_TERMINATING_TEST_SV
...
class basic_sc_026_sc_spans_terminating_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_026_sc_spans_terminating_test)

    localparam string CASE_ID = "BASIC-SC-026";
    localparam string CASE_SEQUENCE = "basic_sc_026_sc_spans_terminating_seq";
    localparam string CASE_SUMMARY = "SC burst spanning RUNNING to TERMINATING";
