// basic_dt_088_stride2_16_mixrr_test.sv
// BASIC bucket test wrapper for BASIC-DT-088.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_088_STRIDE2_16_MIXRR_TEST_SV
`define BASIC_DT_088_STRIDE2_16_MIXRR_TEST_SV
...
class basic_dt_088_stride2_16_mixrr_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_088_stride2_16_mixrr_test)

    localparam string CASE_ID = "BASIC-DT-088";
    localparam string CASE_SEQUENCE = "basic_dt_088_stride2_16_mixrr_seq";
