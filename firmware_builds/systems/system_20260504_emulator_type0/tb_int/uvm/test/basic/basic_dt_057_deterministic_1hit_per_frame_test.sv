// basic_dt_057_deterministic_1hit_per_frame_test.sv
// BASIC bucket test wrapper for BASIC-DT-057.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_057_DETERMINISTIC_1HIT_PER_FRAME_TEST_SV
`define BASIC_DT_057_DETERMINISTIC_1HIT_PER_FRAME_TEST_SV
...
class basic_dt_057_deterministic_1hit_per_frame_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_057_deterministic_1hit_per_frame_test)

    localparam string CASE_ID = "BASIC-DT-057";
    localparam string CASE_SEQUENCE = "basic_dt_057_deterministic_1hit_per_frame_seq";
    localparam string CASE_SUMMARY = "Deterministic one hit per frame";
    localparam int unsigned HIT_COUNT = 4;
