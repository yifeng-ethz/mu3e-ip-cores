// basic_rc_032_random_depth32_f6_test.sv
// BASIC bucket test wrapper for BASIC-RC-032.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_032_RANDOM_DEPTH32_F6_TEST_SV
`define BASIC_RC_032_RANDOM_DEPTH32_F6_TEST_SV
...
class basic_rc_032_random_depth32_f6_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_032_random_depth32_f6_test)

    localparam string CASE_ID = "BASIC-RC-032";
    localparam string CASE_SEQUENCE = "basic_rc_032_random_depth32_f6_seq";
