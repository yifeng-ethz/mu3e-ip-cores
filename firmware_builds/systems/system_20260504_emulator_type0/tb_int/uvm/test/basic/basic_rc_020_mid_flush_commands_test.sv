// basic_rc_020_mid_flush_commands_test.sv
// BASIC bucket test wrapper for BASIC-RC-020.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_020_MID_FLUSH_COMMANDS_TEST_SV
`define BASIC_RC_020_MID_FLUSH_COMMANDS_TEST_SV
...
class basic_rc_020_mid_flush_commands_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_020_mid_flush_commands_test)

    localparam string CASE_ID = "BASIC-RC-020";
    localparam string CASE_SEQUENCE = "basic_rc_020_mid_flush_commands_seq";
