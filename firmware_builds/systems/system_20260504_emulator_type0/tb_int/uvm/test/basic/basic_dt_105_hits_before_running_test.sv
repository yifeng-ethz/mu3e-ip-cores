// basic_dt_105_hits_before_running_test.sv
// BASIC bucket test wrapper for BASIC-DT-105.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_105_HITS_BEFORE_RUNNING_TEST_SV
`define BASIC_DT_105_HITS_BEFORE_RUNNING_TEST_SV
...
class basic_dt_105_hits_before_running_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_105_hits_before_running_test)

    localparam string CASE_ID = "BASIC-DT-105";
    localparam string CASE_SEQUENCE = "basic_dt_105_hits_before_running_seq";
