// basic_dt_020_rate10k_emu_full32_test.sv
// BASIC bucket test wrapper for BASIC-DT-020.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_020_RATE10K_EMU_FULL32_TEST_SV
`define BASIC_DT_020_RATE10K_EMU_FULL32_TEST_SV
...
class basic_dt_020_rate10k_emu_full32_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_020_rate10k_emu_full32_test)

    localparam string CASE_ID = "BASIC-DT-020";
    localparam string CASE_SEQUENCE = "basic_dt_020_rate10k_emu_full32_seq";
    localparam string CASE_SUMMARY = "Rate sweep 10kHz per channel source emu channel-set full32";
    ...
    localparam int unsigned FINE_BASE = 20;
