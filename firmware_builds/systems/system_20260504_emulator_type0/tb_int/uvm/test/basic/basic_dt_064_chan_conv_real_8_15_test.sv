// basic_dt_064_chan_conv_real_8_15_test.sv
// BASIC bucket test wrapper for BASIC-DT-064.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_064_CHAN_CONV_REAL_8_15_TEST_SV
`define BASIC_DT_064_CHAN_CONV_REAL_8_15_TEST_SV
...
class basic_dt_064_chan_conv_real_8_15_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_064_chan_conv_real_8_15_test)

    localparam string CASE_ID = "BASIC-DT-064";
    localparam string CASE_SEQUENCE = "basic_dt_064_chan_conv_real_8_15_seq";
    localparam string CASE_SUMMARY = "REAL-only channel convention violation channels 8..15";
