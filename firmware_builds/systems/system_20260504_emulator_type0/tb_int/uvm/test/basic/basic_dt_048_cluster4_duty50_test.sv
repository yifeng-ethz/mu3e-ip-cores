// basic_dt_048_cluster4_duty50_test.sv
// BASIC bucket test wrapper for BASIC-DT-048.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_048_CLUSTER4_DUTY50_TEST_SV
`define BASIC_DT_048_CLUSTER4_DUTY50_TEST_SV
...
class basic_dt_048_cluster4_duty50_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_048_cluster4_duty50_test)

    localparam string CASE_ID = "BASIC-DT-048";
    localparam string CASE_SEQUENCE = "basic_dt_048_cluster4_duty50_seq";
    localparam string CASE_SUMMARY = "1 MHz cluster size 4 duty-cycle 50 percent";
    localparam int unsigned HIT_COUNT = 8;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 4;
    localparam int unsigned CHANNEL_STRIDE = 1;
    localparam int unsigned FINE_BASE = 16;
