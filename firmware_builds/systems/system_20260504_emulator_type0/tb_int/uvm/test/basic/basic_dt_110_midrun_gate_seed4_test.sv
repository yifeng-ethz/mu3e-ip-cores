// basic_dt_110_midrun_gate_seed4_test.sv
// BASIC bucket test wrapper for BASIC-DT-110.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_110_MIDRUN_GATE_SEED4_TEST_SV
`define BASIC_DT_110_MIDRUN_GATE_SEED4_TEST_SV
...
class basic_dt_110_midrun_gate_seed4_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_110_midrun_gate_seed4_test)

    localparam string CASE_ID = "BASIC-DT-110";
    localparam string CASE_SEQUENCE = "basic_dt_110_midrun_gate_seed4_seq";
    localparam string CASE_SUMMARY = "Mid-run gate and ungate random timing seed 4";
    localparam int unsigned HIT_COUNT = 8;
    localparam int unsigned CHANNEL_BASE = 3;
