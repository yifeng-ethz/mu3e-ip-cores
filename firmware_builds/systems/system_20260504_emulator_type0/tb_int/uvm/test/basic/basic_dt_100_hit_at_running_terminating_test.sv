// basic_dt_100_hit_at_running_terminating_test.sv
// BASIC bucket test wrapper for BASIC-DT-100.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_100_HIT_AT_RUNNING_TERMINATING_TEST_SV
`define BASIC_DT_100_HIT_AT_RUNNING_TERMINATING_TEST_SV
...
class basic_dt_100_hit_at_running_terminating_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_100_hit_at_running_terminating_test)

    localparam string CASE_ID = "BASIC-DT-100";
    localparam string CASE_SEQUENCE = "basic_dt_100_hit_at_running_terminating_seq";
