// basic_dt_096_mixrr_emu_idle_test.sv
// BASIC bucket test wrapper for BASIC-DT-096.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_096_MIXRR_EMU_IDLE_TEST_SV
`define BASIC_DT_096_MIXRR_EMU_IDLE_TEST_SV
...
class basic_dt_096_mixrr_emu_idle_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_096_mixrr_emu_idle_test)

    localparam string CASE_ID = "BASIC-DT-096";
    localparam string CASE_SEQUENCE = "basic_dt_096_mixrr_emu_idle_seq";
