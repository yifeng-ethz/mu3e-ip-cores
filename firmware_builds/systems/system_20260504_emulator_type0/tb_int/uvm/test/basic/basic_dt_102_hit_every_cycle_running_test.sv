// basic_dt_102_hit_every_cycle_running_test.sv
// BASIC bucket test wrapper for BASIC-DT-102.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_102_HIT_EVERY_CYCLE_RUNNING_TEST_SV
`define BASIC_DT_102_HIT_EVERY_CYCLE_RUNNING_TEST_SV
...
class basic_dt_102_hit_every_cycle_running_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_102_hit_every_cycle_running_test)

    localparam string CASE_ID = "BASIC-DT-102";
    localparam string CASE_SEQUENCE = "basic_dt_102_hit_every_cycle_running_seq";
    localparam string CASE_SUMMARY = "Hit at every cycle of RUNNING saturation";
    ...
    localparam int unsigned FINE_BASE = 6;
    localparam int unsigned FINE_STRIDE = 7;
    localparam int unsigned HIT_GAP_CYCLES = 0;
