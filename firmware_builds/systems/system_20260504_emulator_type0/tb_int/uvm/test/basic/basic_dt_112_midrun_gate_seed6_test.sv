// basic_dt_112_midrun_gate_seed6_test.sv
// BASIC bucket test wrapper for BASIC-DT-112.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_112_MIDRUN_GATE_SEED6_TEST_SV
`define BASIC_DT_112_MIDRUN_GATE_SEED6_TEST_SV
...
class basic_dt_112_midrun_gate_seed6_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_112_midrun_gate_seed6_test)

    localparam string CASE_ID = "BASIC-DT-112";
    localparam string CASE_SEQUENCE = "basic_dt_112_midrun_gate_seed6_seq";
    localparam string CASE_SUMMARY = "Mid-run gate and ungate random timing seed 6";
    localparam int unsigned HIT_COUNT = 8;
    localparam int unsigned CHANNEL_BASE = 5;
    localparam int unsigned CHANNEL_SPAN = 8;
    localparam int unsigned CHANNEL_STRIDE = 6;
