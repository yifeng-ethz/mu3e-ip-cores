// basic_dt_093_rc_dt_two_runs_test.sv
// BASIC bucket test wrapper for BASIC-DT-093.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_093_RC_DT_TWO_RUNS_TEST_SV
`define BASIC_DT_093_RC_DT_TWO_RUNS_TEST_SV
...
class basic_dt_093_rc_dt_two_runs_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_093_rc_dt_two_runs_test)

    localparam string CASE_ID = "BASIC-DT-093";
    localparam string CASE_SEQUENCE = "basic_dt_093_rc_dt_two_runs_seq";
