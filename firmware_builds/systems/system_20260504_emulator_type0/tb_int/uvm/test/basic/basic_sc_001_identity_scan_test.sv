// basic_sc_001_identity_scan_test.sv
// BASIC bucket test wrapper for BASIC-SC-001.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_001_IDENTITY_SCAN_TEST_SV
`define BASIC_SC_001_IDENTITY_SCAN_TEST_SV
...
class basic_sc_001_identity_scan_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_001_identity_scan_test)

    localparam string CASE_ID = "BASIC-SC-001";
    localparam string CASE_SEQUENCE = "basic_sc_001_identity_scan_seq";
