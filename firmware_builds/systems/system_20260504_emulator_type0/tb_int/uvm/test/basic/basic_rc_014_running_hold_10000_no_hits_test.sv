// basic_rc_014_running_hold_10000_no_hits_test.sv
// BASIC bucket test wrapper for BASIC-RC-014.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_014_RUNNING_HOLD_10000_NO_HITS_TEST_SV
`define BASIC_RC_014_RUNNING_HOLD_10000_NO_HITS_TEST_SV
...
class basic_rc_014_running_hold_10000_no_hits_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_014_running_hold_10000_no_hits_test)

    localparam string CASE_ID = "BASIC-RC-014";
    localparam string CASE_SEQUENCE = "basic_rc_014_running_hold_10000_no_hits_seq";
