// basic_dt_056_cluster16_duty70_test.sv
// BASIC bucket test wrapper for BASIC-DT-056.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_056_CLUSTER16_DUTY70_TEST_SV
`define BASIC_DT_056_CLUSTER16_DUTY70_TEST_SV
...
class basic_dt_056_cluster16_duty70_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_056_cluster16_duty70_test)

    localparam string CASE_ID = "BASIC-DT-056";
    localparam string CASE_SEQUENCE = "basic_dt_056_cluster16_duty70_seq";
    localparam string CASE_SUMMARY = "1 MHz cluster size 16 duty-cycle 70 percent";
