// basic_rc_026_double_reset_5000cy_test.sv
// BASIC bucket test wrapper for BASIC-RC-026.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_026_DOUBLE_RESET_5000CY_TEST_SV
`define BASIC_RC_026_DOUBLE_RESET_5000CY_TEST_SV
...
class basic_rc_026_double_reset_5000cy_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_026_double_reset_5000cy_test)

    localparam string CASE_ID = "BASIC-RC-026";
    localparam string CASE_SEQUENCE = "basic_rc_026_double_reset_5000cy_seq";
