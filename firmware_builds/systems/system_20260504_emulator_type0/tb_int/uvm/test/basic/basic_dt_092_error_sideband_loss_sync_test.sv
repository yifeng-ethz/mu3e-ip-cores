// basic_dt_092_error_sideband_loss_sync_test.sv
// BASIC bucket test wrapper for BASIC-DT-092.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_092_ERROR_SIDEBAND_LOSS_SYNC_TEST_SV
`define BASIC_DT_092_ERROR_SIDEBAND_LOSS_SYNC_TEST_SV
...
class basic_dt_092_error_sideband_loss_sync_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_092_error_sideband_loss_sync_test)

    localparam string CASE_ID = "BASIC-DT-092";
    localparam string CASE_SEQUENCE = "basic_dt_092_error_sideband_loss_sync_seq";
