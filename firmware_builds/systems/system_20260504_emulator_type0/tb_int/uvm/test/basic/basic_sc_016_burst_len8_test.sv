// basic_sc_016_burst_len8_test.sv
// BASIC bucket test wrapper for BASIC-SC-016.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_016_BURST_LEN8_TEST_SV
`define BASIC_SC_016_BURST_LEN8_TEST_SV
...
class basic_sc_016_burst_len8_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_016_burst_len8_test)

    localparam string CASE_ID = "BASIC-SC-016";
    localparam string CASE_SEQUENCE = "basic_sc_016_burst_len8_seq";
    localparam string CASE_SUMMARY = "Burst read length 8";
