// basic_dt_015_mode_mixrr_to_real_test.sv
// BASIC bucket test wrapper for BASIC-DT-015.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_015_MODE_MIXRR_TO_REAL_TEST_SV
`define BASIC_DT_015_MODE_MIXRR_TO_REAL_TEST_SV
...
class basic_dt_015_mode_mixrr_to_real_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_015_mode_mixrr_to_real_test)

    localparam string CASE_ID = "BASIC-DT-015";
    localparam string CASE_SEQUENCE = "basic_dt_015_mode_mixrr_to_real_seq";
    localparam string CASE_SUMMARY = "MIX_RR to REAL mode switch with both sources active";
    ...
    localparam int unsigned FINE_BASE = 8;
    localparam int unsigned FINE_STRIDE = 1;
