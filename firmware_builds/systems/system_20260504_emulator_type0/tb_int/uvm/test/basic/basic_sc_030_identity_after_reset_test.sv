// basic_sc_030_identity_after_reset_test.sv
// BASIC bucket test wrapper for BASIC-SC-030.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_030_IDENTITY_AFTER_RESET_TEST_SV
`define BASIC_SC_030_IDENTITY_AFTER_RESET_TEST_SV
...
class basic_sc_030_identity_after_reset_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_030_identity_after_reset_test)

    localparam string CASE_ID = "BASIC-SC-030";
    localparam string CASE_SEQUENCE = "basic_sc_030_identity_after_reset_seq";
    localparam string CASE_SUMMARY = "Identity scan after RESET";
