// basic_dt_030_rate500k_real_full32_test.sv
// BASIC bucket test wrapper for BASIC-DT-030.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_030_RATE500K_REAL_FULL32_TEST_SV
`define BASIC_DT_030_RATE500K_REAL_FULL32_TEST_SV
...
class basic_dt_030_rate500k_real_full32_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_030_rate500k_real_full32_test)

    localparam string CASE_ID = "BASIC-DT-030";
    localparam string CASE_SEQUENCE = "basic_dt_030_rate500k_real_full32_seq";
    localparam string CASE_SUMMARY = "Rate sweep 500kHz per channel source real channel-set full32";
