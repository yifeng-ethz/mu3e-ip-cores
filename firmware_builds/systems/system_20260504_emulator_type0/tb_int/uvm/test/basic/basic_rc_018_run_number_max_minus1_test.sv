// basic_rc_018_run_number_max_minus1_test.sv
// BASIC bucket test wrapper for BASIC-RC-018.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_018_RUN_NUMBER_MAX_MINUS1_TEST_SV
`define BASIC_RC_018_RUN_NUMBER_MAX_MINUS1_TEST_SV
...
class basic_rc_018_run_number_max_minus1_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_018_run_number_max_minus1_test)

    localparam string CASE_ID = "BASIC-RC-018";
    localparam string CASE_SEQUENCE = "basic_rc_018_run_number_max_minus1_seq";
