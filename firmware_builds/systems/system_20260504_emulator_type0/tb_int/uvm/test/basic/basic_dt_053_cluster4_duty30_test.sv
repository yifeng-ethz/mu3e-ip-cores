// basic_dt_053_cluster4_duty30_test.sv
// BASIC bucket test wrapper for BASIC-DT-053.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_053_CLUSTER4_DUTY30_TEST_SV
`define BASIC_DT_053_CLUSTER4_DUTY30_TEST_SV
...
class basic_dt_053_cluster4_duty30_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_053_cluster4_duty30_test)

    localparam string CASE_ID = "BASIC-DT-053";
    localparam string CASE_SEQUENCE = "basic_dt_053_cluster4_duty30_seq";
    localparam string CASE_SUMMARY = "1 MHz cluster size 4 duty-cycle 30 percent";
