// basic_sc_022_cross_slave_32_reads_test.sv
// BASIC bucket test wrapper for BASIC-SC-022.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_022_CROSS_SLAVE_32_READS_TEST_SV
`define BASIC_SC_022_CROSS_SLAVE_32_READS_TEST_SV
...
class basic_sc_022_cross_slave_32_reads_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_022_cross_slave_32_reads_test)

    localparam string CASE_ID = "BASIC-SC-022";
    localparam string CASE_SEQUENCE = "basic_sc_022_cross_slave_32_reads_seq";
    localparam string CASE_SUMMARY = "Thirty-two cross-slave back-to-back reads";
    localparam int unsigned HIT_COUNT = 2;
    localparam int unsigned CHANNEL_BASE = 12;
