// basic_rc_012_sync_hold_100_test.sv
// BASIC bucket test wrapper for BASIC-RC-012.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_RC_012_SYNC_HOLD_100_TEST_SV
`define BASIC_RC_012_SYNC_HOLD_100_TEST_SV
...
class basic_rc_012_sync_hold_100_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_rc_012_sync_hold_100_test)

    localparam string CASE_ID = "BASIC-RC-012";
    localparam string CASE_SEQUENCE = "basic_rc_012_sync_hold_100_seq";
