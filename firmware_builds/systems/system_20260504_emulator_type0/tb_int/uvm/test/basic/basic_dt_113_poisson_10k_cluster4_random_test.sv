// basic_dt_113_poisson_10k_cluster4_random_test.sv
// BASIC bucket test wrapper for BASIC-DT-113.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_113_POISSON_10K_CLUSTER4_RANDOM_TEST_SV
`define BASIC_DT_113_POISSON_10K_CLUSTER4_RANDOM_TEST_SV
...
class basic_dt_113_poisson_10k_cluster4_random_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_113_poisson_10k_cluster4_random_test)

    localparam string CASE_ID = "BASIC-DT-113";
    localparam string CASE_SEQUENCE = "basic_dt_113_poisson_10k_cluster4_random_seq";
    localparam string CASE_SUMMARY = "Poisson 10 kHz per channel cluster mean 4 random spatial spread";
    localparam int unsigned HIT_COUNT = 8;
    localparam int unsigned CHANNEL_BASE = 0;
    localparam int unsigned CHANNEL_SPAN = 16;
    localparam int unsigned CHANNEL_STRIDE = 3;
    localparam int unsigned FINE_BASE = 17;
