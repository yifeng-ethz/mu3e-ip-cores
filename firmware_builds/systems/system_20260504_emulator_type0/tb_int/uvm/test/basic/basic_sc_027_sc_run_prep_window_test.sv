// basic_sc_027_sc_run_prep_window_test.sv
// BASIC bucket test wrapper for BASIC-SC-027.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_SC_027_SC_RUN_PREP_WINDOW_TEST_SV
`define BASIC_SC_027_SC_RUN_PREP_WINDOW_TEST_SV
...
class basic_sc_027_sc_run_prep_window_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_sc_027_sc_run_prep_window_test)

    localparam string CASE_ID = "BASIC-SC-027";
    localparam string CASE_SEQUENCE = "basic_sc_027_sc_run_prep_window_seq";
    localparam string CASE_SUMMARY = "SC burst during RUN_PREP reset window";
