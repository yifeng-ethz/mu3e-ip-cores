// basic_dt_052_cluster8_duty100_test.sv
// BASIC bucket test wrapper for BASIC-DT-052.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_052_CLUSTER8_DUTY100_TEST_SV
`define BASIC_DT_052_CLUSTER8_DUTY100_TEST_SV
...
class basic_dt_052_cluster8_duty100_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_052_cluster8_duty100_test)

    localparam string CASE_ID = "BASIC-DT-052";
    localparam string CASE_SEQUENCE = "basic_dt_052_cluster8_duty100_seq";
    localparam string CASE_SUMMARY = "1 MHz cluster size 8 duty-cycle 100 percent";
