// basic_dt_091_hotspot_ch4_test.sv
// BASIC bucket test wrapper for BASIC-DT-091.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260505
// Change  : Add bucket-isolated BASIC case test.

`ifndef BASIC_DT_091_HOTSPOT_CH4_TEST_SV
`define BASIC_DT_091_HOTSPOT_CH4_TEST_SV
...
class basic_dt_091_hotspot_ch4_test extends tb_int_smoke_test;
    `uvm_component_utils(basic_dt_091_hotspot_ch4_test)

    localparam string CASE_ID = "BASIC-DT-091";
    localparam string CASE_SEQUENCE = "basic_dt_091_hotspot_ch4_seq";
