// prof_dt_018_poisson_emu_100khz_cluster8_test.sv
...
package prof_dt_018_poisson_emu_100khz_cluster8_test_pkg;

    import uvm_pkg::*;
    import tb_int_base_test_pkg::*;
    import prof_dt_018_poisson_emu_100khz_cluster8_seq_pkg::*;
    `include "uvm_macros.svh"

    class prof_dt_018_poisson_emu_100khz_cluster8_test extends tb_int_base_test;
        `uvm_component_utils(prof_dt_018_poisson_emu_100khz_cluster8_test)
        ...
        virtual task run_phase(uvm_phase phase);
            prof_dt_018_poisson_emu_100khz_cluster8_seq seq;
            ...
            seq = prof_dt_018_poisson_emu_100khz_cluster8_seq::type_id::create("seq");
...
module prof_dt_018_poisson_emu_100khz_cluster8_anchor;
    import prof_dt_018_poisson_emu_100khz_cluster8_test_pkg::*;
endmodule

bind tb_int_top prof_dt_018_poisson_emu_100khz_cluster8_anchor prof_dt_018_poisson_emu_100khz_cluster8_anchor_i();
