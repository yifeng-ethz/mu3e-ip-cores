// prof_rc_006_long_running_soak_10m_guard512_test.sv
...
package prof_rc_006_long_running_soak_10m_guard512_test_pkg;

    import uvm_pkg::*;
    import tb_int_base_test_pkg::*;
    import prof_rc_006_long_running_soak_10m_guard512_seq_pkg::*;
    `include "uvm_macros.svh"

    class prof_rc_006_long_running_soak_10m_guard512_test extends tb_int_base_test;
        `uvm_component_utils(prof_rc_006_long_running_soak_10m_guard512_test)
        ...
        virtual task run_phase(uvm_phase phase);
            prof_rc_006_long_running_soak_10m_guard512_seq seq;
            ...
            seq = prof_rc_006_long_running_soak_10m_guard512_seq::type_id::create("seq");
...
module prof_rc_006_long_running_soak_10m_guard512_anchor;
    import prof_rc_006_long_running_soak_10m_guard512_test_pkg::*;
endmodule

bind tb_int_top prof_rc_006_long_running_soak_10m_guard512_anchor prof_rc_006_long_running_soak_10m_guard512_anchor_i();
