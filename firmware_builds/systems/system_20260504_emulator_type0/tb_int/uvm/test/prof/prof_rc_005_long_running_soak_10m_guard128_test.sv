// prof_rc_005_long_running_soak_10m_guard128_test.sv
...
package prof_rc_005_long_running_soak_10m_guard128_test_pkg;

    import uvm_pkg::*;
    import tb_int_base_test_pkg::*;
    import prof_rc_005_long_running_soak_10m_guard128_seq_pkg::*;
    `include "uvm_macros.svh"

    class prof_rc_005_long_running_soak_10m_guard128_test extends tb_int_base_test;
        `uvm_component_utils(prof_rc_005_long_running_soak_10m_guard128_test)
        ...
        virtual task run_phase(uvm_phase phase);
            prof_rc_005_long_running_soak_10m_guard128_seq seq;
            ...
            seq = prof_rc_005_long_running_soak_10m_guard128_seq::type_id::create("seq");
...
module prof_rc_005_long_running_soak_10m_guard128_anchor;
    import prof_rc_005_long_running_soak_10m_guard128_test_pkg::*;
endmodule

bind tb_int_top prof_rc_005_long_running_soak_10m_guard128_anchor prof_rc_005_long_running_soak_10m_guard128_anchor_i();
