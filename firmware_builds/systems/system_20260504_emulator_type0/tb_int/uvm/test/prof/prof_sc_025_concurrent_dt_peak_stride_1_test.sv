// prof_sc_025_concurrent_dt_peak_stride_1_test.sv
...
package prof_sc_025_concurrent_dt_peak_stride_1_test_pkg;

    import uvm_pkg::*;
    import tb_int_base_test_pkg::*;
    import prof_sc_025_concurrent_dt_peak_stride_1_seq_pkg::*;
    `include "uvm_macros.svh"

    class prof_sc_025_concurrent_dt_peak_stride_1_test extends tb_int_base_test;
        `uvm_component_utils(prof_sc_025_concurrent_dt_peak_stride_1_test)
        ...
        virtual task run_phase(uvm_phase phase);
            prof_sc_025_concurrent_dt_peak_stride_1_seq seq;
            ...
            seq = prof_sc_025_concurrent_dt_peak_stride_1_seq::type_id::create("seq");
...
module prof_sc_025_concurrent_dt_peak_stride_1_anchor;
    import prof_sc_025_concurrent_dt_peak_stride_1_test_pkg::*;
endmodule

bind tb_int_top prof_sc_025_concurrent_dt_peak_stride_1_anchor prof_sc_025_concurrent_dt_peak_stride_1_anchor_i();
