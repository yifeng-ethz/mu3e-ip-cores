...
module phase4_5_sim_row_p45_031_lane_none_0x00000001_default_dir_tb;
    localparam string ROW_ID = "p45_031_lane_none_0x00000001_default_dir";
    localparam string AXIS_SECTION = "4.5.sanity-neg";
    localparam string EXPECTED_BEHAVIOR = "sanity-negative: lane mask supersedes channel mask";
    localparam int unsigned NUM_LANES = 8;
    localparam int unsigned NUM_BINS = 256;
    localparam logic [7:0] LANE_MASK = 8'h00;
    localparam logic [31:0] CHANNEL_MASK = 32'h00000001;
    localparam logic [15:0] RATE_88FP = 16'h0800;
    localparam logic [1:0] HIT_MODE = 2'b00;
    localparam bit SANITY_NEGATIVE = 1'b1;
