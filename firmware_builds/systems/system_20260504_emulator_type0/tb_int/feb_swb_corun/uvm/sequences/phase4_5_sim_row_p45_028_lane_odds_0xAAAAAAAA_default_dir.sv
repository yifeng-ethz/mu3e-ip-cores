...
module phase4_5_sim_row_p45_028_lane_odds_0xAAAAAAAA_default_dir_tb;
    localparam string ROW_ID = "p45_028_lane_odds_0xAAAAAAAA_default_dir";
    localparam string AXIS_SECTION = "4.5.cross";
    localparam string EXPECTED_BEHAVIOR = "odd lanes x odd channels; double-odd selection";
    localparam int unsigned NUM_LANES = 8;
    localparam int unsigned NUM_BINS = 256;
    localparam logic [7:0] LANE_MASK = 8'hAA;
