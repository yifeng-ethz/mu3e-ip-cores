...
module phase4_5_sim_row_p45_005_all_lanes_0x00000001_default_dir_tb;
    localparam string ROW_ID = "p45_005_all_lanes_0x00000001_default_dir";
    localparam string AXIS_SECTION = "4.5.1";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.1: single channel 0; bins 1..31 = 0; UNDERFLOW=0 OVERFLOW=0";
