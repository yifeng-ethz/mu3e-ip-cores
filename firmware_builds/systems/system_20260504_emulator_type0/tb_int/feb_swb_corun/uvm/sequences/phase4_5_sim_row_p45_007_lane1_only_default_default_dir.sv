...
module phase4_5_sim_row_p45_007_lane1_only_default_default_dir_tb;
    localparam string ROW_ID = "p45_007_lane1_only_default_default_dir";
    localparam string AXIS_SECTION = "4.5.lane_iso";
    localparam string EXPECTED_BEHAVIOR = "lane 1 admit-only; TOTAL_HITS ~= 1/8 of baseline";
    localparam int unsigned NUM_LANES = 8;
    localparam int unsigned NUM_BINS = 256;
    localparam logic [7:0] LANE_MASK = 8'h02;
