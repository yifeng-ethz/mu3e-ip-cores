...
module phase4_5_sim_row_p45_000_all_lanes_0xFFFFFFFF_default_dir_tb;
    localparam string ROW_ID = "p45_000_all_lanes_0xFFFFFFFF_default_dir";
    localparam string AXIS_SECTION = "4.5.1";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.1: all 32 channels populated (Poisson spread); UNDERFLOW=0 OVERFLOW=0";
