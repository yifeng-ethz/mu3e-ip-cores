...
module phase4_5_sim_row_p45_021_all_lanes_default_default_burst_tb;
    localparam string ROW_ID = "p45_021_all_lanes_default_default_burst";
    localparam string AXIS_SECTION = "4.5.3";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.3 burst-mode cluster centered at burst_center";
    ...
    localparam logic [1:0] HIT_MODE = 2'b01;
