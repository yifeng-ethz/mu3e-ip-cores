...
module phase4_5_sim_row_p45_025_lane_none_default_default_dir_tb;
    localparam string ROW_ID = "p45_025_lane_none_default_default_dir";
    localparam string AXIS_SECTION = "4.5.sanity-neg";
    localparam string EXPECTED_BEHAVIOR = "sanity-negative: TOTAL_HITS == 0 (all lanes blocked)";
