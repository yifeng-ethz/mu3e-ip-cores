...
module phase4_5_sim_row_p45_029_lane0only_0x00000001_default_dir_tb;
    localparam string ROW_ID = "p45_029_lane0only_0x00000001_default_dir";
    localparam string AXIS_SECTION = "4.5.cross";
    localparam string EXPECTED_BEHAVIOR = "most-restrictive: only lane 0 channel 0 populated";
