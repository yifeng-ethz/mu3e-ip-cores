...
module phase4_5_sim_row_p45_006_lane0_only_default_default_dir_tb;
    localparam string ROW_ID = "p45_006_lane0_only_default_default_dir";
    localparam string AXIS_SECTION = "4.5.lane_iso";
    localparam string EXPECTED_BEHAVIOR = "lane 0 admit-only; TOTAL_HITS ~= 1/8 of baseline";
