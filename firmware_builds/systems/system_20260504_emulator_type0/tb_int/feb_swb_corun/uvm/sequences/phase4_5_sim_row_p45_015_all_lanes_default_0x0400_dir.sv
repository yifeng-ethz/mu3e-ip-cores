...
module phase4_5_sim_row_p45_015_all_lanes_default_0x0400_dir_tb;
    localparam string ROW_ID = "p45_015_all_lanes_default_0x0400_dir";
    localparam string AXIS_SECTION = "4.5.2";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.2 rate 0x0400; ratio_to_prev ~= 2.0 until knee";
    ...
    localparam logic [15:0] RATE_88FP = 16'h0400;
