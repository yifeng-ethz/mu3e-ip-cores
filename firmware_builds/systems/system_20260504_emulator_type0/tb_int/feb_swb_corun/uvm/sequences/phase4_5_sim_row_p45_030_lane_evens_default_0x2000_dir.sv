...
module phase4_5_sim_row_p45_030_lane_evens_default_0x2000_dir_tb;
    localparam string ROW_ID = "p45_030_lane_evens_default_0x2000_dir";
    localparam string AXIS_SECTION = "4.5.cross";
    localparam string EXPECTED_BEHAVIOR = "even lanes x high rate; per-lane saturation check";
    localparam int unsigned NUM_LANES = 8;
    localparam int unsigned NUM_BINS = 256;
    localparam logic [7:0] LANE_MASK = 8'h55;
