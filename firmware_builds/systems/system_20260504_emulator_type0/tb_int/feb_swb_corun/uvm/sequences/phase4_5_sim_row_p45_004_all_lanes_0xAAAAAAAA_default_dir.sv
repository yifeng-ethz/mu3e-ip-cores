...
module phase4_5_sim_row_p45_004_all_lanes_0xAAAAAAAA_default_dir_tb;
    localparam string ROW_ID = "p45_004_all_lanes_0xAAAAAAAA_default_dir";
    localparam string AXIS_SECTION = "4.5.1";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.1: odd channels populated; even bins = 0; UNDERFLOW=0 OVERFLOW=0";
    localparam int unsigned NUM_LANES = 8;
    localparam int unsigned NUM_BINS = 256;
    localparam logic [7:0] LANE_MASK = 8'hFF;
    localparam logic [31:0] CHANNEL_MASK = 32'hAAAAAAAA;
