...
module phase4_5_sim_row_p45_022_all_lanes_default_default_periodic_tb;
    localparam string ROW_ID = "p45_022_all_lanes_default_default_periodic";
    localparam string AXIS_SECTION = "4.5.3";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.3 periodic-mode delta-function histogram";
    localparam int unsigned NUM_LANES = 8;
    localparam int unsigned NUM_BINS = 256;
    localparam logic [7:0] LANE_MASK = 8'hFF;
    localparam logic [31:0] CHANNEL_MASK = 32'hFFFFFFFF;
    localparam logic [15:0] RATE_88FP = 16'h0800;
    localparam logic [1:0] HIT_MODE = 2'b11;
