...
module phase4_5_sim_row_p45_019_all_lanes_default_0x4000_dir_tb;
    localparam string ROW_ID = "p45_019_all_lanes_default_0x4000_dir";
    localparam string AXIS_SECTION = "4.5.2";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.2 rate 0x4000; ratio_to_prev ~= 2.0 until knee";
    ...
    localparam logic [15:0] RATE_88FP = 16'h4000;
