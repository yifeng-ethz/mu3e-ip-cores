...
module phase4_5_sim_row_p45_023_lane_evens_default_default_dir_tb;
    localparam string ROW_ID = "p45_023_lane_evens_default_default_dir";
    localparam string AXIS_SECTION = "4.5.cross";
    localparam string EXPECTED_BEHAVIOR = "even lanes only; TOTAL_HITS ~= 4/8 of all-lanes baseline";
