...
module phase4_5_sim_row_p45_027_lane_evens_0x55555555_default_dir_tb;
    localparam string ROW_ID = "p45_027_lane_evens_0x55555555_default_dir";
    localparam string AXIS_SECTION = "4.5.cross";
    localparam string EXPECTED_BEHAVIOR = "even lanes x even channels; double-even selection";
