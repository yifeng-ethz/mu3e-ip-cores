...
module phase4_5_sim_row_p45_001_all_lanes_0x0000FFFF_default_dir_tb;
    localparam string ROW_ID = "p45_001_all_lanes_0x0000FFFF_default_dir";
    localparam string AXIS_SECTION = "4.5.1";
    localparam string EXPECTED_BEHAVIOR = "section 4.5.1: channels 0..15 populated; bins 16..31 = 0; UNDERFLOW=0 OVERFLOW=0";
