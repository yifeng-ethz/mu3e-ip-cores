...
module tb_top;
    ...
    task automatic drive_opq_frame_lane0(
        ...
        opq_if0.drive_beat({ts_tag, 16'd1}, 4'b0000, 1'b0, 1'b0, 1'b0, 64'd0);
        opq_if0.drive_beat(32'hc0010000, 4'b0000, 1'b0, 1'b0, 1'b0, 64'd0);
        opq_if0.drive_beat(payload, 4'b0000, 1'b0, 1'b0, 1'b1, meta_bits);
    ...
    task automatic drive_opq_frame_lane1(
        ...
        opq_if1.drive_beat({ts_tag, 16'd1}, 4'b0000, 1'b0, 1'b0, 1'b0, 64'd0);
        opq_if1.drive_beat(32'hc0010001, 4'b0000, 1'b0, 1'b0, 1'b0, 64'd0);
        opq_if1.drive_beat(payload, 4'b0000, 1'b0, 1'b0, 1'b1, meta_bits);
    ...
    initial begin
        ...
        if ($test$plusargs("FEB_SWB_SELF_SMOKE")) begin
            ...
            fork
                feb_if0.drive_beat({4'h0, payload0}, 1'b1, 1'b1, 1'b1,
                                   meta_bits0, 4'd0, 4'd0, 32'd100000);
                feb_if1.drive_beat({4'h0, payload1}, 1'b1, 1'b1, 1'b1,
                                   meta_bits1, 4'd0, 4'd0, 32'd100000);
                begin
