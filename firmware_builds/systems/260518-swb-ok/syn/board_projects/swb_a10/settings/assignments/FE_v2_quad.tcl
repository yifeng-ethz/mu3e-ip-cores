...
# trigger intput
#set_instance_assignment -name INPUT_TERMINATION DIFFERENTIAL -to trigger[0]
#set_location_assignment PIN_AB9 -to trigger[0]
#set_instance_assignment -name IO_STANDARD LVDS -to trigger[0]

#set_instance_assignment -name INPUT_TERMINATION DIFFERENTIAL -to trigger[1]
#set_location_assignment PIN_A14 -to trigger[1]
#set_instance_assignment -name IO_STANDARD LVDS -to trigger[1]

# Looking onto the FEB in the mini grate the connector is:
# 3V3 GND 7 6 5 4 3 2 1
