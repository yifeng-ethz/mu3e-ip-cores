...
- Timestamp: `2026-04-29T21:48:38`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 checksum 0x13A9CC2D, real lane3 10k source-scope isolation fix`
- SC link: `2`
- FEB target: `7`
- Sources: `real`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_10k` | `real` | `lane3` | `0x00000008` | `0x00000000` | `0x00000008` | `rate` | 9999 | 10000 | -1 | 0 | 31794 | 0 | 0 | 0 | `PASS` |
