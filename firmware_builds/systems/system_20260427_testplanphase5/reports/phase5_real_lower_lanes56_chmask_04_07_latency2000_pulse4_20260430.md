...
- Real hits per lane for rate expectation: `4`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 186678 | 0 | 1203353 | 16910 | 3147389521 | 3147389521 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3147389521`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `1507412`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `186678` / dropped `0`
- Histogram last interval: `499566` / dropped `0`
