...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61301 | `emulator` | `header` | 12500 | 1072228 | 0 | 25990462 | 0 | 11194203990 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `11194203990`
- Emulator frame delta: `52096`
- Frame CRC delta: `0`
- Frame actual-hit delta: `27587613`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1072228` / dropped `0`
- Histogram last interval: `2499995` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'delay-hit-t', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_header_mult1_delay_hit_t_cluster31_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_header_mult1_delay_hit_t_cluster31_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.19205371197313, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±259905` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x00003AD4` |
