...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 49100 | `real` | `periodic` | 1250 | 86923 | 0 | 647122 | 0 | 4070286198 | 4070286198 | `PASS` |
...
- Histogram profile/readback: `{'profile': 'rate', 'description': 'post-hit channel/rate histogram', 'uid': 1212765012, 'meta': 436289965, 'control': 256, 'left_bound': 0, 'right_bound': 256, 'bin_width': 1, 'key_loc': 639837726, 'key_value': 0, 'interval_cfg': 125000000}`
- Debug overrides: `{'mts_expected_latency': None, 'mts_delay_ts_field': 'keep', 'mts_drop_delay_error': 'keep', 'ring_filter_inerr': 'keep'}`
- Source mux selected beat delta: `4070286198`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `767760`
- Post-end clean: `yes`
