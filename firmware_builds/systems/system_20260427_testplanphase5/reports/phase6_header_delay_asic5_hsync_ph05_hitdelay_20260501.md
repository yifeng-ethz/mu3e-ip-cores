...
- Timestamp: `2026-05-01T17:46:53`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000DF`
- LVDS lane-go mask: `0x00000020`
...
- Histogram filter key value: `0x00000005`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `header` | 12500 | 1530944 | 0 | 46070880 | 0 | 13524614301 | 0 | 0 | `PASS` |
...
- Source mux selected beat delta: `13524614301`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `48659072`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1530944` / dropped `0`
- Histogram last interval: `4395584` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'delay-hit-t', 'csv': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_header_delay_asic5_hsync_ph05_hitdelay_20260501.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_header_delay_asic5_hsync_ph05_hitdelay_20260501.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.183600676245987, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±460709` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | `adaptive` | 0 | `0x0000008A` | `0x0000008A` | 0 | 0 | 0 | 0 |
| 1 | 0 | `adaptive` | 0 | `0x0000008A` | `0x0000008A` | 0 | 0 | 0 | 0 |
| 2 | 0 | `adaptive` | 0 | `0x00004519` | `0x00004519` | 0 | 0 | 0 | 0 |
| 3 | 0 | `adaptive` | 0 | `0x0000008A` | `0x0000008A` | 0 | 0 | 0 | 0 |
| 4 | 0 | `adaptive` | 0 | `0x0000334A` | `0x0000334A` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x00004957` | `0x00004957` | 0 | 0 | 0 | 0 |
| 6 | 0 | `adaptive` | 0 | `0x0000008A` | `0x0000008A` | 0 | 0 | 0 | 0 |
| 7 | 0 | `adaptive` | 0 | `0x0000008A` | `0x0000008A` | 0 | 0 | 0 | 0 |
