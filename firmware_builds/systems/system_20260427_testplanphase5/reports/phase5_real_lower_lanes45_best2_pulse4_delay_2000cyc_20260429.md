...
- Timestamp: `2026-04-30T00:38:15`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000CF`
- LVDS lane-go mask: `0x00000030`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 496068 | 0 | 10003752 | 0 | 3312568122 | 3312568122 | `PASS` |
...
- Source mux selected beat delta: `3312568122`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `12721740`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `496068` / dropped `0`
- Histogram last interval: `3960469` / dropped `0`
