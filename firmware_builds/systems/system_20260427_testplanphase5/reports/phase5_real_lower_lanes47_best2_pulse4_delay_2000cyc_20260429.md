...
- Timestamp: `2026-04-30T00:38:52`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x0000006F`
- LVDS lane-go mask: `0x00000090`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 134587 | 0 | 9835416 | 0 | 3327862316 | 3327862316 | `PASS` |
...
- Source mux selected beat delta: `3327862316`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `12181495`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `134587` / dropped `0`
- Histogram last interval: `3856230` / dropped `0`
