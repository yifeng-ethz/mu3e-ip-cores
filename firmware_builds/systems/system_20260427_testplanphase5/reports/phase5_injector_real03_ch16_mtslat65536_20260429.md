...
- MTS expected latency override: `65536`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `mixed` | `periodic` | 12500 | 49627 | 0 | 46932 | 41214 | 3196089617 | 3196089617 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 65536, 'mts_delay_ts_field': 'keep', 'mts_drop_delay_error': 'keep', 'ring_filter_inerr': 'keep'}`
- Source mux selected beat delta: `3196089617`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `46815`
- Post-end clean: `yes`
