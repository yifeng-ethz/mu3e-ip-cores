...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1944732 | 0 | 5760112 | 0 | 3290392677 | 3290392677 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3290392677`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7158080`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1944732` / dropped `0`
- Histogram last interval: `2262088` / dropped `0`
