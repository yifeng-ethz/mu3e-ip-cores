...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 48615 | `real` | `periodic` | 1250 | 31948383 | 0 | 364660485 | 348512153 | 16560023883 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000001E` | `0x0000001E` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000001E` | `0x0000001E` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044AD` | `0x000044AD` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000001E` | `0x0000001E` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032DE` | `0x000032DE` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048EB` | `0x000048EB` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000001E` | `0x0000001E` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000001E` | `0x0000001E` | 0 | 0 | 0 | 0 |
