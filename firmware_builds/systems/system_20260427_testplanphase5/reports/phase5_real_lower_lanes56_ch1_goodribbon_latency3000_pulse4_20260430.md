...
- MTS expected latency override: `3000`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 38527 | 0 | 402973 | 0 | 3228004536 | 3228004536 | `PASS` |
...
- Debug overrides: `{'mts_expected_latency': 3000, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3228004536`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `502500`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `38527` / dropped `0`
- Histogram last interval: `166402` / dropped `0`
