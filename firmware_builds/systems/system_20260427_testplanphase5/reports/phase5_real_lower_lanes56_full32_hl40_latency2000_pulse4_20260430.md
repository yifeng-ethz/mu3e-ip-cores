...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1165455 | 0 | 9471791 | 4908 | 3226529892 | 3226529892 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3226529892`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11870136`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1165455` / dropped `0`
- Histogram last interval: `3794247` / dropped `0`
