...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52107 | `real` | `periodic` | 1250 | 1396065 | 0 | 5518671 | 0 | 3150027648 | 3150027648 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3150027648`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6680416`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1396065` / dropped `0`
- Histogram last interval: `2296995` / dropped `0`
