...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61302 | `emulator` | `header` | 12500 | 1506100 | 0 | 51909314 | 0 | 11154885651 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `11154885651`
- Emulator frame delta: `49047`
- Frame CRC delta: `0`
- Frame actual-hit delta: `54954258`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1506100` / dropped `0`
- Histogram last interval: `4999999` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'delay-hit-t', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_header_mult2_delay_hit_t_cluster31_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_header_mult2_delay_hit_t_cluster31_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.191067554056644, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±519093` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x00004D69` |
