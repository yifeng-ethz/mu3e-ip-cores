...
|---:|---|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `delay_100k` | `real` | `lane2` | `0x00000004` | `0x000000FB` | `0x00000000` | `0x00000004` | `delay-mts-both` | 1736960 | 0 | 0 | 0 | 6687216 | 0 | 0 | 0 | `PASS` |
| 1 | `delay_100k` | `real` | `lane3` | `0x00000008` | `0x000000F7` | `0x00000000` | `0x00000008` | `delay-mts-both` | 827124 | 0 | 0 | 0 | 3422841 | 21 | 0 | 0 | `FAIL` |
| 2 | `delay_100k` | `real` | `lane7` | `0x00000080` | `0x0000007F` | `0x00000000` | `0x00000080` | `delay-mts-both` | 1390398 | 0 | 0 | 0 | 5882431 | 170755 | 0 | 0 | `FAIL` |
