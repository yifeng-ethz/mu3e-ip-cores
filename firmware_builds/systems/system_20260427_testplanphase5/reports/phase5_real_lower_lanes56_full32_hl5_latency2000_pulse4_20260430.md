...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1276457 | 0 | 10008663 | 1810661 | 3263101566 | 3263101566 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3263101566`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11818666`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1276457` / dropped `0`
- Histogram last interval: `3895798` / dropped `0`
