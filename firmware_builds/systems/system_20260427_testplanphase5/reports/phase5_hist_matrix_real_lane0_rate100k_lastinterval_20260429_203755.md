...
- Timestamp: `2026-04-29T20:37:55`
- Firmware vehicle: `top_nostp_pipe dual-MTS checksum 0x13DB4566, resume real lane0 ch16 cfg, last-interval rate readout`
- SC link: `2`
- FEB target: `7`
- Sources: `real`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `real` | `lane0` | `0x00000001` | `0x00000000` | `0x00000001` | `rate` | 0 | 0 | 2232806 | 0 | 0 | 927323 | `FAIL` |
