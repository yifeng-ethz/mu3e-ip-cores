...
- Timestamp: `2026-04-29T21:47:39`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 checksum 0x13A9CC2D, real lane0 10k source-scope isolation fix`
- SC link: `2`
- FEB target: `7`
- Sources: `real`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_10k` | `real` | `lane0` | `0x00000001` | `0x00000000` | `0x00000001` | `rate` | 9998 | 10000 | -2 | 0 | 32229 | 0 | 0 | 0 | `PASS` |
