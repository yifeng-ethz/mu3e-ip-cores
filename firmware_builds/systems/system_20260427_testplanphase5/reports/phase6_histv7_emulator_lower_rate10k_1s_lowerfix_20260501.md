...
- Active emulator lanes: `0x000000F0`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 46120 | `emulator` | `periodic` | 12500 | 39996 | 0 | 124940 | 0 | 3815791047 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `3815791047`
- Emulator frame delta: `185859`
- Frame CRC delta: `0`
- Frame actual-hit delta: `148576`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `26096` / dropped `0`
- Histogram last interval: `39996` / dropped `0`
- JTAG histogram artifact: `{'enabled': False}`
- Rate expected/tolerance/error: `40000` / `±400` / `-4` hits
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 0 | `0x00000000` | `0x20041001` | `0x0000B926` |
| 1 | `0x00000001` | 0 | `0x00000000` | `0x20441001` | `0x0000B926` |
| 2 | `0x00000001` | 0 | `0x00000000` | `0x20841001` | `0x0000B926` |
| 3 | `0x00000001` | 0 | `0x00000000` | `0x20C41001` | `0x0000B926` |
| 4 | `0x00000001` | 1 | `0x00000001` | `0x21041001` | `0x00000000` |
| 5 | `0x00000001` | 1 | `0x00000001` | `0x21441001` | `0x00000000` |
| 6 | `0x00000001` | 1 | `0x00000001` | `0x21841001` | `0x00000000` |
| 7 | `0x00000001` | 1 | `0x00000001` | `0x21C41001` | `0x00000000` |
