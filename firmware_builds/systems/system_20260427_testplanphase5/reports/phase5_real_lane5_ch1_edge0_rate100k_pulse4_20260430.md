...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47440 | `real` | `periodic` | 1250 | 66562 | 0 | 233103 | 0 | 4163473560 | 4163473560 | `rate_out_of_tolerance` |
...
- Source mux selected beat delta: `4163473560`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `274252`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `47941` / dropped `0`
- Histogram last interval: `66562` / dropped `0`
- Rate expected/tolerance/error: `100000` / `±5000` / `-33438` hits
- Post-end clean: `yes`
