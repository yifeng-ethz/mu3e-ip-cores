...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45010 | `real` | `periodic` | 12500 | 0 | 0 | 0 | 0 | 3332516139 | 3332516139 | `real_source_not_reaching_histogram` |
...
- Source mux selected beat delta: `3332516139`
- Emulator frame delta: `486873`
- Frame CRC delta: `0`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000000` | 1 | `0x00000009` | `0x20041001` | `0x00002816` |
| 1 | `0x00000000` | 1 | `0x00000009` | `0x20441001` | `0x00002816` |
| 2 | `0x00000000` | 1 | `0x00000009` | `0x20841001` | `0x00002816` |
| 3 | `0x00000000` | 1 | `0x00000009` | `0x20C41001` | `0x00002816` |
| 4 | `0x00000000` | 1 | `0x00000009` | `0x21041001` | `0x00002816` |
| 5 | `0x00000000` | 1 | `0x00000009` | `0x21441001` | `0x00002816` |
| 6 | `0x00000000` | 1 | `0x00000009` | `0x21841001` | `0x00002816` |
| 7 | `0x00000000` | 1 | `0x00000009` | `0x21C41001` | `0x00002816` |
