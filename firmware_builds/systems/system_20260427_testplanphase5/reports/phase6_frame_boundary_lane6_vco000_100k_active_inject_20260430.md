...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 59907 | 0 | 733764 | 0 | 10180659771 | 0 | 0 | `PASS` |
...
- Source mux selected beat delta: `10180659771`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `795708`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `59907` / dropped `0`
- Histogram last interval: `99840` / dropped `0`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | `adaptive` | 0 | `0x00002583` | `0x00002583` | 0 | 0 | 0 | 0 |
| 1 | 0 | `adaptive` | 0 | `0xFFFFFFFF` | `0xFFFFFFFF` | 0 | 0 | 0 | 0 |
| 2 | 0 | `adaptive` | 0 | `0x0000447B` | `0x0000447B` | 0 | 0 | 0 | 0 |
| 3 | 0 | `adaptive` | 0 | `0xFFFFFFFF` | `0xFFFFFFFF` | 0 | 0 | 0 | 0 |
| 4 | 0 | `adaptive` | 0 | `0x00003702` | `0x00003702` | 0 | 0 | 0 | 0 |
| 5 | 0 | `adaptive` | 0 | `0x0000416F` | `0x0000416F` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x00000004` | `0x00000004` | 0 | 0 | 0 | 0 |
| 7 | 0 | `adaptive` | 0 | `0xFFFFFFFF` | `0xFFFFFFFF` | 0 | 0 | 0 | 0 |
