...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 62511 | `emulator` | `off` | 5000 | 4293524946 | 0 | 18625131 | 12212762 | 3674992796 | n/a | n/a | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3674992796`
- Emulator frame delta: `34907`
- Frame CRC delta: `0`
- Frame actual-hit delta: `15523988`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `4293524946` / dropped `0`
- Histogram last interval: `4245532` / dropped `0`
- JTAG histogram artifact: `{'enabled': False}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±186251` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000007` | `0x2004101F` | `0x00008424` |
