...
- Timestamp: `2026-05-01T11:00:38`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x0000008C`
- LVDS lane-go mask: `0x00000073`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 15974301 | 0 | 183418496 | 224549620 | 14348156140 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000002E` | `0x0000002E` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000002E` | `0x0000002E` | 0 | 0 | 0 | 0 |
| 2 | 0 | `adaptive` | 0 | `0x000044BD` | `0x000044BD` | 0 | 0 | 0 | 0 |
| 3 | 0 | `adaptive` | 0 | `0x0000002E` | `0x0000002E` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032EE` | `0x000032EE` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048FB` | `0x000048FB` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000002E` | `0x0000002E` | 0 | 0 | 0 | 0 |
| 7 | 0 | `adaptive` | 0 | `0x0000002E` | `0x0000002E` | 0 | 0 | 0 | 0 |
