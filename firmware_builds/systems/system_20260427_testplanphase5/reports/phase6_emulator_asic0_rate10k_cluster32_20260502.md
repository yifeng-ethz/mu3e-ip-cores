...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61100 | `emulator` | `periodic` | 12500 | 9998 | 0 | 103072 | 0 | 11166296214 | n/a | n/a | `rate_out_of_tolerance` |
...
- Histogram profile/readback: `{'profile': 'rate', 'description': 'pre-RBCAM hit_type1 global channel/rate histogram', 'toolkit_preset_source': 'toolkits/fe_scifi/board_bring_up/fe_scifi_board_bring_up_project.tcl', 'toolkit_preset_id': 'rate', 'uid': 1212765012, 'meta': 436339189, 'control': 256, 'left_bound': 0, 'right_bound': 256, 'bin_width': 1, 'key_loc': 639837726, 'key_value': 0, 'interval_cfg': 125000000, 'filter_enable_requested': False, 'filter_key_loc_requested': None, 'filter_key_value_requested': 0}`
...
- Source mux selected beat delta: `11166296214`
- Emulator frame delta: `47694`
- Frame CRC delta: `0`
- Frame actual-hit delta: `109281`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `2653` / dropped `0`
- Histogram last interval: `9998` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate10k_cluster32_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate10k_cluster32_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.186491201166064, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `320000` / `±3200` / `-310002` hits
- MTS discard/tolerance: `0` / `±1031` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x20041000` | `0x00002EC3` |
| 1 | `0x00000001` | 0 | `0x00000000` | `0x20441000` | `0x00000000` |
| 2 | `0x00000001` | 0 | `0x00000000` | `0x20841000` | `0x00000000` |
| 3 | `0x00000001` | 0 | `0x00000000` | `0x20C41000` | `0x00000000` |
| 4 | `0x00000001` | 0 | `0x00000000` | `0x21041000` | `0x00000000` |
| 5 | `0x00000001` | 0 | `0x00000000` | `0x21441000` | `0x00000000` |
| 6 | `0x00000001` | 0 | `0x00000000` | `0x21841000` | `0x00000000` |
| 7 | `0x00000001` | 0 | `0x00000000` | `0x21C41000` | `0x00000000` |
