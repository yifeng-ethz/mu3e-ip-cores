...
- MTS drop-delay-error override: `on`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 989582 | 0 | 9698941 | 0 | 3263725379 | 3263725379 | `diagnostic_bypass_clean_not_closure` |
...
- Debug overrides: `{'mts_expected_latency': 2000, 'mts_bypass_lapse': 'off', 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'on', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870961, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3263725379`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11522626`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `989582` / dropped `0`
- Histogram last interval: `3893759` / dropped `0`
