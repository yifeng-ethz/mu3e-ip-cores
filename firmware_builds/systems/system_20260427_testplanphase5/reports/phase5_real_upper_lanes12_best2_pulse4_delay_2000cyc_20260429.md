...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 4758053 | 0 | 13565966 | 385489 | 3248511488 | 3248511488 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3248511488`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `16813579`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `4758053` / dropped `0`
- Histogram last interval: `5557816` / dropped `0`
