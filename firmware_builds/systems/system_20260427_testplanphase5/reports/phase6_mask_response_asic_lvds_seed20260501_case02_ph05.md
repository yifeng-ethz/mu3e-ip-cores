...
- Timestamp: `2026-05-01T10:58:26`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x00000014`
- LVDS lane-go mask: `0x000000EB`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 19155807 | 0 | 218951720 | 275460348 | 14358632027 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x00000026` | `0x00000026` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x00000026` | `0x00000026` | 0 | 0 | 0 | 0 |
| 2 | 0 | `adaptive` | 0 | `0x000044B5` | `0x000044B5` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x00000026` | `0x00000026` | 0 | 0 | 0 | 0 |
| 4 | 0 | `adaptive` | 0 | `0x000032E6` | `0x000032E6` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048F3` | `0x000048F3` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x00000026` | `0x00000026` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x00000026` | `0x00000026` | 0 | 0 | 0 | 0 |
