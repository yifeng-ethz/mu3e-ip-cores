...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 398660 | 0 | 6265615 | 0 | 3314253935 | 3314253935 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3314253935`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7613844`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `398660` / dropped `0`
- Histogram last interval: `2362032` / dropped `0`
