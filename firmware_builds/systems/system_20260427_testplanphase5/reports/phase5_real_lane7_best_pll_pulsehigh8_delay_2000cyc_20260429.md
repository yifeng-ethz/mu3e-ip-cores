...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 691201 | 0 | 5744380 | 0 | 4491544402 | 4491544402 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `4491544402`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7130138`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `691201` / dropped `0`
- Histogram last interval: `2267828` / dropped `0`
