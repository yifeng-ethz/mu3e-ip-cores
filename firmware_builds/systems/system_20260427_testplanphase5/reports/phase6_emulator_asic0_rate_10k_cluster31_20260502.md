...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61210 | `emulator` | `periodic` | 12500 | 309969 | 0 | 3204842 | 0 | 11112231445 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `11112231445`
- Emulator frame delta: `43559`
- Frame CRC delta: `0`
- Frame actual-hit delta: `3402529`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `110484` / dropped `0`
- Histogram last interval: `309969` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_10k_cluster31_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_10k_cluster31_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.172009888105094, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `310000` / `±3100` / `-31` hits
- MTS discard/tolerance: `0` / `±32048` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x000018E2` |
