...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2249688 | 0 | 11896226 | 0 | 3414728651 | 3414728651 | `mts_discard_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 2000, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'keep', 'ring_filter_inerr': 'keep', 'mts_ctrl_written': 536870929}`
- Source mux selected beat delta: `3414728651`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `14627339`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2249688` / dropped `0`
- Histogram last interval: `4333448` / dropped `0`
