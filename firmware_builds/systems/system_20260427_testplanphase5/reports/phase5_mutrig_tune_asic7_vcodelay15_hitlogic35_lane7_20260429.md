...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 153476 | 0 | 6229267 | 0 | 3379675002 | 3379675002 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3379675002`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7637642`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `153476` / dropped `0`
- Histogram last interval: `2370409` / dropped `0`
