...
- Result: `5 PASS / 0 PASS_PARTIAL / 3 FAIL / 0 BLOCKED`
...
|---:|---|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `delay_100k` | `real` | `lane0` | `0x00000001` | `0x000000FE` | `0x00000000` | `0x00000001` | `delay-mts-both` | 1261806 | 0 | 0 | 0 | 5239325 | 0 | 0 | 0 | `PASS` |
| 1 | `delay_100k` | `real` | `lane1` | `0x00000002` | `0x000000FD` | `0x00000000` | `0x00000002` | `delay-mts-both` | 1336554 | 0 | 0 | 0 | 6221151 | 0 | 0 | 0 | `PASS` |
| 2 | `delay_100k` | `real` | `lane2` | `0x00000004` | `0x000000FB` | `0x00000000` | `0x00000004` | `delay-mts-both` | 1392804 | 0 | 0 | 0 | 6727149 | 766 | 0 | 0 | `FAIL` |
| 3 | `delay_100k` | `real` | `lane3` | `0x00000008` | `0x000000F7` | `0x00000000` | `0x00000008` | `delay-mts-both` | 794870 | 0 | 0 | 0 | 3460016 | 6 | 0 | 0 | `FAIL` |
| 4 | `delay_100k` | `real` | `lane4` | `0x00000010` | `0x000000EF` | `0x00000000` | `0x00000010` | `delay-mts-both` | 827185 | 0 | 0 | 0 | 4336102 | 0 | 0 | 0 | `PASS` |
| 5 | `delay_100k` | `real` | `lane5` | `0x00000020` | `0x000000DF` | `0x00000000` | `0x00000020` | `delay-mts-both` | 1297788 | 0 | 0 | 0 | 5648364 | 0 | 0 | 0 | `PASS` |
| 6 | `delay_100k` | `real` | `lane6` | `0x00000040` | `0x000000BF` | `0x00000000` | `0x00000040` | `delay-mts-both` | 649306 | 0 | 0 | 0 | 3593718 | 0 | 0 | 0 | `PASS` |
| 7 | `delay_100k` | `real` | `lane7` | `0x00000080` | `0x0000007F` | `0x00000000` | `0x00000080` | `delay-mts-both` | 1273162 | 0 | 0 | 0 | 5672946 | 236360 | 0 | 0 | `FAIL` |
