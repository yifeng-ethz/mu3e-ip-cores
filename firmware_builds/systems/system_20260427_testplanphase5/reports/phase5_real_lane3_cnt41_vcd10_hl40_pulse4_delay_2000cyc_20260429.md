...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 868323 | 0 | 2308144 | 0 | 3257384093 | 3257384093 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3257384093`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2872956`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `868323` / dropped `0`
- Histogram last interval: `931653` / dropped `0`
