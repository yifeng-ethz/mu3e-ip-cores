...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1776106 | 0 | 5758280 | 0 | 3221806683 | 3221806683 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3221806683`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7089191`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1776106` / dropped `0`
- Histogram last interval: `2358527` / dropped `0`
