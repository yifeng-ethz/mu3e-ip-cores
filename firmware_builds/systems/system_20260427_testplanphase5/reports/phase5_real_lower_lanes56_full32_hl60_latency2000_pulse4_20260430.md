...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1992215 | 0 | 8942039 | 1551965 | 3338853904 | 3338853904 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3338853904`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `10783606`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1992215` / dropped `0`
- Histogram last interval: `3690214` / dropped `0`
