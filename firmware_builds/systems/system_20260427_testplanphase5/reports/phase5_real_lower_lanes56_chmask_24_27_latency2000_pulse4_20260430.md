...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 84168 | 0 | 501999 | 0 | 3202458302 | 3202458302 | `PASS` |
...
- Source mux selected beat delta: `3202458302`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `634776`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `84168` / dropped `0`
- Histogram last interval: `201305` / dropped `0`
