...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 205742 | 0 | 5254931 | 0 | 3334445736 | 3334445736 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3334445736`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6581883`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `205742` / dropped `0`
- Histogram last interval: `2079008` / dropped `0`
