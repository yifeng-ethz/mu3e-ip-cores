...
- Result: `6 PASS / 0 PASS_PARTIAL / 2 FAIL / 0 BLOCKED`
...
|---:|---|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `delay_100k` | `real` | `lane0` | `0x00000001` | `0x000000FE` | `0x00000000` | `0x00000001` | `delay-mts-both` | 1099426 | 0 | 0 | 0 | 4931431 | 875 | 0 | 0 | `FAIL` |
| 1 | `delay_100k` | `real` | `lane1` | `0x00000002` | `0x000000FD` | `0x00000000` | `0x00000002` | `delay-mts-both` | 1337229 | 0 | 0 | 0 | 6282117 | 0 | 0 | 0 | `PASS` |
| 2 | `delay_100k` | `real` | `lane2` | `0x00000004` | `0x000000FB` | `0x00000000` | `0x00000004` | `delay-mts-both` | 1695175 | 0 | 0 | 0 | 6572779 | 0 | 0 | 0 | `PASS` |
| 3 | `delay_100k` | `real` | `lane3` | `0x00000008` | `0x000000F7` | `0x00000000` | `0x00000008` | `delay-mts-both` | 469162 | 0 | 0 | 0 | 2180023 | 18 | 0 | 0 | `FAIL` |
| 4 | `delay_100k` | `real` | `lane4` | `0x00000010` | `0x000000EF` | `0x00000000` | `0x00000010` | `delay-mts-both` | 1080401 | 0 | 0 | 0 | 3888864 | 0 | 0 | 0 | `PASS` |
| 5 | `delay_100k` | `real` | `lane5` | `0x00000020` | `0x000000DF` | `0x00000000` | `0x00000020` | `delay-mts-both` | 1075510 | 0 | 0 | 0 | 5603735 | 0 | 0 | 0 | `PASS` |
| 6 | `delay_100k` | `real` | `lane6` | `0x00000040` | `0x000000BF` | `0x00000000` | `0x00000040` | `delay-mts-both` | 667814 | 0 | 0 | 0 | 3658256 | 0 | 0 | 0 | `PASS` |
| 7 | `delay_100k` | `real` | `lane7` | `0x00000080` | `0x0000007F` | `0x00000000` | `0x00000080` | `delay-mts-both` | 1254048 | 0 | 0 | 0 | 5370152 | 0 | 0 | 0 | `PASS` |
