...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47460 | `real` | `periodic` | 1250 | 66560 | 0 | 226358 | 0 | 4182795803 | 4182795803 | `rate_out_of_tolerance` |
...
- Histogram profile/readback: `{'profile': 'rate', 'description': 'post-hit channel/rate histogram', 'uid': 1212765012, 'meta': 436298157, 'control': 256, 'left_bound': 0, 'right_bound': 256, 'bin_width': 1, 'key_loc': 639837726, 'key_value': 0, 'interval_cfg': 125000000, 'filter_enable_requested': False, 'filter_key_loc_requested': None, 'filter_key_value_requested': 0}`
...
- Source mux selected beat delta: `4182795803`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `266699`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `48825` / dropped `0`
- Histogram last interval: `66560` / dropped `0`
- Rate expected/tolerance/error: `100000` / `±5000` / `-33440` hits
- Post-end clean: `yes`
