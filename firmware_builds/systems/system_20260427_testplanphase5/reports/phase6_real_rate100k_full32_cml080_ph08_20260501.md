...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 48608 | `real` | `periodic` | 1250 | 25744965 | 0 | 293511272 | 322594603 | 14436658772 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `14436658772`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `226631112`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `7929965` / dropped `0`
- Histogram last interval: `25744965` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_rate_per_channel_1s_real_full32_cml080_ph08_20260501.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_rate_per_channel_1s_real_full32_cml080_ph08_20260501.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 9.198787086177617, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `25600000` / `±256000` / `144965` hits
- Post-end clean: `yes`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x00000010` | `0x00000010` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x00000010` | `0x00000010` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x0000449F` | `0x0000449F` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x00000010` | `0x00000010` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032D0` | `0x000032D0` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048DD` | `0x000048DD` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x00000010` | `0x00000010` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x00000010` | `0x00000010` | 0 | 0 | 0 | 0 |
