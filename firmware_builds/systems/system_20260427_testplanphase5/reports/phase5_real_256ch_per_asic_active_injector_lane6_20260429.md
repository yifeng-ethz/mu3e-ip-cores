...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52106 | `real` | `periodic` | 1250 | 848792 | 0 | 3746424 | 0 | 3202606970 | 3202606970 | `PASS` |
...
- Source mux selected beat delta: `3202606970`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4674612`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `848792` / dropped `0`
- Histogram last interval: `1530894` / dropped `0`
