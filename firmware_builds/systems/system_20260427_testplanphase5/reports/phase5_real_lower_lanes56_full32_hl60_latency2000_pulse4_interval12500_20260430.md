...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 12500 | 209417 | 0 | 976942 | 187920 | 3307232077 | 3307232077 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3307232077`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `1164544`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `209417` / dropped `0`
- Histogram last interval: `369669` / dropped `0`
