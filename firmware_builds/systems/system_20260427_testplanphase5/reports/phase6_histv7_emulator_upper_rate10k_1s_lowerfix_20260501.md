...
- Active emulator lanes: `0x0000000F`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 46110 | `emulator` | `periodic` | 12500 | 39996 | 0 | 122768 | 0 | 3775934466 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `3775934466`
- Emulator frame delta: `164967`
- Frame CRC delta: `0`
- Frame actual-hit delta: `145796`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `26260` / dropped `0`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x20041001` | `0x0000D70D` |
| 1 | `0x00000001` | 1 | `0x00000001` | `0x20441001` | `0x0000D70D` |
| 2 | `0x00000001` | 1 | `0x00000001` | `0x20841001` | `0x0000D70D` |
| 3 | `0x00000001` | 1 | `0x00000001` | `0x20C41001` | `0x0000D70D` |
| 4 | `0x00000001` | 0 | `0x00000000` | `0x21041001` | `0x0000D70D` |
| 5 | `0x00000001` | 0 | `0x00000000` | `0x21441001` | `0x0000D70D` |
| 6 | `0x00000001` | 0 | `0x00000000` | `0x21841001` | `0x0000D70D` |
| 7 | `0x00000001` | 0 | `0x00000000` | `0x21C41001` | `0x0000D70D` |
