...
- Result: `0 PASS / 0 PASS_PARTIAL / 2 FAIL / 0 BLOCKED`
...
|---:|---|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `delay_100k` | `real` | `lane3` | `0x00000008` | `0x000000F7` | `0x00000000` | `0x00000008` | `delay-mts-both` | 998266 | 0 | 0 | 0 | 4427406 | 13 | 0 | 0 | `FAIL` |
| 1 | `delay_100k` | `real` | `lane7` | `0x00000080` | `0x0000007F` | `0x00000000` | `0x00000080` | `delay-mts-both` | 2151450 | 0 | 0 | 0 | 8600475 | 711883 | 0 | 0 | `FAIL` |
