...
- Timestamp: `2026-04-30T00:49:39`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000F9`
- LVDS lane-go mask: `0x00000006`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47210 | `real` | `periodic` | 1250 | 32614 | 0 | 487254 | 0 | 3231663637 | 3231663637 | `PASS` |
...
- Debug overrides: `{'mts_expected_latency': 2000, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'keep', 'mts_ctrl_written': 536870929}`
- Source mux selected beat delta: `3231663637`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `609164`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `32614` / dropped `0`
- Histogram last interval: `199680` / dropped `0`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- Post-end clean: `yes`

| Lane | Source Ctrl | Emu Enabled | Emu Ctrl | Emu Cluster | Emu Status |
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 0 | `0x00000000` | `0x20041001` | `0x00008590` |
| 1 | `0x00000000` | 0 | `0x00000000` | `0x20441001` | `0x00008590` |
| 2 | `0x00000000` | 0 | `0x00000000` | `0x20841001` | `0x00008590` |
| 3 | `0x00000001` | 0 | `0x00000000` | `0x20C41001` | `0x00008590` |
| 4 | `0x00000001` | 0 | `0x00000000` | `0x21041001` | `0x00008590` |
| 5 | `0x00000001` | 0 | `0x00000000` | `0x21441001` | `0x00008590` |
| 6 | `0x00000001` | 0 | `0x00000000` | `0x21841001` | `0x00008590` |
| 7 | `0x00000001` | 0 | `0x00000000` | `0x21C41001` | `0x00008590` |
