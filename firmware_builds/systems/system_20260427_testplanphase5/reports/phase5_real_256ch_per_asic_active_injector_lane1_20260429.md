...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52101 | `real` | `periodic` | 1250 | 2082672 | 0 | 6429240 | 0 | 3194403497 | 3194403497 | `PASS` |
...
- Source mux selected beat delta: `3194403497`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `8026425`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2082672` / dropped `0`
- Histogram last interval: `2695680` / dropped `0`
