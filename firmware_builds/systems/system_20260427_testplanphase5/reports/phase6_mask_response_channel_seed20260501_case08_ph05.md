...
- Real hits per lane for rate expectation: `20`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 15974466 | 0 | 182655120 | 202829701 | 14339427730 | 0 | 0 | `ring_input_errors_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x00000042` | `0x00000042` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x00000042` | `0x00000042` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044D1` | `0x000044D1` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x00000042` | `0x00000042` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x00003302` | `0x00003302` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x0000490F` | `0x0000490F` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x00000042` | `0x00000042` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x00000042` | `0x00000042` | 0 | 0 | 0 | 0 |
