...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 237927 | 0 | 2388784 | 0 | 3380078759 | 3380078759 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3380078759`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2993575`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `237927` / dropped `0`
- Histogram last interval: `931727` / dropped `0`
