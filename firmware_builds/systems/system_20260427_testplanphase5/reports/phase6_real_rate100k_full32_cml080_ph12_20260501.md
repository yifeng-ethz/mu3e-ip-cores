...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 48612 | `real` | `periodic` | 1250 | 31390770 | 0 | 366507725 | 344155374 | 14175369095 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `14175369095`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `290870054`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `12296569` / dropped `0`
- Histogram last interval: `31390770` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_rate_per_channel_1s_real_full32_cml080_ph12_20260501.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_rate_per_channel_1s_real_full32_cml080_ph12_20260501.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 9.178460587281734, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `25600000` / `±256000` / `5790770` hits
- Post-end clean: `yes`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x00000018` | `0x00000018` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x00000018` | `0x00000018` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044A7` | `0x000044A7` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x00000018` | `0x00000018` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032D8` | `0x000032D8` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048E5` | `0x000048E5` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x00000018` | `0x00000018` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x00000018` | `0x00000018` | 0 | 0 | 0 | 0 |
