...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 46140 | `emulator` | `periodic` | 1250 | 409080 | 0 | 2419092 | 0 | 3751789105 | n/a | n/a | `PASS` |
...
- Histogram profile/readback: `{'profile': 'delay-mts-both', 'description': 'combined signed MTS ts_delta delay histogram on debug_1/debug_2', 'toolkit_preset_source': 'toolkits/fe_scifi/board_bring_up/fe_scifi_board_bring_up_project.tcl', 'toolkit_preset_id': 'delay_mts_both', 'uid': 1212765012, 'meta': 436302325, 'control': 144, 'left_bound': 0, 'right_bound': 4096, 'bin_width': 16, 'key_loc': 639833361, 'key_value': 0, 'interval_cfg': 125000000, 'filter_enable_requested': False, 'filter_key_loc_requested': None, 'filter_key_value_requested': 0}`
...
- Source mux selected beat delta: `3751789105`
- Emulator frame delta: `314437`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2874044`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `409080` / dropped `0`
- Histogram last interval: `798720` / dropped `0`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x20041000` | `0x0000D3C9` |
| 1 | `0x00000001` | 1 | `0x00000001` | `0x20441000` | `0x0000D3C9` |
| 2 | `0x00000001` | 1 | `0x00000001` | `0x20841000` | `0x0000D3C9` |
| 3 | `0x00000001` | 1 | `0x00000001` | `0x20C41000` | `0x0000D3C9` |
| 4 | `0x00000001` | 1 | `0x00000001` | `0x21041000` | `0x0000D3C9` |
| 5 | `0x00000001` | 1 | `0x00000001` | `0x21441000` | `0x0000D3C9` |
| 6 | `0x00000001` | 1 | `0x00000001` | `0x21841000` | `0x0000D3C9` |
| 7 | `0x00000001` | 1 | `0x00000001` | `0x21C41000` | `0x0000D3C9` |
