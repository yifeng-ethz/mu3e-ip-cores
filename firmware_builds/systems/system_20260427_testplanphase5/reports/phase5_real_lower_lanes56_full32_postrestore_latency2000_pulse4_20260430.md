...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1415471 | 0 | 9859630 | 1990485 | 3213940308 | 3213940308 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 2000, 'mts_bypass_lapse': 'off', 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3213940308`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11694757`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1415471` / dropped `0`
- Histogram last interval: `3894034` / dropped `0`
