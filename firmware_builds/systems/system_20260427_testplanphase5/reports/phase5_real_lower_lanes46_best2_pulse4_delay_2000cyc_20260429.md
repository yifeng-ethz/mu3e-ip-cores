...
- Timestamp: `2026-04-30T00:38:34`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000AF`
- LVDS lane-go mask: `0x00000050`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2466936 | 0 | 7510346 | 0 | 3205803893 | 3205803893 | `PASS` |
...
- Source mux selected beat delta: `3205803893`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `9467681`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2466936` / dropped `0`
- Histogram last interval: `3128348` / dropped `0`
