...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 13379 | 0 | 404630 | 225857 | 3391408625 | 3391408625 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3391408625`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `435437`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `13379` / dropped `0`
- Histogram last interval: `156306` / dropped `0`
