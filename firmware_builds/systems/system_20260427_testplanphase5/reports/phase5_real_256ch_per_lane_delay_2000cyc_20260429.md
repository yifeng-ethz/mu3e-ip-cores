...
|---:|---|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `delay_100k` | `real` | `lane0` | `0x00000001` | `0x000000FE` | `0x00000000` | `0x00000001` | `delay-mts-both` | 960347 | 0 | 0 | 0 | 5228160 | 0 | 0 | 0 | `PASS` |
| 1 | `delay_100k` | `real` | `lane1` | `0x00000002` | `0x000000FD` | `0x00000000` | `0x00000002` | `delay-mts-both` | 1377540 | 0 | 0 | 0 | 6234165 | 0 | 0 | 0 | `PASS` |
| 2 | `delay_100k` | `real` | `lane2` | `0x00000004` | `0x000000FB` | `0x00000000` | `0x00000004` | `delay-mts-both` | 1259181 | 0 | 0 | 0 | 6712099 | 805 | 0 | 0 | `FAIL` |
| 3 | `delay_100k` | `real` | `lane3` | `0x00000008` | `0x000000F7` | `0x00000000` | `0x00000008` | `delay-mts-both` | 554198 | 0 | 0 | 0 | 3388484 | 16 | 0 | 0 | `FAIL` |
| 4 | `delay_100k` | `real` | `lane4` | `0x00000010` | `0x000000EF` | `0x00000000` | `0x00000010` | `delay-mts-both` | 700659 | 0 | 0 | 0 | 4292911 | 0 | 0 | 0 | `PASS` |
| 5 | `delay_100k` | `real` | `lane5` | `0x00000020` | `0x000000DF` | `0x00000000` | `0x00000020` | `delay-mts-both` | 1085132 | 0 | 0 | 0 | 5571896 | 0 | 0 | 0 | `PASS` |
| 6 | `delay_100k` | `real` | `lane6` | `0x00000040` | `0x000000BF` | `0x00000000` | `0x00000040` | `delay-mts-both` | 661480 | 0 | 0 | 0 | 3629430 | 0 | 0 | 0 | `PASS` |
| 7 | `delay_100k` | `real` | `lane7` | `0x00000080` | `0x0000007F` | `0x00000000` | `0x00000080` | `delay-mts-both` | 915810 | 0 | 0 | 0 | 5540214 | 151795 | 0 | 0 | `FAIL` |
