...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47450 | `real` | `periodic` | 1250 | 66561 | 0 | 231506 | 0 | 4287122205 | 4287122205 | `rate_out_of_tolerance` |
...
- Source mux selected beat delta: `4287122205`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `271942`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `1518` / dropped `0`
