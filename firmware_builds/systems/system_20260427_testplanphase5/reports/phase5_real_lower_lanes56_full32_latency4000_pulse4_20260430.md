...
- MTS expected latency override: `4000`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 831865 | 0 | 9709819 | 1288312 | 3229013057 | 3229013057 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 4000, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3229013057`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11711001`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `831865` / dropped `0`
- Histogram last interval: `3894326` / dropped `0`
