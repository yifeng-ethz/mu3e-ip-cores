...
- Real hits per lane for rate expectation: `24`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1004562 | 0 | 6645781 | 1281072 | 3320284649 | 3320284649 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3320284649`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7956847`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1004562` / dropped `0`
- Histogram last interval: `2695708` / dropped `0`
