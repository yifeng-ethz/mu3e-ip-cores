...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61220 | `emulator` | `periodic` | 1250 | 3095060 | 0 | 32206024 | 0 | 11232433379 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `11232433379`
- Emulator frame delta: `51142`
- Frame CRC delta: `0`
- Frame actual-hit delta: `33989826`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `844575` / dropped `0`
- Histogram last interval: `3095060` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_100k_cluster31_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_100k_cluster31_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.218548765871674, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `3100000` / `±31000` / `-4940` hits
- MTS discard/tolerance: `0` / `±322060` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x00002317` |
