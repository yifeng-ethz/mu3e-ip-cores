...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2276046 | 0 | 5899298 | 0 | 3291283095 | 3291283095 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3291283095`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7358204`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2276046` / dropped `0`
- Histogram last interval: `2269337` / dropped `0`
