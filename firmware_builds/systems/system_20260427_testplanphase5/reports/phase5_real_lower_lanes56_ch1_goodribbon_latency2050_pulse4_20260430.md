...
- MTS expected latency override: `2050`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 53303 | 0 | 416905 | 0 | 3355831630 | 3355831630 | `PASS` |
...
- Debug overrides: `{'mts_expected_latency': 2050, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3355831630`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `515198`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `53303` / dropped `0`
