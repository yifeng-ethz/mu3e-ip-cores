...
- Timestamp: `2026-04-30T00:35:02`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000F0`
- LVDS lane-go mask: `0x0000000F`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 4075581 | 0 | 21945941 | 384324 | 3488104692 | 3488104692 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3488104692`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `26904789`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `4075581` / dropped `0`
- Histogram last interval: `8595346` / dropped `0`
