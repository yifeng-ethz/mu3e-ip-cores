...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1289155 | 0 | 3548670 | 0 | 3234537089 | 3234537089 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3234537089`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4420430`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1289155` / dropped `0`
- Histogram last interval: `1416014` / dropped `0`
