...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `emulator` | `periodic` | 12500 | 0 | 0 | 0 | 0 | 0 | n/a | n/a | `rate_last_interval_unavailable` |
...
- Histogram profile/readback: `{'profile': 'rate', 'description': 'pre-RBCAM hit_type1 global channel/rate histogram', 'toolkit_preset_source': 'toolkits/fe_scifi/board_bring_up/fe_scifi_board_bring_up_project.tcl', 'toolkit_preset_id': 'rate', 'uid': 1212765012, 'meta': 436281769, 'control': 256, 'left_bound': 0, 'right_bound': 256, 'bin_width': 1, 'key_loc': 639837726, 'key_value': 0, 'interval_cfg': 125000000, 'filter_enable_requested': False, 'filter_key_loc_requested': None, 'filter_key_value_requested': 0}`
...
- Emulator frame delta: `24457`
- Frame CRC delta: `0`
- Frame actual-hit delta: `0`
- Histogram rate counter source: `live_delta_no_last_interval`
- Histogram live delta: `0` / dropped `0`
- Histogram last interval: `0` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_onboard_emulator_post_rbcam_rate_10k_ticketfifo_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_onboard_emulator_post_rbcam_rate_10k_ticketfifo_20260502.log', 'read_chunk_words': 1, 'read_delay_ms': 1, 'unsafe_bulk_read': False, 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.527076304890215, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `310000` / `±3100` / `-310000` hits
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x00000000` |
