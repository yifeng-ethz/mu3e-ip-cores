...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 924626 | 0 | 2370183 | 0 | 3327735609 | 3327735609 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3327735609`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2933325`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `924626` / dropped `0`
- Histogram last interval: `931842` / dropped `0`
