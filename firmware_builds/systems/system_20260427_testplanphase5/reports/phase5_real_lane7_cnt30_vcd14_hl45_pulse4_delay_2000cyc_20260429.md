...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 368212 | 0 | 5855147 | 0 | 3242041553 | 3242041553 | `PASS` |
...
- Source mux selected beat delta: `3242041553`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7218654`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `368212` / dropped `0`
- Histogram last interval: `2245186` / dropped `0`
