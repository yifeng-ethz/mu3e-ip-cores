...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 788683 | 0 | 9800466 | 8156177 | 3358717781 | 3358717781 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3358717781`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `10027380`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `788683` / dropped `0`
- Histogram last interval: `3893804` / dropped `0`
