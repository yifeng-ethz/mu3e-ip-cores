...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47350 | `real` | `periodic` | 1250 | 7630 | 0 | 415825 | 535272 | 3311305816 | 3311305816 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3311305816`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `373402`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `7630` / dropped `0`
- Histogram last interval: `166401` / dropped `0`
