...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 44169 | 0 | 5970546 | 0 | 3246972752 | 3246972752 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3246972752`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7315418`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `44169` / dropped `0`
- Histogram last interval: `2274816` / dropped `0`
