...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61000 | `emulator` | `periodic` | 12500 | 9998 | 0 | 103758 | 0 | 11210750107 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `11210750107`
- Emulator frame delta: `51283`
- Frame CRC delta: `0`
- Frame actual-hit delta: `109862`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `3353` / dropped `0`
- Histogram last interval: `9998` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate10k_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate10k_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.174412551801652, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `10000` / `±100` / `-2` hits
- MTS discard/tolerance: `0` / `±1038` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x20041001` | `0x00003EBB` |
