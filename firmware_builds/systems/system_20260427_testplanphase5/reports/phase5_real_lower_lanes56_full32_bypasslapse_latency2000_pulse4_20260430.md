...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1445038 | 0 | 9889398 | 26103431 | 3244517848 | 3244517848 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 2000, 'mts_bypass_lapse': 'on', 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870937, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3244517848`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `5155190`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1445038` / dropped `0`
- Histogram last interval: `3893924` / dropped `0`
