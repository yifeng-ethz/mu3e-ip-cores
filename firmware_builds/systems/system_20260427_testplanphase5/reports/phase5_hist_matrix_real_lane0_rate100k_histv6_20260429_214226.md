...
- Timestamp: `2026-04-29T21:42:26`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 last-interval CSR checksum 0x13A9CC2D, real lane0 ch16 cfg`
- SC link: `2`
- FEB target: `7`
- Sources: `real`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `real` | `lane0` | `0x00000001` | `0x00000000` | `0x00000001` | `rate` | 629938 | 100000 | 529938 | 0 | 2226085 | 0 | 0 | 928293 | `FAIL` |
