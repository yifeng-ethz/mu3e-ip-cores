...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 367776 | 0 | 2578074 | 330128 | 3205799998 | 3205799998 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3205799998`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `3182022`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `367776` / dropped `0`
- Histogram last interval: `1065164` / dropped `0`
