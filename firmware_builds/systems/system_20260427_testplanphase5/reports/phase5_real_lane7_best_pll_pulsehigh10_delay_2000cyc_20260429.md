...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 353569 | 0 | 10921442 | 0 | 3300067225 | 3300067225 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3300067225`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `12722888`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `353569` / dropped `0`
- Histogram last interval: `4006740` / dropped `0`
