...
- Timestamp: `2026-04-30T00:36:20`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000FA`
- LVDS lane-go mask: `0x00000005`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 781392 | 0 | 12196247 | 0 | 3225226741 | 3225226741 | `PASS` |
...
- Source mux selected beat delta: `3225226741`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `15474646`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `781392` / dropped `0`
- Histogram last interval: `4971556` / dropped `0`
