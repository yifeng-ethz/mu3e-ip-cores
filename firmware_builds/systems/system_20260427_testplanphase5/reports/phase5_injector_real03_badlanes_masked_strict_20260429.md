...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `mixed` | `periodic` | 12500 | 1055636 | 0 | 1279602 | 1516339 | 3057776920 | 3057776920 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3057776920`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `1133378`
- Post-end clean: `yes`

| Lane | Source Ctrl | Emu Enabled | Emu Ctrl | Emu Cluster | Emu Status |
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000000` | 0 | `0x00000000` | `0x20041001` | `0x00002E89` |
