...
- Timestamp: `2026-04-29T23:48:06`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x0000008F`
- LVDS lane-go mask: `0x00000070`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 4696538 | 0 | 14154372 | 12238735 | 3270440933 | 3270440933 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3270440933`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `14256874`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `4696538` / dropped `0`
- Histogram last interval: `5729966` / dropped `0`
