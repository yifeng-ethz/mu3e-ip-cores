...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 327096 | 0 | 10040478 | 8278502 | 3337818823 | 3337818823 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3337818823`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `10246735`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `327096` / dropped `0`
- Histogram last interval: `3893309` / dropped `0`
