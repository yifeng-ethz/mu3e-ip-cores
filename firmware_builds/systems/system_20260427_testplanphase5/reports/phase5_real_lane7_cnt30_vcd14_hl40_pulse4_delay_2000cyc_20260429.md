...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1922435 | 0 | 5499954 | 0 | 3151966553 | 3151966553 | `PASS` |
...
- Source mux selected beat delta: `3151966553`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6840296`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1922435` / dropped `0`
- Histogram last interval: `2236082` / dropped `0`
