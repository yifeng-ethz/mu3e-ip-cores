...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 186252 | 0 | 489593 | 0 | 3235736395 | 3235736395 | `PASS` |
...
- Source mux selected beat delta: `3235736395`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `620261`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `186252` / dropped `0`
- Histogram last interval: `196379` / dropped `0`
