...
- Timestamp: `2026-04-29T21:48:07`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 checksum 0x13A9CC2D, real lane3 source-scope isolation fix`
- SC link: `2`
- FEB target: `7`
- Sources: `real`
- Real-lane availability mask: `0x00000008`
- Mixed emulator-source mask: `0x000000F7`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `real` | `lane3` | `0x00000008` | `0x00000000` | `0x00000008` | `rate` | 99841 | 100000 | -159 | 0 | 314732 | 0 | 0 | 0 | `PASS` |
