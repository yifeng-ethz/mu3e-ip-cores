...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 3425886 | 0 | 9890452 | 6703464 | 3258495532 | 3258495532 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3258495532`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `10425651`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `3425886` / dropped `0`
- Histogram last interval: `3900203` / dropped `0`
