...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2229686 | 0 | 46518187 | 53865754 | 3469618683 | 3469618683 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3469618683`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `41715109`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2229686` / dropped `0`
- Histogram last interval: `17314603` / dropped `0`
