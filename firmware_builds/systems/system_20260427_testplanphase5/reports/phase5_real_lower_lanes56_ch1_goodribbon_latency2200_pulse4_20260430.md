...
- MTS expected latency override: `2200`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 106489 | 0 | 443741 | 0 | 3201789006 | 3201789006 | `PASS` |
...
- Debug overrides: `{'mts_expected_latency': 2200, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3201789006`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `557856`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `106489` / dropped `0`
- Histogram last interval: `166400` / dropped `0`
