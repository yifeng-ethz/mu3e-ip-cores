...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61230 | `emulator` | `periodic` | 250 | 5080677 | 0 | 52732880 | 0 | 11099928214 | n/a | n/a | `rate_out_of_tolerance` |
...
- Source mux selected beat delta: `11099928214`
- Emulator frame delta: `43830`
- Frame CRC delta: `0`
- Frame actual-hit delta: `55974774`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `1683251` / dropped `0`
- Histogram last interval: `5080677` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_500k_cluster31_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_500k_cluster31_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.191742312163115, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `15500000` / `±155000` / `-10419323` hits
- MTS discard/tolerance: `0` / `±527329` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x000028AD` |
| 1 | `0x00000001` | 0 | `0x00000000` | `0x2044101F` | `0x00000000` |
| 2 | `0x00000001` | 0 | `0x00000000` | `0x2084101F` | `0x00000000` |
| 3 | `0x00000001` | 0 | `0x00000000` | `0x20C4101F` | `0x00000000` |
| 4 | `0x00000001` | 0 | `0x00000000` | `0x2104101F` | `0x00000000` |
| 5 | `0x00000001` | 0 | `0x00000000` | `0x2144101F` | `0x00000000` |
| 6 | `0x00000001` | 0 | `0x00000000` | `0x2184101F` | `0x00000000` |
| 7 | `0x00000001` | 0 | `0x00000000` | `0x21C4101F` | `0x00000000` |
