...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1907124 | 0 | 5963695 | 0 | 3231544808 | 3231544808 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3231544808`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7348005`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1907124` / dropped `0`
- Histogram last interval: `2351457` / dropped `0`
