...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 88236 | 0 | 7752580 | 0 | 3383991283 | 3383991283 | `PASS` |
...
- Source mux selected beat delta: `3383991283`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `9551133`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `88236` / dropped `0`
- Histogram last interval: `3040265` / dropped `0`
