...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45200 | `emulator` | `periodic` | 12500 | 0 | 0 | 0 | 0 | 0 | 0 | `exception` |
...
info: request words written to SC main:
  ...
  timing matched      : 0 us
  timing total        : 1000953 us
  secondary before    : 0x0000
  secondary after     : 0x0000
  secondary delta     : 0 word(s)
  SC main status      : 0xFFFFFFFF
  SC state            : 0xFFFFFFFF
...
board:
  PLL_LOCKED_REGISTER_R      = 0xFFFFFFFF
  LINK_LOCKED_LOW_REGISTER_R = 0xFFFFFFFF
  LINK_LOCKED_HIGH_REGISTER_R= 0xFFFFFFFF
  RESET_LINK_STATUS_REGISTER_R = 0xFFFFFFFF
info: request summary:
  type               : WR
  link               : 2
  addr               : 0x0AC80
