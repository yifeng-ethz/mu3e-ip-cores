...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 265480 | 0 | 10439758 | 0 | 3252003040 | 3252003040 | `PASS` |
...
- Source mux selected beat delta: `3252003040`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `13514093`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `265480` / dropped `0`
- Histogram last interval: `4202722` / dropped `0`
