...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 107809 | 0 | 12457366 | 0 | 3319826993 | 3319826993 | `PASS` |
...
- Source mux selected beat delta: `3319826993`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `15473395`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `107809` / dropped `0`
- Histogram last interval: `4959011` / dropped `0`
