...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 61240 | `emulator` | `periodic` | 125 | 5080635 | 0 | 52899777 | 0 | 11244006367 | n/a | n/a | `rate_out_of_tolerance` |
...
- Source mux selected beat delta: `11244006367`
- Emulator frame delta: `55115`
- Frame CRC delta: `0`
- Frame actual-hit delta: `55945321`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `1675611` / dropped `0`
- Histogram last interval: `5080635` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_1M_cluster31_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_rate_1M_cluster31_20260502.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.194818711839616, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `31000000` / `±310000` / `-25919365` hits
- MTS discard/tolerance: `0` / `±528998` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x0000FC36` |
