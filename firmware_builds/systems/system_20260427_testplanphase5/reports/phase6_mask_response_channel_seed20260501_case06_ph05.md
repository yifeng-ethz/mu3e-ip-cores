...
- Real hits per lane for rate expectation: `13`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 10383464 | 0 | 119341248 | 128577995 | 14452198141 | 0 | 0 | `ring_input_errors_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000003E` | `0x0000003E` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000003E` | `0x0000003E` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044CD` | `0x000044CD` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000003E` | `0x0000003E` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032FE` | `0x000032FE` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x0000490B` | `0x0000490B` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000003E` | `0x0000003E` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000003E` | `0x0000003E` | 0 | 0 | 0 | 0 |
