...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 17452 | 0 | 170995 | 0 | 3169983662 | 3169983662 | `PASS` |
...
- Source mux selected beat delta: `3169983662`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `211830`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `17452` / dropped `0`
- Histogram last interval: `69415` / dropped `0`
