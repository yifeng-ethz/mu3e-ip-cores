...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 15974400 | 0 | 185456160 | 204598294 | 14528568241 | 0 | 0 | `ring_input_errors_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000003C` | `0x0000003C` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000003C` | `0x0000003C` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044CB` | `0x000044CB` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000003C` | `0x0000003C` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032FC` | `0x000032FC` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x00004909` | `0x00004909` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000003C` | `0x0000003C` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000003C` | `0x0000003C` | 0 | 0 | 0 | 0 |
