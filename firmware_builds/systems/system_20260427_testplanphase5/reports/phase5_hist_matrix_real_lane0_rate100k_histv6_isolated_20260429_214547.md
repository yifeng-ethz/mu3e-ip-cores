...
- Timestamp: `2026-04-29T21:45:47`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 checksum 0x13A9CC2D, lane0 real isolated by source mux 0xFE`
- SC link: `2`
- FEB target: `7`
- Sources: `mixed`
- Real-lane availability mask: `0x00000001`
- Mixed emulator-source mask: `0x000000FE`
- Duration per run: `1100 ms`
- Result: `1 PASS / 0 PASS_PARTIAL / 0 FAIL / 0 BLOCKED`

## Summary

| # | Scenario | Source | Scope | Requested | Effective emu | Effective real/LVDS | Hist profile | Hits | Rate Exp | Rate Err | Drops | MTS | Discard | CRC | Ring InErr | Status |
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `mixed` | `lane0` | `0x00000001` | `0x00000000` | `0x00000001` | `rate` | 99841 | 100000 | -159 | 0 | 317783 | 0 | 0 | 0 | `PASS` |
