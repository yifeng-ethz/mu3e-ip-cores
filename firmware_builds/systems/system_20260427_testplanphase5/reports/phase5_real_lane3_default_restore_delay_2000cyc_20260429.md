...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 71413 | 0 | 3726865 | 0 | 3399482366 | 3399482366 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3399482366`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4660215`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `71413` / dropped `0`
- Histogram last interval: `1461381` / dropped `0`
