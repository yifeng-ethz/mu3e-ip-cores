...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2204984 | 0 | 5929132 | 0 | 3291404863 | 3291404863 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3291404863`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7169474`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2204984` / dropped `0`
- Histogram last interval: `2264099` / dropped `0`
