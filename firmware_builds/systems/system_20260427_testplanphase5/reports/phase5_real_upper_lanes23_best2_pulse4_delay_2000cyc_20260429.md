...
- Timestamp: `2026-04-30T00:37:34`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000F3`
- LVDS lane-go mask: `0x0000000C`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 31122 | 0 | 9705804 | 301747 | 3278007770 | 3278007770 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3278007770`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11842855`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `31122` / dropped `0`
- Histogram last interval: `3793927` / dropped `0`
