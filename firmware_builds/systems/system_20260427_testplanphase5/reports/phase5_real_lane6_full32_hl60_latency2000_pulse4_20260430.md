...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 322500 | 0 | 3657580 | 0 | 3297525622 | 3297525622 | `PASS` |
...
- Source mux selected beat delta: `3297525622`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4521434`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `322500` / dropped `0`
- Histogram last interval: `1431040` / dropped `0`
