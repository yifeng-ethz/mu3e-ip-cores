...
- Real hits per lane for rate expectation: `11`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 8785920 | 0 | 101728924 | 111925336 | 14550817883 | 0 | 0 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `14550817883`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `78288115`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `2451856` / dropped `0`
- Histogram last interval: `8785920` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_mask_response_channel_seed20260501_case04_ph05.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_mask_response_channel_seed20260501_case04_ph05.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 9.399478631094098, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `8800000` / `±88000` / `-14080` hits
- Post-end clean: `yes`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000003A` | `0x0000003A` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000003A` | `0x0000003A` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044C9` | `0x000044C9` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000003A` | `0x0000003A` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032FA` | `0x000032FA` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x00004907` | `0x00004907` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000003A` | `0x0000003A` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000003A` | `0x0000003A` | 0 | 0 | 0 | 0 |
