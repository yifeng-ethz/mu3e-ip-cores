...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 48606 | `real` | `periodic` | 1250 | 25547170 | 0 | 295860384 | 333672054 | 14586740262 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000000C` | `0x0000000C` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000000C` | `0x0000000C` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x0000449B` | `0x0000449B` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000000C` | `0x0000000C` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032CC` | `0x000032CC` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048D9` | `0x000048D9` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000000C` | `0x0000000C` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000000C` | `0x0000000C` | 0 | 0 | 0 | 0 |
