...
- MTS bypass-lapse override: `off`
- MTS delay-ts field override: `e`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1993029 | 0 | 9816920 | 18496961 | 3158468849 | 3158468849 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 2000, 'mts_bypass_lapse': 'off', 'mts_delay_ts_field': 'e', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 17, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3158468849`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7207838`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1993029` / dropped `0`
- Histogram last interval: `3894009` / dropped `0`
