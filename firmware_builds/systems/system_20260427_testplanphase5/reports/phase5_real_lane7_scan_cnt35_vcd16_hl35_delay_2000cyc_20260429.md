...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1920048 | 0 | 5870589 | 0 | 3241729114 | 3241729114 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3241729114`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7097790`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1920048` / dropped `0`
- Histogram last interval: `2264927` / dropped `0`
