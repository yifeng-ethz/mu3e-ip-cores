...
- Timestamp: `2026-04-29T21:47:03`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 checksum 0x13A9CC2D, real lane0 source-scope isolation fix`
- SC link: `2`
- FEB target: `7`
- Sources: `real`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `real` | `lane0` | `0x00000001` | `0x00000000` | `0x00000001` | `rate` | 99839 | 100000 | -161 | 0 | 315832 | 0 | 0 | 0 | `PASS` |
