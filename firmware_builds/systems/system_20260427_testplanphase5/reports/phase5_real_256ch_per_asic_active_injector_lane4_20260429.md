...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52104 | `real` | `periodic` | 1250 | 1580174 | 0 | 4392892 | 0 | 3229041572 | 3229041572 | `PASS` |
...
- Source mux selected beat delta: `3229041572`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `5554201`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1580174` / dropped `0`
- Histogram last interval: `1829177` / dropped `0`
