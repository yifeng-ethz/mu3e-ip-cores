...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2021580 | 0 | 5707669 | 0 | 3310122467 | 3310122467 | `PASS` |
...
- Source mux selected beat delta: `3310122467`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7063903`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2021580` / dropped `0`
- Histogram last interval: `2230707` / dropped `0`
