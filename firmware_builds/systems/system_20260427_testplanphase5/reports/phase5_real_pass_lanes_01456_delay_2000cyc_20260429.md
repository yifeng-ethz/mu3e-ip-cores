...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1595762 | 0 | 26495872 | 12502888 | 3363782570 | 3363782570 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3363782570`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `30220352`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1595762` / dropped `0`
- Histogram last interval: `10687482` / dropped `0`
