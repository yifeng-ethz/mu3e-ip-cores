...
- Timestamp: `2026-04-30T00:39:29`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x0000005F`
- LVDS lane-go mask: `0x000000A0`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 32715 | 0 | 12349954 | 19162856 | 3193356493 | 3193356493 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3193356493`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `10056083`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `32715` / dropped `0`
- Histogram last interval: `4610678` / dropped `0`
