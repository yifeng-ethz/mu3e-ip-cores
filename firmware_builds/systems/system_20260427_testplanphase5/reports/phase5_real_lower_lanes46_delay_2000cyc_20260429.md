...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 585285 | 0 | 8577789 | 0 | 3318271257 | 3318271257 | `PASS` |
...
- Source mux selected beat delta: `3318271257`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `10541348`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `585285` / dropped `0`
- Histogram last interval: `3359615` / dropped `0`
