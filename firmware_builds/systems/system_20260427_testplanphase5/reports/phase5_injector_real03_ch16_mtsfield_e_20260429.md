...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `mixed` | `periodic` | 12500 | 37741 | 0 | 44316 | 67344 | 3118787179 | 3118787179 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': None, 'mts_delay_ts_field': 'e', 'mts_drop_delay_error': 'keep', 'ring_filter_inerr': 'keep', 'mts_ctrl_written': 17}`
- Source mux selected beat delta: `3118787179`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `36691`
- Post-end clean: `yes`
