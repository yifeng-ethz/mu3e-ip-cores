...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52103 | `real` | `periodic` | 1250 | 1145231 | 0 | 3378038 | 0 | 3139791310 | 3139791310 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3139791310`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4297323`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1145231` / dropped `0`
- Histogram last interval: `1461088` / dropped `0`
