...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52000 | `real` | `periodic` | 1250 | 16508986 | 0 | 47931661 | 54824901 | 3454200191 | 3454200191 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3454200191`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `42968319`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `16508986` / dropped `0`
- Histogram last interval: `17274399` / dropped `0`
