...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 890008 | 0 | 2280484 | 0 | 3327801842 | 3327801842 | `PASS` |
...
- Source mux selected beat delta: `3327801842`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2834891`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `890008` / dropped `0`
- Histogram last interval: `931847` / dropped `0`
