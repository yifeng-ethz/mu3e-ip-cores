...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1514 | 0 | 24475 | 0 | 3406151505 | 3406151505 | `PASS` |
...
- Source mux selected beat delta: `3406151505`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `30708`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1514` / dropped `0`
- Histogram last interval: `9597` / dropped `0`
