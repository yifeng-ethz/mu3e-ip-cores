...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 48607 | `real` | `periodic` | 1250 | 25539048 | 0 | 292743070 | 325703487 | 14360613570 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000000E` | `0x0000000E` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000000E` | `0x0000000E` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x0000449D` | `0x0000449D` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000000E` | `0x0000000E` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032CE` | `0x000032CE` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048DB` | `0x000048DB` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000000E` | `0x0000000E` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000000E` | `0x0000000E` | 0 | 0 | 0 | 0 |
