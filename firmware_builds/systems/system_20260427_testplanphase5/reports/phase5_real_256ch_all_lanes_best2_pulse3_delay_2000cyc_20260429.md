...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 135761 | 0 | 2531972 | 93557 | 3327199717 | 3327199717 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3327199717`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `3193782`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `135761` / dropped `0`
- Histogram last interval: `986072` / dropped `0`
