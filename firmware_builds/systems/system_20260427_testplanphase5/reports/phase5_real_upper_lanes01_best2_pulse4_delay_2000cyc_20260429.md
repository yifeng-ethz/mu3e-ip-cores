...
- Timestamp: `2026-04-30T00:36:01`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000FC`
- LVDS lane-go mask: `0x00000003`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 4600586 | 0 | 11907619 | 0 | 3341247812 | 3341247812 | `PASS` |
...
- Source mux selected beat delta: `3341247812`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `15108606`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `4600586` / dropped `0`
- Histogram last interval: `4813570` / dropped `0`
