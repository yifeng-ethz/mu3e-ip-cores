...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47470 | `real` | `periodic` | 1250 | 66561 | 0 | 325070 | 0 | 5670010178 | 5670010178 | `rate_out_of_tolerance` |
...
- Source mux selected beat delta: `5670010178`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `367912`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `18613` / dropped `0`
- Histogram last interval: `66561` / dropped `0`
- Rate expected/tolerance/error: `100000` / `±5000` / `-33439` hits
- Post-end clean: `yes`
