...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 62520 | `emulator` | `off` | 5000 | 286580 | 0 | 51071941 | 32496080 | 10117683064 | n/a | n/a | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `10117683064`
- Emulator frame delta: `28869`
- Frame CRC delta: `0`
- Frame actual-hit delta: `42995569`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `286580` / dropped `0`
- Histogram last interval: `4272941` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'delay-hit-t', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_post_rbcam_rate_10k_delay_hit_t_internal_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_emulator_asic0_post_rbcam_rate_10k_delay_hit_t_internal_20260502.jtag.log', 'read_chunk_words': 1, 'read_delay_ms': 1, 'unsafe_bulk_read': False, 'returncode': 127, 'timed_out': False, 'elapsed_s': 6.9699172507971525, 'csv_exists': False, 'csv_line_count': 0}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±510719` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000007` | `0x2004101F` | `0x00007B1F` |
