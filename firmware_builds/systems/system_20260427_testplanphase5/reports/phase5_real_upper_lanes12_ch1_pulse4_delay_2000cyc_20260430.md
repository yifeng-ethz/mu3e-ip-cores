...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47200 | `real` | `periodic` | 1250 | 702042 | 0 | 1981904 | 0 | 3334877463 | 3334877463 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3334877463`
- Emulator frame delta: `37289`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2490544`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `702042` / dropped `0`
