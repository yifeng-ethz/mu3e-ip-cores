...
- Result: `2 PASS / 0 PASS_PARTIAL / 0 FAIL / 0 BLOCKED`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `emulator` | `lane4` | `0x00000010` | `0x00000010` | `0x000001FF` | `rate` | 260420 | 0 | 225483 | 0 | 0 | 0 | `PASS` |
| 1 | `rate_10k` | `emulator` | `lane4` | `0x00000010` | `0x00000010` | `0x000001FF` | `rate` | 25393 | 0 | 22266 | 0 | 0 | 0 | `PASS` |
