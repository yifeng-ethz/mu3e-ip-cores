...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 134994 | 0 | 402187 | 238388 | 3277425570 | 3277425570 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3277425570`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `437231`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `134994` / dropped `0`
- Histogram last interval: `158526` / dropped `0`
