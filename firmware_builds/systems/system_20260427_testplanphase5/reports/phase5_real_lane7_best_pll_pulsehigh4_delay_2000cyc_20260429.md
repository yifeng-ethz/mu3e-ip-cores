...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1876533 | 0 | 5604722 | 0 | 3205508204 | 3205508204 | `PASS` |
...
- Source mux selected beat delta: `3205508204`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6938872`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1876533` / dropped `0`
- Histogram last interval: `2255160` / dropped `0`
