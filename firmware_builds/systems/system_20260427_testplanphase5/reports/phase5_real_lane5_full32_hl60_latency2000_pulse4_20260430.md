...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 697532 | 0 | 5624703 | 0 | 3270541724 | 3270541724 | `PASS` |
...
- Source mux selected beat delta: `3270541724`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6960247`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `697532` / dropped `0`
- Histogram last interval: `2258639` / dropped `0`
