...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 182330 | 0 | 1365680 | 277 | 3152910162 | 3152910162 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3152910162`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `1729699`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `182330` / dropped `0`
- Histogram last interval: `550435` / dropped `0`
