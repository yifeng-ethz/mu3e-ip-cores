...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1790966 | 0 | 5280842 | 0 | 3212130124 | 3212130124 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3212130124`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6625007`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1790966` / dropped `0`
- Histogram last interval: `2125941` / dropped `0`
