...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 251283 | 0 | 1441962 | 0 | 4330573546 | 4330573546 | `PASS` |
...
- Source mux selected beat delta: `4330573546`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `1788513`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `251283` / dropped `0`
- Histogram last interval: `565765` / dropped `0`
