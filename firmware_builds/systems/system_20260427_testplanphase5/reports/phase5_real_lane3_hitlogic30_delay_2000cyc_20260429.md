...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1288043 | 0 | 3524590 | 0 | 3222802773 | 3222802773 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3222802773`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4317404`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1288043` / dropped `0`
- Histogram last interval: `1364483` / dropped `0`
