...
- Timestamp: `2026-04-30T00:37:15`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000F5`
- LVDS lane-go mask: `0x0000000A`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 810524 | 0 | 9154857 | 71088 | 3338980194 | 3338980194 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3338980194`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11385806`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `810524` / dropped `0`
- Histogram last interval: `3627518` / dropped `0`
