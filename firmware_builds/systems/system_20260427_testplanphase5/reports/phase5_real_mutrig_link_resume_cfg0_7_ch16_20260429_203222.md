...
|---:|---:|---:|---:|---:|---:|---|
| 0 | 1041548473 | 1041774043 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 1 | 1177878752 | 1181781828 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 2 | 1183166804 | 1183998277 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 3 | 1181612000 | 1181058960 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 4 | 1180181759 | 1179978696 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 5 | 1180858269 | 1179962869 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 6 | 1177332962 | 1179483303 | 0 | 0 | `0x1BC` | `aligned_idle` |
| 7 | 1181183620 | 1178481584 | 0 | 0 | `0x1BC` | `aligned_idle` |
