...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 33364 | 0 | 171878 | 0 | 3379627765 | 3379627765 | `PASS` |
...
- Source mux selected beat delta: `3379627765`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `214543`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `33364` / dropped `0`
- Histogram last interval: `66475` / dropped `0`
