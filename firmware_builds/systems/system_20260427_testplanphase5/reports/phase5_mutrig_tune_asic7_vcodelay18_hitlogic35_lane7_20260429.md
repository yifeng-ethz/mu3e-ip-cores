...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2262474 | 0 | 5971655 | 0 | 3247609324 | 3247609324 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3247609324`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7363442`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2262474` / dropped `0`
- Histogram last interval: `2359030` / dropped `0`
