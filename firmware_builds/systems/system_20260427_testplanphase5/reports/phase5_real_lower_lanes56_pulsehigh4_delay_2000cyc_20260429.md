...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 3882172 | 0 | 14402594 | 11699059 | 4327273389 | 4327273389 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `4327273389`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `13615858`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `3882172` / dropped `0`
- Histogram last interval: `3897677` / dropped `0`
