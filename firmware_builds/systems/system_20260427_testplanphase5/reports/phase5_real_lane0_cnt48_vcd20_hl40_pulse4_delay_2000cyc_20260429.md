...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 132777 | 0 | 5173925 | 0 | 3211755221 | 3211755221 | `PASS` |
...
- Source mux selected beat delta: `3211755221`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6416919`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `132777` / dropped `0`
- Histogram last interval: `2101521` / dropped `0`
