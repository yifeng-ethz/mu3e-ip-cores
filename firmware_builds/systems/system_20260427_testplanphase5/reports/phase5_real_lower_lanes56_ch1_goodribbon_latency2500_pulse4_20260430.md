...
- MTS expected latency override: `2500`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 47913 | 0 | 408786 | 0 | 3210919837 | 3210919837 | `PASS` |
...
- Debug overrides: `{'mts_expected_latency': 2500, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3210919837`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `507925`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `47913` / dropped `0`
