...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1491666 | 0 | 9427206 | 1874451 | 3309552298 | 3309552298 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3309552298`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11372473`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1491666` / dropped `0`
- Histogram last interval: `3894176` / dropped `0`
