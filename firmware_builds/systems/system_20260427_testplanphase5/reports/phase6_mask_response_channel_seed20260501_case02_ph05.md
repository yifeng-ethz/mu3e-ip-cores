...
- Real hits per lane for rate expectation: `15`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 11980920 | 0 | 136777140 | 153302936 | 14262949204 | 0 | 0 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `14262949204`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `104584207`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `3583920` / dropped `0`
- Histogram last interval: `11980920` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_mask_response_channel_seed20260501_case02_ph05.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_mask_response_channel_seed20260501_case02_ph05.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 9.194779788609594, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `12000000` / `±120000` / `-19080` hits
- Post-end clean: `yes`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x00000036` | `0x00000036` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x00000036` | `0x00000036` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044C5` | `0x000044C5` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x00000036` | `0x00000036` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032F6` | `0x000032F6` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x00004903` | `0x00004903` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x00000036` | `0x00000036` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x00000036` | `0x00000036` | 0 | 0 | 0 | 0 |
