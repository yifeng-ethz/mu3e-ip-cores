...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 14859250 | 0 | 39898636 | 36028969 | 3233269498 | 3233269498 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3233269498`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `40079631`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `14859250` / dropped `0`
- Histogram last interval: `16344948` / dropped `0`
