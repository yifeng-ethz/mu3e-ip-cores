...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 27986 | 0 | 166676 | 0 | 3315918605 | 3315918605 | `PASS` |
...
- Source mux selected beat delta: `3315918605`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `207254`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `27986` / dropped `0`
- Histogram last interval: `66609` / dropped `0`
