...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 891902 | 0 | 6063010 | 0 | 3396892830 | 3396892830 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3396892830`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7494293`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `891902` / dropped `0`
- Histogram last interval: `2343248` / dropped `0`
