...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 884 | 0 | 18827 | 0 | 3162835049 | 3162835049 | `PASS` |
...
- Source mux selected beat delta: `3162835049`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `22115`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `884` / dropped `0`
- Histogram last interval: `6232` / dropped `0`
