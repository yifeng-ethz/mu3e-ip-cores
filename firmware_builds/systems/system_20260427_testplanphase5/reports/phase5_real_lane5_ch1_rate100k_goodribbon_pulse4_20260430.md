...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 47430 | `real` | `periodic` | 1250 | 66559 | 0 | 232378 | 0 | 4225030450 | 4225030450 | `rate_out_of_tolerance` |
...
- Source mux selected beat delta: `4225030450`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `273445`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `58875` / dropped `0`
- Histogram last interval: `66559` / dropped `0`
- Rate expected/tolerance/error: `100000` / `±5000` / `-33441` hits
- Post-end clean: `yes`
