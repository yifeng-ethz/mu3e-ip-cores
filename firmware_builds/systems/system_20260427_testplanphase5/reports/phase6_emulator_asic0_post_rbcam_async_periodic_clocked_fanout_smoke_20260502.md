...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 62513 | `emulator` | `async-periodic` | 12500 | 0 | 0 | 0 | 0 | 3853430226 | n/a | n/a | `blocked_before_mts` |
...
- Pulse high cycles: `20`
- Injector mode during run: `3`
...
- Source mux selected beat delta: `3853430226`
- Emulator frame delta: `51402`
- Frame CRC delta: `0`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000001` | `0x2004101F` | `0x00006688` |
