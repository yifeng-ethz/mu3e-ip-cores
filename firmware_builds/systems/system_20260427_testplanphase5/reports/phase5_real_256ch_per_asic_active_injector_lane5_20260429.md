...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52105 | `real` | `periodic` | 1250 | 2191915 | 0 | 5697747 | 0 | 3100979267 | 3100979267 | `PASS` |
...
- Source mux selected beat delta: `3100979267`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7187173`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2191915` / dropped `0`
- Histogram last interval: `2376437` / dropped `0`
