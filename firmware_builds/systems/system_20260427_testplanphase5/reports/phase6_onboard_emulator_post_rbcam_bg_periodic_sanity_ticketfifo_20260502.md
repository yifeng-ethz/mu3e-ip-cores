...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `emulator` | `off` | 12500 | 4996071 | 0 | 57940323 | 3852806 | 0 | n/a | n/a | `ring_input_errors_with_histogram_hits` |
...
- Emulator frame delta: `506`
- Frame CRC delta: `0`
- Frame actual-hit delta: `56796541`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `1968236` / dropped `0`
- Histogram last interval: `4996071` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'rate', 'csv': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_onboard_emulator_post_rbcam_bg_periodic_sanity_ticketfifo_20260502.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/mu3e-ip-cores/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_onboard_emulator_post_rbcam_bg_periodic_sanity_ticketfifo_20260502.log', 'read_chunk_words': 1, 'read_delay_ms': 1, 'unsafe_bulk_read': False, 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.513453014194965, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±579403` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---:|---:|---:|---:|
| 0 | `0x00000001` | 1 | `0x00000007` | `0x2004101F` | `0x00004BB8` |
