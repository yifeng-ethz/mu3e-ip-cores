...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 855660 | 0 | 2256301 | 0 | 3211434379 | 3211434379 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3211434379`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2828265`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `855660` / dropped `0`
- Histogram last interval: `931822` / dropped `0`
