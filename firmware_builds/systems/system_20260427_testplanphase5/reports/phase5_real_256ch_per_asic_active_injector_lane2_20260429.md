...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 52102 | `real` | `periodic` | 1250 | 1956710 | 0 | 6612826 | 0 | 3217187768 | 3217187768 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3217187768`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `8313139`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1956710` / dropped `0`
- Histogram last interval: `2861738` / dropped `0`
