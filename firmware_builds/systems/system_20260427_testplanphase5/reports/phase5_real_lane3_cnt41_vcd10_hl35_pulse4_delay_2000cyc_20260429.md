...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 704142 | 0 | 2265788 | 0 | 3212393412 | 3212393412 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3212393412`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2823356`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `704142` / dropped `0`
- Histogram last interval: `931830` / dropped `0`
