...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 386022 | 0 | 1743266 | 0 | 4270760354 | 4270760354 | `PASS` |
...
- Source mux selected beat delta: `4270760354`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2277464`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `386022` / dropped `0`
- Histogram last interval: `698887` / dropped `0`
