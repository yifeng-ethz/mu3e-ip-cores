...
- Timestamp: `2026-05-01T17:44:45`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x000000FD`
- LVDS lane-go mask: `0x00000002`
...
- Histogram filter key value: `0x00000001`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `header` | 12500 | 1348372 | 0 | 45733152 | 0 | 13416095100 | 0 | 0 | `PASS` |
...
- Source mux selected beat delta: `13416095100`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `48322752`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1348372` / dropped `0`
- Histogram last interval: `4395616` / dropped `0`
- JTAG histogram artifact: `{'enabled': True, 'profile': 'delay-hit-t', 'csv': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_header_delay_asic1_hsync_ph05_hitdelay_20260501.csv', 'log': '/home/yifeng/packages/mu3e_ip_dev/.worktrees/mu3e_ip_cores_phase6_closure_20260430/firmware_builds/systems/system_20260427_testplanphase5/reports/phase6_header_delay_asic1_hsync_ph05_hitdelay_20260501.log', 'returncode': 0, 'timed_out': False, 'elapsed_s': 8.204932369757444, 'csv_exists': True, 'csv_line_count': 257}`
- Rate expected/tolerance/error: `0` / `±0` / `0` hits
- MTS discard/tolerance: `0` / `±457332` hits (`0.0` %)
- Post-end clean: `yes`
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | `adaptive` | 0 | `0x00000082` | `0x00000082` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x00000082` | `0x00000082` | 0 | 0 | 0 | 0 |
| 2 | 0 | `adaptive` | 0 | `0x00004511` | `0x00004511` | 0 | 0 | 0 | 0 |
| 3 | 0 | `adaptive` | 0 | `0x00000082` | `0x00000082` | 0 | 0 | 0 | 0 |
| 4 | 0 | `adaptive` | 0 | `0x00003342` | `0x00003342` | 0 | 0 | 0 | 0 |
| 5 | 0 | `adaptive` | 0 | `0x0000494F` | `0x0000494F` | 0 | 0 | 0 | 0 |
| 6 | 0 | `adaptive` | 0 | `0x00000082` | `0x00000082` | 0 | 0 | 0 | 0 |
| 7 | 0 | `adaptive` | 0 | `0x00000082` | `0x00000082` | 0 | 0 | 0 | 0 |
