...
- Real hits per lane for rate expectation: `16`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 100041 | 0 | 4523011 | 3923128 | 3290773366 | 3290773366 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3290773366`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `4546474`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `100041` / dropped `0`
- Histogram last interval: `1764096` / dropped `0`
