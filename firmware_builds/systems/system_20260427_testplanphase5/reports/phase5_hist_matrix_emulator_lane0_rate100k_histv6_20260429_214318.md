...
- Timestamp: `2026-04-29T21:43:18`
- Firmware vehicle: `top_nostp_pipe histogram v26.1.6 last-interval CSR checksum 0x13A9CC2D, emulator lane0`
- SC link: `2`
- FEB target: `7`
- Sources: `emulator`
...
|---:|---|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | `rate_100k` | `emulator` | `lane0` | `0x00000001` | `0x00000001` | `0x000001FF` | `rate` | 99842 | 100000 | -158 | 0 | 314320 | 0 | 0 | 0 | `PASS` |
