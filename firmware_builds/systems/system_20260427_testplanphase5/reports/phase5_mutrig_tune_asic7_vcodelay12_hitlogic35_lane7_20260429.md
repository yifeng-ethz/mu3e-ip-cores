...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1891451 | 0 | 5729443 | 0 | 3181520565 | 3181520565 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3181520565`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7119751`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1891451` / dropped `0`
- Histogram last interval: `2356068` / dropped `0`
