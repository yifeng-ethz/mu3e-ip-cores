...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 146755 | 0 | 909869 | 0 | 3368451556 | 3368451556 | `PASS` |
...
- Source mux selected beat delta: `3368451556`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `1142357`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `146755` / dropped `0`
- Histogram last interval: `366080` / dropped `0`
