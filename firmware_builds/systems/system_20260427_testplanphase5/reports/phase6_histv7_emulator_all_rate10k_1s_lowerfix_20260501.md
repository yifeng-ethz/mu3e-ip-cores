...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 46100 | `emulator` | `periodic` | 12500 | 79984 | 0 | 247020 | 0 | 3853154478 | n/a | n/a | `PASS` |
...
- Source mux selected beat delta: `3853154478`
- Emulator frame delta: `391330`
- Frame CRC delta: `0`
- Frame actual-hit delta: `292952`
- Histogram rate counter source: `last_interval`
- Histogram live delta: `54648` / dropped `0`
- Histogram last interval: `79984` / dropped `0`
- JTAG histogram artifact: `{'enabled': False}`
- Rate expected/tolerance/error: `80000` / `±800` / `-16` hits
- Post-end clean: `yes`
