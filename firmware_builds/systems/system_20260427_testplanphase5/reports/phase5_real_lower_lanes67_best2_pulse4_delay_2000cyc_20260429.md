...
- Timestamp: `2026-04-30T00:39:48`
- SC link: `2`
- Device: `/dev/mudaq0`
- FEB target: `7`
- Source: `real`
- Source emulator mask: `0x0000003F`
- LVDS lane-go mask: `0x000000C0`
...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 243513 | 0 | 9742885 | 12631032 | 3296747953 | 3296747953 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3296747953`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `8582452`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `243513` / dropped `0`
- Histogram last interval: `3771887` / dropped `0`
