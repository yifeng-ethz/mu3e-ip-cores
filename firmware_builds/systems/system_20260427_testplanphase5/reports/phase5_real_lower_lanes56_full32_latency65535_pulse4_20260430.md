...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 1372359 | 0 | 9762363 | 996634 | 3207227043 | 3207227043 | `ring_input_errors_with_histogram_hits` |
...
- Debug overrides: `{'mts_expected_latency': 65535, 'mts_delay_ts_field': 't', 'mts_drop_delay_error': 'off', 'ring_filter_inerr': 'on', 'mts_ctrl_written': 536870929, 'ring_ctrl_written': 17}`
- Source mux selected beat delta: `3207227043`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `11790695`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `1372359` / dropped `0`
- Histogram last interval: `3893936` / dropped `0`
