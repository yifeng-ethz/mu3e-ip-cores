...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 2500 | 426645 | 0 | 4433283 | 762608 | 3310459910 | 3310459910 | `ring_input_errors_with_histogram_hits` |
...
- Source mux selected beat delta: `3310459910`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `5289392`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `426645` / dropped `0`
- Histogram last interval: `1846683` / dropped `0`
