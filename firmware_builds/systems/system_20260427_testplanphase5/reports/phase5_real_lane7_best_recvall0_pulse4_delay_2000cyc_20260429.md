...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 20648 | 0 | 283247 | 0 | 3329356147 | 3329356147 | `PASS` |
...
- Source mux selected beat delta: `3329356147`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `353093`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `20648` / dropped `0`
- Histogram last interval: `114406` / dropped `0`
