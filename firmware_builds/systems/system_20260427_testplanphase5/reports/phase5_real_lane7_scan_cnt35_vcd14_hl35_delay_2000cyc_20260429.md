...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 716143 | 0 | 5713915 | 0 | 4424764202 | 4424764202 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `4424764202`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6997777`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `716143` / dropped `0`
- Histogram last interval: `2264678` / dropped `0`
