...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 48614 | `real` | `periodic` | 1250 | 31948741 | 0 | 370836211 | 348656023 | 14512630085 | 0 | 0 | `mts_discard_with_histogram_hits` |
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `adaptive` | 0 | `0x0000001C` | `0x0000001C` | 0 | 0 | 0 | 0 |
| 1 | 1 | `adaptive` | 0 | `0x0000001C` | `0x0000001C` | 0 | 0 | 0 | 0 |
| 2 | 1 | `adaptive` | 0 | `0x000044AB` | `0x000044AB` | 0 | 0 | 0 | 0 |
| 3 | 1 | `adaptive` | 0 | `0x0000001C` | `0x0000001C` | 0 | 0 | 0 | 0 |
| 4 | 1 | `adaptive` | 0 | `0x000032DC` | `0x000032DC` | 0 | 0 | 0 | 0 |
| 5 | 1 | `adaptive` | 0 | `0x000048E9` | `0x000048E9` | 0 | 0 | 0 | 0 |
| 6 | 1 | `adaptive` | 0 | `0x0000001C` | `0x0000001C` | 0 | 0 | 0 | 0 |
| 7 | 1 | `adaptive` | 0 | `0x0000001C` | `0x0000001C` | 0 | 0 | 0 | 0 |
