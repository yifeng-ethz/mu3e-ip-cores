...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 2260947 | 0 | 5989577 | 0 | 3268344662 | 3268344662 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3268344662`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `7433104`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `2260947` / dropped `0`
- Histogram last interval: `2268759` / dropped `0`
