...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 77888 | 0 | 2289300 | 0 | 3471234874 | 3471234874 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3471234874`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `2838162`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `77888` / dropped `0`
- Histogram last interval: `930925` / dropped `0`
