...
|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | 45000 | `real` | `periodic` | 1250 | 81136 | 0 | 5301164 | 0 | 3320583432 | 3320583432 | `mts_discard_with_histogram_hits` |
...
- Source mux selected beat delta: `3320583432`
- Emulator frame delta: `0`
- Frame CRC delta: `0`
- Frame actual-hit delta: `6578986`
- Histogram rate counter source: `live_delta`
- Histogram live delta: `81136` / dropped `0`
- Histogram last interval: `2129375` / dropped `0`
