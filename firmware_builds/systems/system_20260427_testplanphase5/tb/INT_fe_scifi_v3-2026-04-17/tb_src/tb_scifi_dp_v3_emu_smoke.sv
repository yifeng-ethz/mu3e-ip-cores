...
module tb_scifi_dp_v3_emu_smoke;
    ...
    localparam logic [4:0]  HIST_CSR_KEY_VALUE  = 5'd7;
    ...
    localparam logic [1:0] HIT_MODE_BURST   = 2'b01;
    ...
    int lane0_mux_word_count;
    int lane0_mux_k28_0_count;
    int lane0_mux_payload_word_count;
    ...
    bit                terminal_tail_check_en;
    bit                use_generated_runctl_fanout;
    bit                trace_runctl_fanout;
    bit                force_decoded_din_from_emu;
    bit                require_no_mts_errors;
    int unsigned       sync_hold_cycles;
    int unsigned       mts_error_window_cycles;
    int unsigned       measure_run_cycles;
    logic [15:0]       measure_hit_rate;
    logic [15:0]       measure_noise_rate;
    bit                measure_short_mode;
    logic [15:0]       smoke_hit_rate;
    logic [15:0]       smoke_noise_rate;
    bit                smoke_short_mode;
    int unsigned       smoke_hist_interval_clocks;
    int unsigned       smoke_min_total_hits;
    int unsigned       smoke_min_active_bins;
    int unsigned       smoke_timeout_us;
    int unsigned       smoke_poll_us;
    string             measure_report_dir;
    bit                measure_use_periodic_injector;
    int unsigned       measure_inject_mode;
    int unsigned       measure_inject_period_cycles;
    int unsigned       measure_inject_high_cycles;
    ...
    task automatic force_run_control_ready_paths;
        begin
            // Current pipe run-control input is readyless and the generated
            // top-level splitter outputs are tied ready-high in Qsys.
        end
    endtask
    ...
    task automatic force_histogram_ready_paths;
        begin
            // The current integrated datapath no longer exposes the legacy
            // histogram fill/splitter ready seams this bench used to pin.
            // The surviving histogram egress ports are already tied ready-high
            // at the wrapper boundary, so this shim is intentionally empty.
        end
    endtask
    ...
    task automatic force_datapath_local_csr_idle;
        begin
            ...
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_0_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_1_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_2_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_3_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_4_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_5_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_6_csr_writedata                   = 32'h0000_0000;

            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_backpressure_fifo_csr_address   = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_backpressure_fifo_csr_read      = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_backpressure_fifo_csr_write     = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_backpressure_fifo_csr_writedata = 32'h0000_0000;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_csr_address                     = 2'b00;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_csr_read                        = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_csr_write                       = 1'b0;
            force dut_wrap.dut.mm_interconnect_0_mutrig_datapath_subsystem_7_csr_writedata                   = 32'h0000_0000;
        end
    endtask

    task automatic force_avmm_idle_seams;
        begin
            // The active pipe image splits the old LVDS AVMM pipeline into
            // per-aperture Qsys pipelines. No global LVDS idle seam remains.
        end
    endtask
    ...
    task automatic read_emulator_local_waitrequest(
        ...
        begin
            case (lane)
                0: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_0_csr_waitrequest;
                1: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_1_csr_waitrequest;
                2: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_2_csr_waitrequest;
                3: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_3_csr_waitrequest;
                4: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_4_csr_waitrequest;
                5: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_5_csr_waitrequest;
                6: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_6_csr_waitrequest;
                7: waitrequest = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_7_csr_waitrequest;
                default: begin
                    waitrequest = 1'b1;
                    $fatal(1, "Invalid emulator lane %0d", lane);
                end
    ...
    task automatic read_emulator_local_readdata(
        ...
        begin
            case (lane)
                0: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_0_csr_readdata;
                1: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_1_csr_readdata;
                2: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_2_csr_readdata;
                3: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_3_csr_readdata;
                4: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_4_csr_readdata;
                5: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_5_csr_readdata;
                6: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_6_csr_readdata;
                7: data = dut_wrap.dut.mm_interconnect_0_emulator_mutrig_7_csr_readdata;
                default: begin
                    data = '0;
                    $fatal(1, "Invalid emulator lane %0d", lane);
                end
    ...
    task automatic force_datapath_hit1_ready_paths;
        begin
            // Bank 0 routes type1 through histogram_ingress_bridge_0 before
            // hit_stack_subsystem_0; bank 1 routes directly into
            // hit_stack_subsystem_1. Pin both seams for the mixed-language
            // image so MTS output is not blocked by X/undriven ready nets.
            force dut_wrap.dut.histogram_ingress_bridge_0_pre_out_ready = 1'b1;
            force dut_wrap.dut.mts_preprocessor_0_hit_type1_out_ready   = 1'b1;
            force dut_wrap.dut.mts_preprocessor_1_hit_type1_out_ready   = 1'b1;
            force dut_wrap.dut.hist_post_cdc_0_out_ready                = 1'b1;
        end
    endtask
    ...
    task automatic force_lvds_decode_lanes_off;
        begin
            ...
            force dut_wrap.dut.avalon_st_adapter_out_0_valid    = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_out_0_data     = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_out_0_channel  = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_out_0_error    = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_001_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_001_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_001_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_001_out_0_error   = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_002_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_002_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_002_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_002_out_0_error   = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_003_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_003_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_003_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_003_out_0_error   = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_004_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_004_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_004_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_004_out_0_error   = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_005_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_005_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_005_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_005_out_0_error   = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_006_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_006_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_006_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_006_out_0_error   = 3'b000;
            force dut_wrap.dut.avalon_st_adapter_007_out_0_valid   = 1'b0;
            force dut_wrap.dut.avalon_st_adapter_007_out_0_data    = 9'h000;
            force dut_wrap.dut.avalon_st_adapter_007_out_0_channel = 4'h0;
            force dut_wrap.dut.avalon_st_adapter_007_out_0_error   = 3'b000;
        end
    endtask
    ...
    task automatic reset_counters;
        begin
            ...
            lane0_mux_word_count     = 0;
            lane0_mux_k28_0_count    = 0;
            lane0_mux_payload_word_count = 0;
    ...
    task automatic avmm_read32_csr(
        input  logic [13:0] addr,
        output logic [31:0] data
    );
        int unsigned cycles;
            ...
            while (1'b1) begin
                ...
                if (cycles > AVMM_ACCEPT_TIMEOUT) begin
                    $display(
                        ...
                        dut_wrap.dut.rst_controller_001_reset_out_reset
                    );
                    $fatal(1, "AVMM CSR read accept timeout addr=0x%04h", addr);
                end
            end

            // The exported datapath CSR windows are plain Avalon-MM slaves
            // behind the bridge. They complete on accepted read without a
            // later readdatavalid pulse, so sample once the access is taken.
            data = avmm_readdata;
    ...
    task automatic emu_write32_local(
        ...
        begin
            ...
            while (1'b1) begin
                @(posedge clk_125);
                read_emulator_local_waitrequest(lane, waitrequest_v);
                if (waitrequest_v === 1'b0)
                    break;
                cycles++;
                if (cycles > AVMM_ACCEPT_TIMEOUT)
                    $fatal(1, "EMU local write accept timeout lane=%0d addr=0x%0h data=0x%08h", lane, addr, data);
            end
            force_emulator_local_csr_lane(lane, 4'h0, 1'b0, 1'b0, 32'h0000_0000);
            @(posedge clk_125);
        end
    ...
    task automatic trace_run_control_fanout(input string tag, input logic [8:0] state);
        begin
            if (trace_runctl_fanout) begin
                #1;
                $display(
                    "TB_RUNCTL_TRACE %s state=0x%03h src=%0b/0x%03h split1=%0b/0x%03h mts0=%0b/0x%03h split12=%0b/0x%03h mts1=%0b/0x%03h split15=%0b/0x%03h emu0=%0b/0x%03h",
                    tag,
                    state,
                    runctl_valid,
                    runctl_data,
                    dut_wrap.dut.run_control_splitter_out1_valid,
                    dut_wrap.dut.run_control_splitter_out1_data,
                    dut_wrap.dut.avalon_st_adapter_019_out_0_valid,
                    dut_wrap.dut.avalon_st_adapter_019_out_0_data,
                    dut_wrap.dut.run_control_splitter_out12_valid,
                    dut_wrap.dut.run_control_splitter_out12_data,
                    dut_wrap.dut.avalon_st_adapter_022_out_0_valid,
                    dut_wrap.dut.avalon_st_adapter_022_out_0_data,
                    dut_wrap.dut.run_control_splitter_out15_valid,
                    dut_wrap.dut.run_control_splitter_out15_data,
                    dut_wrap.dut.emulator_ctrl_splitter_out0_valid,
                    dut_wrap.dut.emulator_ctrl_splitter_out0_data
                );
            end
        end
    endtask
    ...
    task automatic send_run_state(input logic [8:0] state);
        begin
            ...
            runctl_data  <= state;
            runctl_valid <= 1'b1;
            trace_run_control_fanout("assert0", state);
            repeat (2) begin
                @(posedge clk_125);
                trace_run_control_fanout("assert", state);
            end
            runctl_valid <= 1'b0;
            @(posedge clk_125);
            trace_run_control_fanout("idle", state);
        end
    endtask
    ...
    task automatic enter_running;
        begin
            ...
            repeat (sync_hold_cycles) @(posedge clk_125);
    ...
    task automatic wait_lane_frame_count(
        input int unsigned lane,
        input int unsigned min_count,
        input int unsigned timeout_cycles
    );
        int unsigned cycles;
        begin
            cycles = 0;
            while (lane_status_frame_count(lane) < min_count) begin
                @(posedge lvds_outclock);
                cycles++;
                if (cycles > timeout_cycles)
                    $fatal(1, "Timeout waiting lane%0d frame_count >= %0d, have %0d",
                           lane, min_count, lane_status_frame_count(lane));
            end
        end
    endtask

    task automatic pulse_emulator_inject_lane(input int unsigned lane);
        begin
            case (lane)
                0: force dut_wrap.dut.emulator_mutrig_0.coe_inject_pulse = 1'b1;
                1: force dut_wrap.dut.emulator_mutrig_1.coe_inject_pulse = 1'b1;
                2: force dut_wrap.dut.emulator_mutrig_2.coe_inject_pulse = 1'b1;
                3: force dut_wrap.dut.emulator_mutrig_3.coe_inject_pulse = 1'b1;
                4: force dut_wrap.dut.emulator_mutrig_4.coe_inject_pulse = 1'b1;
                5: force dut_wrap.dut.emulator_mutrig_5.coe_inject_pulse = 1'b1;
                6: force dut_wrap.dut.emulator_mutrig_6.coe_inject_pulse = 1'b1;
                7: force dut_wrap.dut.emulator_mutrig_7.coe_inject_pulse = 1'b1;
                default: $fatal(1, "Invalid emulator lane for inject pulse: %0d", lane);
            endcase
            repeat (4) @(posedge clk_125);
            case (lane)
                0: release dut_wrap.dut.emulator_mutrig_0.coe_inject_pulse;
                1: release dut_wrap.dut.emulator_mutrig_1.coe_inject_pulse;
                2: release dut_wrap.dut.emulator_mutrig_2.coe_inject_pulse;
                3: release dut_wrap.dut.emulator_mutrig_3.coe_inject_pulse;
                4: release dut_wrap.dut.emulator_mutrig_4.coe_inject_pulse;
                5: release dut_wrap.dut.emulator_mutrig_5.coe_inject_pulse;
                6: release dut_wrap.dut.emulator_mutrig_6.coe_inject_pulse;
                7: release dut_wrap.dut.emulator_mutrig_7.coe_inject_pulse;
                default: begin end
            endcase
            repeat (4) @(posedge clk_125);
        end
    ...
    task automatic configure_injector(
        input logic [31:0] mode_word,
        input logic [31:0] pulse_interval_cycles,
        input logic [31:0] pulse_high_cycles
    );
        begin
    ...
    task automatic run_terminal_tail_check;
        int unsigned lane;
        int unsigned frames_base;
        int unsigned frames_before_term;
        int unsigned frames_after_term;
        int unsigned frames_after_idle;
        int unsigned queued_before_term;
        int unsigned type0_before_term;
        int unsigned type0_after_term;
        int unsigned ingress_before_term;
        int unsigned ingress_after_term;
        begin
            lane = 0;

            configure_emulator(lane, 16'h0000, 16'h0000, 1'b0, HIT_MODE_POISSON, 5'd31, 5'd16);
            for (int other = 1; other < 8; other++)
                emu_write32_local(other, 4'd0, 32'h0000_0000);

            reset_counters();
            enter_running();

            frames_base = lane_status_frame_count(lane);
            wait_lane_frame_count(lane, frames_base + 1, 200000);
            frames_before_term = lane_status_frame_count(lane);
            type0_before_term = dp_hit0_payload_fire_count;
            ingress_before_term = hit_stack_ingress_payload_word_count;

            pulse_emulator_inject_lane(lane);
            repeat (64) @(posedge lvds_outclock);
            queued_before_term = lane_visible_event_count(lane);

            $display(
                "TB_TERM_TAIL_PRE lane=%0d frames_before=%0d queued=%0d type0_before=%0d ingress_before=%0d",
                lane,
                frames_before_term,
                queued_before_term,
                type0_before_term,
            ...
            check("Terminal-tail test queued hits before TERMINATING", queued_before_term > 0);

            send_run_state(CTRL_TERMINATING);
            repeat (4096) @(posedge lvds_outclock);

            frames_after_term = lane_status_frame_count(lane);
            type0_after_term = dp_hit0_payload_fire_count;
            ingress_after_term = hit_stack_ingress_payload_word_count;

            $display(
                "TB_TERM_TAIL_POST lane=%0d frames_after=%0d event_count=%0d fifo_visible=%0d type0_after=%0d ingress_after=%0d clean=%0d error=%0d",
                lane,
                frames_after_term,
                lane_status_event_count(lane),
                lane_visible_event_count(lane),
                type0_after_term,
                ingress_after_term,
                hit_stack_ingress_payload_clean_word_count,
                hit_stack_ingress_payload_error_word_count
            );
            check("TERMINATING opened queued emulator tail frame", frames_after_term > frames_before_term);
            check("Terminal emulator frame carried queued events", lane_status_event_count(lane) > 0);
            check("Terminal drain emptied emulator FIFO", lane_visible_event_count(lane) == 0);
            check("Terminal tail reached frame deassembly type0", type0_after_term > type0_before_term);
            check("Terminal tail reached MTS hit-stack ingress", ingress_after_term > ingress_before_term);
            if (require_no_mts_errors)
                check("Terminal tail saw no MTS timestamp errors", hit_stack_ingress_payload_error_word_count == 0);

            send_run_state(CTRL_IDLE);
            repeat (64) @(posedge clk_125);
            frames_after_idle = lane_status_frame_count(lane);
            repeat (2000) @(posedge lvds_outclock);
            check("No idle-only emulator frames after terminal tail", lane_status_frame_count(lane) == frames_after_idle);
        end
    endtask
    ...
    task automatic hist0_ctrl_read(
        ...
        begin
            avmm_read32_csr(HIST0_CSR_CONTROL, data);
        end
    endtask
    ...
    task automatic read_hist0_status(
        ...
        begin
            avmm_read32_csr(HIST0_CSR_BANK,      bank_status);
            avmm_read32_csr(HIST0_CSR_TOTAL,     total_hits);
            avmm_read32_csr(HIST0_CSR_DROPPED,   dropped_hits);
            avmm_read32_csr(HIST0_CSR_UNDERFLOW, underflow_hits);
            avmm_read32_csr(HIST0_CSR_OVERFLOW,  overflow_hits);
        end
    endtask
    ...
    task automatic configure_hist0_local(
        input logic [31:0] interval_clocks
    );
        begin
            local_hist_csr_write(1'b1, HIST_CSR_LEFT,      32'h0000_0000);
            local_hist_csr_write(1'b1, HIST_CSR_BIN_WIDTH, 32'h0000_0001);
            local_hist_csr_write(1'b1, HIST_CSR_KEY_LOC,   32'h2828_2424);
            local_hist_csr_write(1'b1, HIST_CSR_KEY_VALUE, 32'h0000_0000);
            local_hist_csr_write(1'b1, HIST_CSR_INTERVAL,  interval_clocks);
            local_hist_csr_write(1'b1, HIST_CSR_CONTROL,   32'h0000_0101);
        end
    endtask

    task automatic wait_for_local_hist_total_at_least(
        input bit          rate_sel,
        ...
        begin
            ...
            polls  = 0;
            while (waited < timeout_window) begin
                local_hist_summary(rate_sel, n_bins, hist_total_hits, hist_active_bins, hist_min_nonzero, hist_max_nonzero, peak_bin_dummy);
                if ((hist_total_hits >= min_total) && (hist_active_bins >= min_active_bins))
                    return;
                if ((polls % 10) == 0) begin
                    $display(
                        "TB_HIST_WAIT rate_sel=%0d waited=%0t total=%0d active=%0d min_nonzero=%0d max_nonzero=%0d ext_emu=%0d type0=%0d type1=%0d hs=%0d hs_payload=%0d",
                        rate_sel,
                        waited,
                        hist_total_hits,
                        hist_active_bins,
            ...
            $display(
                "TB_HIST_TIMEOUT_DEBUG rate_sel=%0d ext_emu=%0d lane0_mux=%0d lane0_k28_0=%0d lane0_payload=%0d type0=%0d type0_payload=%0d type1=%0d hs=%0d hs_payload=%0d hs_payload_clean=%0d hs_payload_error=%0d lvds_cycle=%0d",
                rate_sel,
                ext_emu_word_count,
                lane0_mux_word_count,
                lane0_mux_k28_0_count,
                lane0_mux_payload_word_count,
                dp_hit0_word_count,
            ...
            report_emulator_status("HIST_TIMEOUT");
            $fatal(
                1,
                "Local histogram alive threshold not reached within %0t: rate_sel=%0d total=%0d active=%0d min_nonzero=%0d max_nonzero=%0d",
                timeout_window,
                rate_sel,
                hist_total_hits,
                hist_active_bins,
    ...
    task automatic wait_for_hit_stack_ingress_at_least(
        input int unsigned min_total,
        input time         timeout_window,
        input time         poll_period
    );
        ...
        begin
            ...
            polls  = 0;
            while (waited < timeout_window) begin
                if (hit_stack_ingress_payload_word_count >= min_total)
                    return;
                if ((polls % 10) == 0) begin
                    $display(
                        "TB_SMOKE_WAIT waited=%0t hs_payload=%0d hs=%0d type1=%0d type0=%0d ext_emu=%0d",
                        waited,
                        hit_stack_ingress_payload_word_count,
                        hit_stack_ingress_word_count,
                        mts_type1_word_count,
            ...
            report_emulator_status("SMOKE_WAIT_TIMEOUT");
            $display(
                "TB_SMOKE_TIMEOUT_STAGES ext_emu=%0d lane0_mux=%0d lane0_k28_0=%0d lane0_payload=%0d type0=%0d type1=%0d hs=%0d hs_payload=%0d",
                ext_emu_word_count,
                lane0_mux_word_count,
                lane0_mux_k28_0_count,
                lane0_mux_payload_word_count,
            ...
            $fatal(
                1,
                "Hit-stack ingress threshold not reached within %0t: hs_payload=%0d hs=%0d type1=%0d type0=%0d ext_emu=%0d",
                timeout_window,
                hit_stack_ingress_payload_word_count,
                hit_stack_ingress_word_count,
                mts_type1_word_count,
            ...
            for (int bank = 0; bank < 2; bank++) begin
                ...
                if (mts_output_fire(bank)) begin
                    ...
                    if (lane_from_asic_v >= 8 || mts_trace_q[lane_from_asic_v].size() == 0) begin
                        ...
                        if (mts_output_error(bank) != !((expected_delta_v > 0) && (expected_delta_v < mts_error_window_cycles)))
                        ...
                        if (trace_ts_enable
                         ...
                         && (
                             ...
                             || (mts_output_error(bank) != !((expected_delta_v > 0) && (expected_delta_v < mts_error_window_cycles)))
                            )) begin
                            trace_mismatch_print_count = trace_mismatch_print_count + 1;
                            $display(
                                ...
                                expected_delta_v,
                                mts_output_error(bank),
                                !((expected_delta_v > 0) && (expected_delta_v < mts_error_window_cycles))
                            );
                            if (trace_detail_fd != 0) begin
                                $fdisplay(
                                    trace_detail_fd,
    ...
    initial begin
        ...
        trace_runctl_fanout = $test$plusargs("TB_DP_TRACE_RUNCTL_FANOUT");
        force_decoded_din_from_emu = !$test$plusargs("TB_DP_NO_FORCE_DECODED_DIN");
        require_no_mts_errors = $test$plusargs("TB_DP_REQUIRE_NO_MTS_ERRORS");
        sync_hold_cycles    = 32;
        measure_run_cycles   = 125000000;
        measure_hit_rate     = 16'h1000;
        measure_noise_rate   = 16'h0000;
        measure_short_mode   = 1'b1;
        smoke_hit_rate       = 16'h2000;
        smoke_noise_rate     = 16'h0000;
        smoke_short_mode     = 1'b1;
        smoke_hist_interval_clocks = 1024;
        smoke_min_total_hits  = 8;
        smoke_min_active_bins = 1;
        smoke_timeout_us      = 500;
        smoke_poll_us         = 25;
        measure_report_dir   = ".";
        measure_use_periodic_injector = $test$plusargs("TB_DP_USE_PERIODIC_INJECTOR");
        measure_inject_mode           = 2;
        measure_inject_period_cycles  = 12500;
        measure_inject_high_cycles    = 5;
        trace_ts_enable      = $test$plusargs("TB_DP_TS_TRACE");
        trace_mismatch_limit = TRACE_MISMATCH_DEFAULT;
        trace_detail_fd      = 0;
        mts_error_window_cycles = 4096;
        ...
        void'($value$plusargs("TB_DP_SMOKE_HIT_RATE=%h", smoke_hit_rate));
        void'($value$plusargs("TB_DP_SMOKE_NOISE_RATE=%h", smoke_noise_rate));
        void'($value$plusargs("TB_DP_SMOKE_SHORT_MODE=%d", smoke_short_mode));
        void'($value$plusargs("TB_DP_SMOKE_HIST_INTERVAL=%d", smoke_hist_interval_clocks));
        void'($value$plusargs("TB_DP_SMOKE_MIN_TOTAL=%d", smoke_min_total_hits));
        void'($value$plusargs("TB_DP_SMOKE_MIN_ACTIVE=%d", smoke_min_active_bins));
        void'($value$plusargs("TB_DP_SMOKE_TIMEOUT_US=%d", smoke_timeout_us));
        void'($value$plusargs("TB_DP_SMOKE_POLL_US=%d", smoke_poll_us));
        void'($value$plusargs("TB_DP_REPORT_DIR=%s", measure_report_dir));
        void'($value$plusargs("TB_DP_INJECT_MODE=%d", measure_inject_mode));
        void'($value$plusargs("TB_DP_INJECT_PERIOD=%d", measure_inject_period_cycles));
        void'($value$plusargs("TB_DP_INJECT_HIGH=%d", measure_inject_high_cycles));
        void'($value$plusargs("TB_DP_SYNC_HOLD_CYCLES=%d", sync_hold_cycles));
        void'($value$plusargs("TB_DP_MTS_EXPECTED_LATENCY=%d", mts_error_window_cycles));
        ...
        if (use_generated_runctl_fanout) begin
            $display("TB_RUNCTL using generated Qsys run-control splitter/fanout");
        end else begin
        ...
        force_datapath_hit1_ready_paths();
        ...
        if (terminal_tail_check_en) begin
            ...
            if (measure_use_periodic_injector) begin
                configure_injector(
                    ...
                    measure_inject_period_cycles[31:0],
                    measure_inject_high_cycles[31:0]
                );
            end
            ...
            reset_counters();
            enter_running();
            wait_for_hit_stack_ingress_at_least(
                smoke_min_total_hits,
                smoke_timeout_us * 1us,
                smoke_poll_us * 1us
            );
            leave_running_with_drain(smoke_short_mode ? 2048 : 4096);
            flush_pre_rbcam_hist_shadow(1_000_000);
            freeze_local_hist(1'b1);
            wait_local_hist_quiescent(1'b1, 8192);
            wait_local_hist_drained(1'b1, 8192);
            local_hist_summary(1'b1, 256, hist_total_hits, hist_active_bins, hist_min_nonzero, hist_max_nonzero, rate_hist_peak_bin);
            local_hist_csr_read(1'b1, HIST_CSR_BANK, hist_bank_status);
            local_hist_read_status(1'b1, hist_ctrl_word, hist_total_status, hist_dropped_status, hist_underflow_status, hist_overflow_status);

            report_emulator_status("SMOKE");
            $display(
                "TB_SMOKE_CFG hit_rate=0x%04h noise_rate=0x%04h short_mode=%0d hist_interval=%0d min_total=%0d min_active=%0d timeout_us=%0d poll_us=%0d sync_hold_cycles=%0d",
                smoke_hit_rate,
                smoke_noise_rate,
                smoke_short_mode,
                smoke_hist_interval_clocks,
                smoke_min_total_hits,
                smoke_min_active_bins,
                smoke_timeout_us,
                smoke_poll_us,
                sync_hold_cycles
            );
            $display("TB_SMOKE ext_emu_word_count=%0d", ext_emu_word_count);
            $display("TB_SMOKE lane0_mux_word_count=%0d", lane0_mux_word_count);
            $display("TB_SMOKE lane0_mux_k28_0_count=%0d", lane0_mux_k28_0_count);
            $display("TB_SMOKE lane0_mux_payload_word_count=%0d", lane0_mux_payload_word_count);
            ...
            if (require_no_mts_errors)
                check("DP E2E saw no MTS timestamp errors", hit_stack_ingress_payload_error_word_count == 0);
            ...
            check("DP E2E histogram met active-bin threshold", hist_active_bins >= integer'(smoke_min_active_bins));
        end
