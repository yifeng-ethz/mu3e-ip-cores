...
module feb_system_v3_pipe_data_path_subsystem_mm_interconnect_0_router_002_default_decode
  #(
...
module feb_system_v3_pipe_data_path_subsystem_mm_interconnect_0_router_002
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD8 = log2ceil(64'hb000 - 64'ha000); 
    localparam PAD9 = log2ceil(64'hb800 - 64'hb000); 
    localparam PAD10 = log2ceil(64'hd080 - 64'hd000); 
    // -------------------------------------------------------
    ...
    feb_system_v3_pipe_data_path_subsystem_mm_interconnect_0_router_002_default_decode the_default_decode(
    ...
    // ( 0xa000 .. 0xb000 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 16'ha000   ) begin
            src_channel = 56'b00100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 20;
    end

    // ( 0xb000 .. 0xb800 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 16'hb000   ) begin
            src_channel = 56'b10000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 22;
    end

    // ( 0xd000 .. 0xd080 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 16'hd000   ) begin
