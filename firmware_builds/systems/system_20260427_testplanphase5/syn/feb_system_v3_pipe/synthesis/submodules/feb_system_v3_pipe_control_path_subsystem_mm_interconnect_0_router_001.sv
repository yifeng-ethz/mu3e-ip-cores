...
module feb_system_v3_pipe_control_path_subsystem_mm_interconnect_0_router_001_default_decode
  #(
...
module feb_system_v3_pipe_control_path_subsystem_mm_interconnect_0_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD3 = log2ceil(64'h14080 - 64'h14000); 
    localparam PAD4 = log2ceil(64'h15004 - 64'h15000); 
    localparam PAD5 = log2ceil(64'h16400 - 64'h16000); 
    ...
    feb_system_v3_pipe_control_path_subsystem_mm_interconnect_0_router_001_default_decode the_default_decode(
    ...
    // ( 0x3f010 .. 0x3f020 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 18'h3f010   ) begin
