...
begin
    u_core : entity work.histogram_statistics_v2_bool_core
        generic map (
            ...
            ENABLE_PINGPONG           => boolean'val(ENABLE_PINGPONG),
            ...
            SNOOP_EN                  => boolean'val(SNOOP_EN),
            ENABLE_PACKET             => boolean'val(ENABLE_PACKET),
            DEBUG                     => DEBUG
        )
        port map (
