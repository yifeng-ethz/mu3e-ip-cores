library ieee;
library full8lane_type0_system;
...
architecture rtl of feb_system is
    component full8lane_type0_system is
        port (
            cclk156_clk                           : in    std_logic                     := 'X';
            download_sc_data                      : in    std_logic_vector(31 downto 0) := (others => 'X');
            download_sc_datak                     : in    std_logic_vector(3 downto 0)  := (others => 'X');
            download_sc_ready                     : out   std_logic;
            inject_pulse                          : out   std_logic;
            inject_masked_pulse                   : out   std_logic;
            legacy_firefly_mon_waitrequest        : in    std_logic                     := 'X';
            legacy_firefly_mon_readdata           : in    std_logic_vector(31 downto 0) := (others => 'X');
            legacy_firefly_mon_readdatavalid      : in    std_logic                     := 'X';
            legacy_firefly_mon_response           : in    std_logic_vector(1 downto 0)  := (others => 'X');
            ...
            osc_clock_50_in_clk                   : in    std_logic                     := 'X';
            pulse_out_conduit_pulse               : out   std_logic;
            redriver_losn                         : in    std_logic_vector(8 downto 0)  := (others => 'X');
            reset_3_reset_n                       : in    std_logic                     := 'X';
            sense_dq_in                           : in    std_logic_vector(5 downto 0)  := (others => 'X');
            sense_dq_out                          : out   std_logic_vector(5 downto 0);
            sense_dq_oe                           : out   std_logic_vector(5 downto 0);
            serial_data                           : in    std_logic_vector(8 downto 0)  := (others => 'X');
            si_gpio_out_export                    : out   std_logic_vector(15 downto 0);
            si_status_in_export                   : in    std_logic_vector(7 downto 0)  := (others => 'X');
            to_firefly_ucc8_scl                   : inout std_logic                     := 'X';
            to_firefly_ucc8_present_n             : in    std_logic_vector(1 downto 0)  := (others => 'X');
            to_firefly_ucc8_sda                   : inout std_logic                     := 'X';
            to_firefly_ucc8_reset_n               : out   std_logic_vector(1 downto 0);
            to_firefly_ucc8_select_n              : out   std_logic_vector(1 downto 0);
            to_firefly_ucc8_int_n                 : in    std_logic_vector(1 downto 0)  := (others => 'X');
            upload_data0_sc_rc_data               : out   std_logic_vector(35 downto 0);
            upload_data0_sc_rc_valid              : out   std_logic;
            upload_data0_sc_rc_ready              : in    std_logic                     := 'X';
