...
//   output_name:        scifi_datapath_system_v3_pipe_run_control_mux
//   use_packets:        false
//   use_empty:          0
//   empty_width:        0
//   data_width:         9
...
module scifi_datapath_system_v3_pipe_run_control_mux (     
// Interface: out
...
// Interface: in0
 ...
 input [9-1: 0] in0_data,
           
// Interface: in1
 input           in1_valid,
 output reg      in1_ready,
 input [9-1: 0] in1_data,
...
/*AUTOARG*/);
   ...
   //| Signal Declarations
   // ---------------------------------------------------------------------
   reg [9 -1:0]      in0_payload;
   reg                in0_endofpacket = 0;
   reg [9 -1:0]      in1_payload;
   ...
   wire               out_valid_wire;
   wire               selected_ready;
   reg   [9 -1 :0]   selected_payload;  
   reg   [1-1:0]      counter;
   wire [1-1:0]       out_select;   
   wire [9 - 1:0]    out_payload;
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   scifi_datapath_system_v3_pipe_run_control_mux_1stage_pipeline  #( .PAYLOAD_WIDTH( 9 + 1 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module scifi_datapath_system_v3_pipe_run_control_mux_1stage_pipeline
