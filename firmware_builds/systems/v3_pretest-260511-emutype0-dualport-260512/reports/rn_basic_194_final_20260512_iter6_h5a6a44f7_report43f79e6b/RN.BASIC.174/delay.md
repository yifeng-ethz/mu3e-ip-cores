# RN.BASIC.174 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 31,250; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 62,515; expected: 31,250; delta: 100.05%

combined bank sum: 62,515; rate total: 62,515; delta: 0
