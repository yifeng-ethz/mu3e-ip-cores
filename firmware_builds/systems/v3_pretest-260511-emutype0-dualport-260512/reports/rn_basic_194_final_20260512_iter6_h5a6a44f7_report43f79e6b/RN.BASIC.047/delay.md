# RN.BASIC.047 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 732.500; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 1,466; expected: 732.500; delta: 100.14%

combined bank sum: 1,466; rate total: 1,466; delta: 0
