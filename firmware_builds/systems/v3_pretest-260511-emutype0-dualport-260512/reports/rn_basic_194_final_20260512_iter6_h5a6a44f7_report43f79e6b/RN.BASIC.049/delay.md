# RN.BASIC.049 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 3,936; expected: 1,953; delta: 101.54%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 1,953; delta: -100.00%

combined bank sum: 3,936; rate total: 3,936; delta: 0
