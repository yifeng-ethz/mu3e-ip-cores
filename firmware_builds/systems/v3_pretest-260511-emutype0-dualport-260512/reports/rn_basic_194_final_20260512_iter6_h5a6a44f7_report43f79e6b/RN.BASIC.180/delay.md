# RN.BASIC.180 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 7,812.500; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 15,637; expected: 7,812.500; delta: 100.15%

combined bank sum: 15,637; rate total: 15,637; delta: 0
