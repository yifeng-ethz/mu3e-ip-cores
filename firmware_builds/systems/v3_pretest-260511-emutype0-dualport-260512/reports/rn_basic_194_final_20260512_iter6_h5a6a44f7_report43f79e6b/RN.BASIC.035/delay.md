# RN.BASIC.035 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 23,437.500; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 46,912; expected: 23,437.500; delta: 100.16%

combined bank sum: 46,912; rate total: 46,912; delta: 0
