# RN.BASIC.132 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 1,952; expected: 1,953; delta: -0.05%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 1,952; expected: 1,953; delta: -0.05%

combined bank sum: 3,904; rate total: 3,904; delta: 0
