# RN.BASIC.074 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 1,953; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 3,920; expected: 1,953; delta: 100.72%

combined bank sum: 3,920; rate total: 3,920; delta: 0
