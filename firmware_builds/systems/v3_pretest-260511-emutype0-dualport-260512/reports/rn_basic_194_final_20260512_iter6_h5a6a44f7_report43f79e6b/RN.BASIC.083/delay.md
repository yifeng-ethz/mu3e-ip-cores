# RN.BASIC.083 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 11,744; expected: 5,859.500; delta: 100.43%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 5,859.500; delta: -100.00%

combined bank sum: 11,744; rate total: 11,744; delta: 0
