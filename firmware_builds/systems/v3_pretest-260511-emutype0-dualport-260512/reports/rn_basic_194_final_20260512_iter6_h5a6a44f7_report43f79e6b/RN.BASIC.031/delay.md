# RN.BASIC.031 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 1,467; expected: 732.500; delta: 100.27%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 732.500; delta: -100.00%

combined bank sum: 1,467; rate total: 1,467; delta: 0
