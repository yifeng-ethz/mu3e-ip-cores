# RN.BASIC.019 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 46,944; expected: 23,437.500; delta: 100.29%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 23,437.500; delta: -100.00%

combined bank sum: 46,944; rate total: 46,944; delta: 0
