# RN.BASIC.061 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 123; expected: 61; delta: 101.64%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 61; delta: -100.00%

combined bank sum: 123; rate total: 123; delta: 0
