# RN.BASIC.072 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 3,906; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 7,824; expected: 3,906; delta: 100.31%

combined bank sum: 7,824; rate total: 7,824; delta: 0
