# RN.BASIC.103 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 5,872; expected: 2,929.500; delta: 100.44%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 2,929.500; delta: -100.00%

combined bank sum: 5,872; rate total: 5,872; delta: 0
