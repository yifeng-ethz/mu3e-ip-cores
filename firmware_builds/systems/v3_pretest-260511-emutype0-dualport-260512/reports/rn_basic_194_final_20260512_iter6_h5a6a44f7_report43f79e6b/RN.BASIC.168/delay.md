# RN.BASIC.168 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 62,623; expected: 31,250; delta: 100.39%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 0; expected: 31,250; delta: -100.00%

combined bank sum: 62,623; rate total: 62,623; delta: 0
