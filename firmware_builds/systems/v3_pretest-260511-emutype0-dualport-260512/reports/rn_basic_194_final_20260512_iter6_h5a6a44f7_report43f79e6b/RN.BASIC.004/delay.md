# RN.BASIC.004 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 62,528; expected: 62,500; delta: 0.04%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 62,496; expected: 62,500; delta: -0.01%

combined bank sum: 125,024; rate total: 125,024; delta: 0
