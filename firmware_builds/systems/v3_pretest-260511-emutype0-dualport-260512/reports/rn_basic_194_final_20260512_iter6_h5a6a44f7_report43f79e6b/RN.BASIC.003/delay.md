# RN.BASIC.003 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 46,944; expected: 46,875; delta: 0.15%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 46,912; expected: 46,875; delta: 0.08%

combined bank sum: 93,856; rate total: 93,856; delta: 0
