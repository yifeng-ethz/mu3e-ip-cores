# RN.BASIC.039 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 0; expected: 11,719; delta: -100.00%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 23,456; expected: 11,719; delta: 100.15%

combined bank sum: 23,456; rate total: 23,456; delta: 0
