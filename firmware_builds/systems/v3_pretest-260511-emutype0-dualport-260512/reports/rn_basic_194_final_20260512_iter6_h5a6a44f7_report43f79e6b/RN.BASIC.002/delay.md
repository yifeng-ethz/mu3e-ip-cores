# RN.BASIC.002 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 31,264; expected: 31,250; delta: 0.04%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 31,264; expected: 31,250; delta: 0.04%

combined bank sum: 62,528; rate total: 62,528; delta: 0
