# RN.BASIC.119 rate (CSR counters)

Notes: board measured total TBD

| IP | counter | measured | sim | expected | sim_delta_pct | board_delta_pct |
|---|---|---:|---:|---:|---:|---:|
| arb_hit_type0 | SELECTED_COUNT (lane 6) | -- | 5,856 | 5,859 | -0.05% | -- |
| arb_hit_type0 | DROPPED_HITS | -- | 0 | 0 | 0.00% | -- |
| histogram_statistics_v2 | TOTAL_HITS_CSR13 | -- | 5,856 | 5,859 | -0.05% | -- |
| histogram_statistics_v2 | LAST_INTERVAL_TOTAL_HITS_CSR17 | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | feb_egress_hits | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | opq_egress_hits | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | post_rbcam_hits | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | pre_rbcam_hits | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | rdma_hits | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | source_generation_hits | -- | 5,856 | 5,859 | -0.05% | -- |
| checkpoint | swb_ingress_hits | -- | 5,856 | 5,859 | -0.05% | -- |
...
| ring_buffer_cam_rbcam_2 | push_cnt | -- | 5,856 | 1,464.750 | 299.80% | -- |
| ring_buffer_cam_rbcam_2 | pop_cnt | -- | 5,856 | 1,464.750 | 299.80% | -- |
