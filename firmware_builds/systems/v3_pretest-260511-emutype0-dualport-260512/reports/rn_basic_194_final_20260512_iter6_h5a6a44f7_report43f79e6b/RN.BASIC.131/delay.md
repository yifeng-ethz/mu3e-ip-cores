# RN.BASIC.131 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 31,232; expected: 31,250; delta: -0.06%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 31,232; expected: 31,250; delta: -0.06%

combined bank sum: 62,464; rate total: 62,464; delta: 0
