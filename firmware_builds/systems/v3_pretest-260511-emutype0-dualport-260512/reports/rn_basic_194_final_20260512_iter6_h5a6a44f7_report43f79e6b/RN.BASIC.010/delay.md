# RN.BASIC.010 delay (2 hist plot + scoreboard)

## hist bin A
![hist_bin_a](plots/hist_bin_a.pdf)
bank-A sum: 15,632; expected: 15,625; delta: 0.04%

## hist bin B
![hist_bin_b](plots/hist_bin_b.pdf)
bank-B sum: 15,632; expected: 15,625; delta: 0.04%

combined bank sum: 31,264; rate total: 31,264; delta: 0
