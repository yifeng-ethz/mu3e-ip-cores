...
package tb_int_swb_stage_pkg;
    ...
    class swb_stage_record extends uvm_sequence_item;
        ...
        function string describe();
            return $sformatf(
                "{stage=%0d lane=%0d sop=%0b eop=%0b sidecar_valid=%0b sidecar=0x%016h packet_ts_valid=%0b packet_ts=0x%012h subh=0x%02h hit_ts=0x%01h word=%0d declared=%0d seen=%0d format_error=%0b data=0x%064h t=%0t}",
