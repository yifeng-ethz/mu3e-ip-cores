// nios_altera_mm_interconnect_181_7d7plwy.v
...
`timescale 1 ps / 1 ps
module nios_altera_mm_interconnect_181_7d7plwy (
		...
		output wire [13:0] avm_sfp_slave_address,                                           //                                             avm_sfp_slave.address
		output wire        avm_sfp_slave_write,                                             //                                                          .write
		output wire        avm_sfp_slave_read,                                              //                                                          .read
		input  wire [31:0] avm_sfp_slave_readdata,                                          //                                                          .readdata
		output wire [31:0] avm_sfp_slave_writedata,                                         //                                                          .writedata
		input  wire        avm_sfp_slave_waitrequest,                                       //                                                          .waitrequest
		output wire [17:0] avm_xcvr0_slave_address,                                         //                                           avm_xcvr0_slave.address
		output wire        avm_xcvr0_slave_write,                                           //                                                          .write
		output wire        avm_xcvr0_slave_read,                                            //                                                          .read
		input  wire [31:0] avm_xcvr0_slave_readdata,                                        //                                                          .readdata
		output wire [31:0] avm_xcvr0_slave_writedata,                                       //                                                          .writedata
		input  wire        avm_xcvr0_slave_waitrequest,                                     //                                                          .waitrequest
		output wire [17:0] avm_xcvr1_slave_address,                                         //                                           avm_xcvr1_slave.address
		output wire        avm_xcvr1_slave_write,                                           //                                                          .write
		output wire        avm_xcvr1_slave_read,                                            //                                                          .read
		input  wire [31:0] avm_xcvr1_slave_readdata,                                        //                                                          .readdata
		output wire [31:0] avm_xcvr1_slave_writedata,                                       //                                                          .writedata
		input  wire        avm_xcvr1_slave_waitrequest,                                     //                                                          .waitrequest
		...
		output wire [27:0] flash_uas_address,                                               //                                                 flash_uas.address
		output wire        flash_uas_write,                                                 //                                                          .write
		output wire        flash_uas_read,                                                  //                                                          .read
		input  wire [31:0] flash_uas_readdata,                                              //                                                          .readdata
		output wire [31:0] flash_uas_writedata,                                             //                                                          .writedata
		output wire [2:0]  flash_uas_burstcount,                                            //                                                          .burstcount
		output wire [3:0]  flash_uas_byteenable,                                            //                                                          .byteenable
		input  wire        flash_uas_readdatavalid,                                         //                                                          .readdatavalid
		input  wire        flash_uas_waitrequest,                                           //                                                          .waitrequest
		output wire        flash_uas_lock,                                                  //                                                          .lock
		output wire        flash_uas_debugaccess,                                           //                                                          .debugaccess
	...
	wire  [110:0] i2c_csr_agent_rf_source_data;                                              // i2c_csr_agent:rf_source_data -> i2c_csr_agent_rsp_fifo:in_data
	...
	wire  [110:0] i2c_csr_agent_rsp_fifo_out_data;                                           // i2c_csr_agent_rsp_fifo:out_data -> i2c_csr_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> i2c_csr_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // i2c_csr_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [13:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> i2c_csr_agent:cp_channel
	...
	wire  [110:0] ram_s1_agent_rf_source_data;                                               // ram_s1_agent:rf_source_data -> ram_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] ram_s1_agent_rsp_fifo_out_data;                                            // ram_s1_agent_rsp_fifo:out_data -> ram_s1_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> ram_s1_agent:cp_data
	...
	wire  [109:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> timer_s1_agent:cp_data
	...
	wire   [31:0] timer_ts_s1_agent_m0_address;                                              // timer_ts_s1_agent:m0_address -> timer_ts_s1_translator:uav_address
	...
	wire  [110:0] timer_ts_s1_agent_rf_source_data;                                          // timer_ts_s1_agent:rf_source_data -> timer_ts_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] timer_ts_s1_agent_rsp_fifo_out_data;                                       // timer_ts_s1_agent_rsp_fifo:out_data -> timer_ts_s1_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> timer_ts_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // timer_ts_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [13:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> timer_ts_s1_agent:cp_channel
	...
	wire  [110:0] pio_s1_agent_rf_source_data;                                               // pio_s1_agent:rf_source_data -> pio_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] pio_s1_agent_rsp_fifo_out_data;                                            // pio_s1_agent_rsp_fifo:out_data -> pio_s1_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> pio_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // pio_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [13:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> pio_s1_agent:cp_channel
	...
	wire   [31:0] i2c_mask_s1_agent_m0_address;                                              // i2c_mask_s1_agent:m0_address -> i2c_mask_s1_translator:uav_address
	...
	wire  [110:0] i2c_mask_s1_agent_rf_source_data;                                          // i2c_mask_s1_agent:rf_source_data -> i2c_mask_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] i2c_mask_s1_agent_rsp_fifo_out_data;                                       // i2c_mask_s1_agent_rsp_fifo:out_data -> i2c_mask_s1_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> i2c_mask_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                     // i2c_mask_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [13:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> i2c_mask_s1_agent:cp_channel
	...
	wire   [31:0] avm_xcvr0_slave_agent_m0_readdata;                                         // avm_xcvr0_slave_translator:uav_readdata -> avm_xcvr0_slave_agent:m0_readdata
	wire          avm_xcvr0_slave_agent_m0_waitrequest;                                      // avm_xcvr0_slave_translator:uav_waitrequest -> avm_xcvr0_slave_agent:m0_waitrequest
	wire          avm_xcvr0_slave_agent_m0_debugaccess;                                      // avm_xcvr0_slave_agent:m0_debugaccess -> avm_xcvr0_slave_translator:uav_debugaccess
	wire   [31:0] avm_xcvr0_slave_agent_m0_address;                                          // avm_xcvr0_slave_agent:m0_address -> avm_xcvr0_slave_translator:uav_address
	wire    [3:0] avm_xcvr0_slave_agent_m0_byteenable;                                       // avm_xcvr0_slave_agent:m0_byteenable -> avm_xcvr0_slave_translator:uav_byteenable
	wire          avm_xcvr0_slave_agent_m0_read;                                             // avm_xcvr0_slave_agent:m0_read -> avm_xcvr0_slave_translator:uav_read
	wire          avm_xcvr0_slave_agent_m0_readdatavalid;                                    // avm_xcvr0_slave_translator:uav_readdatavalid -> avm_xcvr0_slave_agent:m0_readdatavalid
	wire          avm_xcvr0_slave_agent_m0_lock;                                             // avm_xcvr0_slave_agent:m0_lock -> avm_xcvr0_slave_translator:uav_lock
	wire   [31:0] avm_xcvr0_slave_agent_m0_writedata;                                        // avm_xcvr0_slave_agent:m0_writedata -> avm_xcvr0_slave_translator:uav_writedata
	wire          avm_xcvr0_slave_agent_m0_write;                                            // avm_xcvr0_slave_agent:m0_write -> avm_xcvr0_slave_translator:uav_write
	wire    [2:0] avm_xcvr0_slave_agent_m0_burstcount;                                       // avm_xcvr0_slave_agent:m0_burstcount -> avm_xcvr0_slave_translator:uav_burstcount
	wire          avm_xcvr0_slave_agent_rf_source_valid;                                     // avm_xcvr0_slave_agent:rf_source_valid -> avm_xcvr0_slave_agent_rsp_fifo:in_valid
	wire  [110:0] avm_xcvr0_slave_agent_rf_source_data;                                      // avm_xcvr0_slave_agent:rf_source_data -> avm_xcvr0_slave_agent_rsp_fifo:in_data
	wire          avm_xcvr0_slave_agent_rf_source_ready;                                     // avm_xcvr0_slave_agent_rsp_fifo:in_ready -> avm_xcvr0_slave_agent:rf_source_ready
	wire          avm_xcvr0_slave_agent_rf_source_startofpacket;                             // avm_xcvr0_slave_agent:rf_source_startofpacket -> avm_xcvr0_slave_agent_rsp_fifo:in_startofpacket
	wire          avm_xcvr0_slave_agent_rf_source_endofpacket;                               // avm_xcvr0_slave_agent:rf_source_endofpacket -> avm_xcvr0_slave_agent_rsp_fifo:in_endofpacket
	wire          avm_xcvr0_slave_agent_rsp_fifo_out_valid;                                  // avm_xcvr0_slave_agent_rsp_fifo:out_valid -> avm_xcvr0_slave_agent:rf_sink_valid
	wire  [110:0] avm_xcvr0_slave_agent_rsp_fifo_out_data;                                   // avm_xcvr0_slave_agent_rsp_fifo:out_data -> avm_xcvr0_slave_agent:rf_sink_data
	wire          avm_xcvr0_slave_agent_rsp_fifo_out_ready;                                  // avm_xcvr0_slave_agent:rf_sink_ready -> avm_xcvr0_slave_agent_rsp_fifo:out_ready
	wire          avm_xcvr0_slave_agent_rsp_fifo_out_startofpacket;                          // avm_xcvr0_slave_agent_rsp_fifo:out_startofpacket -> avm_xcvr0_slave_agent:rf_sink_startofpacket
	wire          avm_xcvr0_slave_agent_rsp_fifo_out_endofpacket;                            // avm_xcvr0_slave_agent_rsp_fifo:out_endofpacket -> avm_xcvr0_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> avm_xcvr0_slave_agent:cp_valid
	wire  [109:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> avm_xcvr0_slave_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // avm_xcvr0_slave_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [13:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> avm_xcvr0_slave_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> avm_xcvr0_slave_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> avm_xcvr0_slave_agent:cp_endofpacket
	wire   [31:0] avm_xcvr1_slave_agent_m0_readdata;                                         // avm_xcvr1_slave_translator:uav_readdata -> avm_xcvr1_slave_agent:m0_readdata
	wire          avm_xcvr1_slave_agent_m0_waitrequest;                                      // avm_xcvr1_slave_translator:uav_waitrequest -> avm_xcvr1_slave_agent:m0_waitrequest
	wire          avm_xcvr1_slave_agent_m0_debugaccess;                                      // avm_xcvr1_slave_agent:m0_debugaccess -> avm_xcvr1_slave_translator:uav_debugaccess
	wire   [31:0] avm_xcvr1_slave_agent_m0_address;                                          // avm_xcvr1_slave_agent:m0_address -> avm_xcvr1_slave_translator:uav_address
	wire    [3:0] avm_xcvr1_slave_agent_m0_byteenable;                                       // avm_xcvr1_slave_agent:m0_byteenable -> avm_xcvr1_slave_translator:uav_byteenable
	wire          avm_xcvr1_slave_agent_m0_read;                                             // avm_xcvr1_slave_agent:m0_read -> avm_xcvr1_slave_translator:uav_read
	wire          avm_xcvr1_slave_agent_m0_readdatavalid;                                    // avm_xcvr1_slave_translator:uav_readdatavalid -> avm_xcvr1_slave_agent:m0_readdatavalid
	wire          avm_xcvr1_slave_agent_m0_lock;                                             // avm_xcvr1_slave_agent:m0_lock -> avm_xcvr1_slave_translator:uav_lock
	wire   [31:0] avm_xcvr1_slave_agent_m0_writedata;                                        // avm_xcvr1_slave_agent:m0_writedata -> avm_xcvr1_slave_translator:uav_writedata
	wire          avm_xcvr1_slave_agent_m0_write;                                            // avm_xcvr1_slave_agent:m0_write -> avm_xcvr1_slave_translator:uav_write
	wire    [2:0] avm_xcvr1_slave_agent_m0_burstcount;                                       // avm_xcvr1_slave_agent:m0_burstcount -> avm_xcvr1_slave_translator:uav_burstcount
	wire          avm_xcvr1_slave_agent_rf_source_valid;                                     // avm_xcvr1_slave_agent:rf_source_valid -> avm_xcvr1_slave_agent_rsp_fifo:in_valid
	wire  [110:0] avm_xcvr1_slave_agent_rf_source_data;                                      // avm_xcvr1_slave_agent:rf_source_data -> avm_xcvr1_slave_agent_rsp_fifo:in_data
	wire          avm_xcvr1_slave_agent_rf_source_ready;                                     // avm_xcvr1_slave_agent_rsp_fifo:in_ready -> avm_xcvr1_slave_agent:rf_source_ready
	wire          avm_xcvr1_slave_agent_rf_source_startofpacket;                             // avm_xcvr1_slave_agent:rf_source_startofpacket -> avm_xcvr1_slave_agent_rsp_fifo:in_startofpacket
	wire          avm_xcvr1_slave_agent_rf_source_endofpacket;                               // avm_xcvr1_slave_agent:rf_source_endofpacket -> avm_xcvr1_slave_agent_rsp_fifo:in_endofpacket
	wire          avm_xcvr1_slave_agent_rsp_fifo_out_valid;                                  // avm_xcvr1_slave_agent_rsp_fifo:out_valid -> avm_xcvr1_slave_agent:rf_sink_valid
	wire  [110:0] avm_xcvr1_slave_agent_rsp_fifo_out_data;                                   // avm_xcvr1_slave_agent_rsp_fifo:out_data -> avm_xcvr1_slave_agent:rf_sink_data
	wire          avm_xcvr1_slave_agent_rsp_fifo_out_ready;                                  // avm_xcvr1_slave_agent:rf_sink_ready -> avm_xcvr1_slave_agent_rsp_fifo:out_ready
	wire          avm_xcvr1_slave_agent_rsp_fifo_out_startofpacket;                          // avm_xcvr1_slave_agent_rsp_fifo:out_startofpacket -> avm_xcvr1_slave_agent:rf_sink_startofpacket
	wire          avm_xcvr1_slave_agent_rsp_fifo_out_endofpacket;                            // avm_xcvr1_slave_agent_rsp_fifo:out_endofpacket -> avm_xcvr1_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> avm_xcvr1_slave_agent:cp_valid
	wire  [109:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> avm_xcvr1_slave_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                     // avm_xcvr1_slave_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [13:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> avm_xcvr1_slave_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> avm_xcvr1_slave_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> avm_xcvr1_slave_agent:cp_endofpacket
	wire   [31:0] avm_sfp_slave_agent_m0_readdata;                                           // avm_sfp_slave_translator:uav_readdata -> avm_sfp_slave_agent:m0_readdata
	wire          avm_sfp_slave_agent_m0_waitrequest;                                        // avm_sfp_slave_translator:uav_waitrequest -> avm_sfp_slave_agent:m0_waitrequest
	wire          avm_sfp_slave_agent_m0_debugaccess;                                        // avm_sfp_slave_agent:m0_debugaccess -> avm_sfp_slave_translator:uav_debugaccess
	wire   [31:0] avm_sfp_slave_agent_m0_address;                                            // avm_sfp_slave_agent:m0_address -> avm_sfp_slave_translator:uav_address
	wire    [3:0] avm_sfp_slave_agent_m0_byteenable;                                         // avm_sfp_slave_agent:m0_byteenable -> avm_sfp_slave_translator:uav_byteenable
	wire          avm_sfp_slave_agent_m0_read;                                               // avm_sfp_slave_agent:m0_read -> avm_sfp_slave_translator:uav_read
	wire          avm_sfp_slave_agent_m0_readdatavalid;                                      // avm_sfp_slave_translator:uav_readdatavalid -> avm_sfp_slave_agent:m0_readdatavalid
	wire          avm_sfp_slave_agent_m0_lock;                                               // avm_sfp_slave_agent:m0_lock -> avm_sfp_slave_translator:uav_lock
	wire   [31:0] avm_sfp_slave_agent_m0_writedata;                                          // avm_sfp_slave_agent:m0_writedata -> avm_sfp_slave_translator:uav_writedata
	wire          avm_sfp_slave_agent_m0_write;                                              // avm_sfp_slave_agent:m0_write -> avm_sfp_slave_translator:uav_write
	wire    [2:0] avm_sfp_slave_agent_m0_burstcount;                                         // avm_sfp_slave_agent:m0_burstcount -> avm_sfp_slave_translator:uav_burstcount
	wire          avm_sfp_slave_agent_rf_source_valid;                                       // avm_sfp_slave_agent:rf_source_valid -> avm_sfp_slave_agent_rsp_fifo:in_valid
	wire  [110:0] avm_sfp_slave_agent_rf_source_data;                                        // avm_sfp_slave_agent:rf_source_data -> avm_sfp_slave_agent_rsp_fifo:in_data
	wire          avm_sfp_slave_agent_rf_source_ready;                                       // avm_sfp_slave_agent_rsp_fifo:in_ready -> avm_sfp_slave_agent:rf_source_ready
	wire          avm_sfp_slave_agent_rf_source_startofpacket;                               // avm_sfp_slave_agent:rf_source_startofpacket -> avm_sfp_slave_agent_rsp_fifo:in_startofpacket
	wire          avm_sfp_slave_agent_rf_source_endofpacket;                                 // avm_sfp_slave_agent:rf_source_endofpacket -> avm_sfp_slave_agent_rsp_fifo:in_endofpacket
	wire          avm_sfp_slave_agent_rsp_fifo_out_valid;                                    // avm_sfp_slave_agent_rsp_fifo:out_valid -> avm_sfp_slave_agent:rf_sink_valid
	wire  [110:0] avm_sfp_slave_agent_rsp_fifo_out_data;                                     // avm_sfp_slave_agent_rsp_fifo:out_data -> avm_sfp_slave_agent:rf_sink_data
	wire          avm_sfp_slave_agent_rsp_fifo_out_ready;                                    // avm_sfp_slave_agent:rf_sink_ready -> avm_sfp_slave_agent_rsp_fifo:out_ready
	wire          avm_sfp_slave_agent_rsp_fifo_out_startofpacket;                            // avm_sfp_slave_agent_rsp_fifo:out_startofpacket -> avm_sfp_slave_agent:rf_sink_startofpacket
	wire          avm_sfp_slave_agent_rsp_fifo_out_endofpacket;                              // avm_sfp_slave_agent_rsp_fifo:out_endofpacket -> avm_sfp_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> avm_sfp_slave_agent:cp_valid
	wire  [109:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> avm_sfp_slave_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                     // avm_sfp_slave_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [13:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> avm_sfp_slave_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> avm_sfp_slave_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> avm_sfp_slave_agent:cp_endofpacket
	...
	wire  [110:0] spi_spi_control_port_agent_rf_source_data;                                 // spi_spi_control_port_agent:rf_source_data -> spi_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [110:0] spi_spi_control_port_agent_rsp_fifo_out_data;                              // spi_spi_control_port_agent_rsp_fifo:out_data -> spi_spi_control_port_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> spi_spi_control_port_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                     // spi_spi_control_port_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> spi_spi_control_port_agent:cp_channel
	...
	wire   [31:0] flash_uas_agent_m0_readdata;                                               // flash_uas_translator:uav_readdata -> flash_uas_agent:m0_readdata
	wire          flash_uas_agent_m0_waitrequest;                                            // flash_uas_translator:uav_waitrequest -> flash_uas_agent:m0_waitrequest
	wire          flash_uas_agent_m0_debugaccess;                                            // flash_uas_agent:m0_debugaccess -> flash_uas_translator:uav_debugaccess
	wire   [31:0] flash_uas_agent_m0_address;                                                // flash_uas_agent:m0_address -> flash_uas_translator:uav_address
	wire    [3:0] flash_uas_agent_m0_byteenable;                                             // flash_uas_agent:m0_byteenable -> flash_uas_translator:uav_byteenable
	wire          flash_uas_agent_m0_read;                                                   // flash_uas_agent:m0_read -> flash_uas_translator:uav_read
	wire          flash_uas_agent_m0_readdatavalid;                                          // flash_uas_translator:uav_readdatavalid -> flash_uas_agent:m0_readdatavalid
	wire          flash_uas_agent_m0_lock;                                                   // flash_uas_agent:m0_lock -> flash_uas_translator:uav_lock
	wire   [31:0] flash_uas_agent_m0_writedata;                                              // flash_uas_agent:m0_writedata -> flash_uas_translator:uav_writedata
	wire          flash_uas_agent_m0_write;                                                  // flash_uas_agent:m0_write -> flash_uas_translator:uav_write
	wire    [2:0] flash_uas_agent_m0_burstcount;                                             // flash_uas_agent:m0_burstcount -> flash_uas_translator:uav_burstcount
	wire          flash_uas_agent_rf_source_valid;                                           // flash_uas_agent:rf_source_valid -> flash_uas_agent_rsp_fifo:in_valid
	wire  [110:0] flash_uas_agent_rf_source_data;                                            // flash_uas_agent:rf_source_data -> flash_uas_agent_rsp_fifo:in_data
	wire          flash_uas_agent_rf_source_ready;                                           // flash_uas_agent_rsp_fifo:in_ready -> flash_uas_agent:rf_source_ready
	wire          flash_uas_agent_rf_source_startofpacket;                                   // flash_uas_agent:rf_source_startofpacket -> flash_uas_agent_rsp_fifo:in_startofpacket
	wire          flash_uas_agent_rf_source_endofpacket;                                     // flash_uas_agent:rf_source_endofpacket -> flash_uas_agent_rsp_fifo:in_endofpacket
	wire          flash_uas_agent_rsp_fifo_out_valid;                                        // flash_uas_agent_rsp_fifo:out_valid -> flash_uas_agent:rf_sink_valid
	wire  [110:0] flash_uas_agent_rsp_fifo_out_data;                                         // flash_uas_agent_rsp_fifo:out_data -> flash_uas_agent:rf_sink_data
	wire          flash_uas_agent_rsp_fifo_out_ready;                                        // flash_uas_agent:rf_sink_ready -> flash_uas_agent_rsp_fifo:out_ready
	wire          flash_uas_agent_rsp_fifo_out_startofpacket;                                // flash_uas_agent_rsp_fifo:out_startofpacket -> flash_uas_agent:rf_sink_startofpacket
	wire          flash_uas_agent_rsp_fifo_out_endofpacket;                                  // flash_uas_agent_rsp_fifo:out_endofpacket -> flash_uas_agent:rf_sink_endofpacket
	wire          cmd_mux_013_src_valid;                                                     // cmd_mux_013:src_valid -> flash_uas_agent:cp_valid
	wire  [109:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> flash_uas_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                     // flash_uas_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                   // cmd_mux_013:src_channel -> flash_uas_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                             // cmd_mux_013:src_startofpacket -> flash_uas_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                               // cmd_mux_013:src_endofpacket -> flash_uas_agent:cp_endofpacket
	...
	wire  [109:0] jtag_master_master_agent_cp_data;                                          // jtag_master_master_agent:cp_data -> router_002:sink_data
	...
	wire  [109:0] i2c_csr_agent_rp_data;                                                     // i2c_csr_agent:rp_data -> router_005:sink_data
	...
	wire  [109:0] ram_s1_agent_rp_data;                                                      // ram_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [109:0] timer_s1_agent_rp_data;                                                    // timer_s1_agent:rp_data -> router_008:sink_data
	...
	wire          timer_ts_s1_agent_rp_valid;                                                // timer_ts_s1_agent:rp_valid -> router_009:sink_valid
	wire  [109:0] timer_ts_s1_agent_rp_data;                                                 // timer_ts_s1_agent:rp_data -> router_009:sink_data
	wire          timer_ts_s1_agent_rp_ready;                                                // router_009:sink_ready -> timer_ts_s1_agent:rp_ready
	wire          timer_ts_s1_agent_rp_startofpacket;                                        // timer_ts_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          timer_ts_s1_agent_rp_endofpacket;                                          // timer_ts_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [109:0] pio_s1_agent_rp_data;                                                      // pio_s1_agent:rp_data -> router_010:sink_data
	...
	wire          i2c_mask_s1_agent_rp_valid;                                                // i2c_mask_s1_agent:rp_valid -> router_011:sink_valid
	wire  [109:0] i2c_mask_s1_agent_rp_data;                                                 // i2c_mask_s1_agent:rp_data -> router_011:sink_data
	wire          i2c_mask_s1_agent_rp_ready;                                                // router_011:sink_ready -> i2c_mask_s1_agent:rp_ready
	wire          i2c_mask_s1_agent_rp_startofpacket;                                        // i2c_mask_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          i2c_mask_s1_agent_rp_endofpacket;                                          // i2c_mask_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          avm_xcvr0_slave_agent_rp_valid;                                            // avm_xcvr0_slave_agent:rp_valid -> router_012:sink_valid
	wire  [109:0] avm_xcvr0_slave_agent_rp_data;                                             // avm_xcvr0_slave_agent:rp_data -> router_012:sink_data
	wire          avm_xcvr0_slave_agent_rp_ready;                                            // router_012:sink_ready -> avm_xcvr0_slave_agent:rp_ready
	wire          avm_xcvr0_slave_agent_rp_startofpacket;                                    // avm_xcvr0_slave_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          avm_xcvr0_slave_agent_rp_endofpacket;                                      // avm_xcvr0_slave_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          avm_xcvr1_slave_agent_rp_valid;                                            // avm_xcvr1_slave_agent:rp_valid -> router_013:sink_valid
	wire  [109:0] avm_xcvr1_slave_agent_rp_data;                                             // avm_xcvr1_slave_agent:rp_data -> router_013:sink_data
	wire          avm_xcvr1_slave_agent_rp_ready;                                            // router_013:sink_ready -> avm_xcvr1_slave_agent:rp_ready
	wire          avm_xcvr1_slave_agent_rp_startofpacket;                                    // avm_xcvr1_slave_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          avm_xcvr1_slave_agent_rp_endofpacket;                                      // avm_xcvr1_slave_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          avm_sfp_slave_agent_rp_valid;                                              // avm_sfp_slave_agent:rp_valid -> router_014:sink_valid
	wire  [109:0] avm_sfp_slave_agent_rp_data;                                               // avm_sfp_slave_agent:rp_data -> router_014:sink_data
	wire          avm_sfp_slave_agent_rp_ready;                                              // router_014:sink_ready -> avm_sfp_slave_agent:rp_ready
	wire          avm_sfp_slave_agent_rp_startofpacket;                                      // avm_sfp_slave_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          avm_sfp_slave_agent_rp_endofpacket;                                        // avm_sfp_slave_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire  [109:0] spi_spi_control_port_agent_rp_data;                                        // spi_spi_control_port_agent:rp_data -> router_015:sink_data
	...
	wire          flash_uas_agent_rp_valid;                                                  // flash_uas_agent:rp_valid -> router_016:sink_valid
	wire  [109:0] flash_uas_agent_rp_data;                                                   // flash_uas_agent:rp_data -> router_016:sink_data
	wire          flash_uas_agent_rp_ready;                                                  // router_016:sink_ready -> flash_uas_agent:rp_ready
	wire          flash_uas_agent_rp_startofpacket;                                          // flash_uas_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          flash_uas_agent_rp_endofpacket;                                            // flash_uas_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire  [109:0] router_002_src_data;                                                       // router_002:src_data -> jtag_master_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                      // jtag_master_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire   [13:0] router_002_src_channel;                                                    // router_002:src_channel -> jtag_master_master_limiter:cmd_sink_channel
	...
	wire  [109:0] jtag_master_master_limiter_cmd_src_data;                                   // jtag_master_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire          jtag_master_master_limiter_cmd_src_ready;                                  // cmd_demux_002:sink_ready -> jtag_master_master_limiter:cmd_src_ready
	wire   [13:0] jtag_master_master_limiter_cmd_src_channel;                                // jtag_master_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [109:0] rsp_mux_002_src_data;                                                      // rsp_mux_002:src_data -> jtag_master_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                     // jtag_master_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire   [13:0] rsp_mux_002_src_channel;                                                   // rsp_mux_002:src_channel -> jtag_master_master_limiter:rsp_sink_channel
	...
	wire   [13:0] jtag_master_master_limiter_rsp_src_channel;                                // jtag_master_master_limiter:rsp_src_channel -> jtag_master_master_agent:rp_channel
	...
	wire  [109:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_013:sink1_data
	...
	wire  [109:0] cmd_demux_002_src1_data;                                                   // cmd_demux_002:src1_data -> cmd_mux_013:sink2_data
	wire          cmd_demux_002_src1_ready;                                                  // cmd_mux_013:sink2_ready -> cmd_demux_002:src1_ready
	wire   [13:0] cmd_demux_002_src1_channel;                                                // cmd_demux_002:src1_channel -> cmd_mux_013:sink2_channel
	...
	wire  [109:0] rsp_demux_013_src1_data;                                                   // rsp_demux_013:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [109:0] rsp_demux_013_src2_data;                                                   // rsp_demux_013:src2_data -> rsp_mux_002:sink1_data
	wire          rsp_demux_013_src2_ready;                                                  // rsp_mux_002:sink1_ready -> rsp_demux_013:src2_ready
	wire   [13:0] rsp_demux_013_src2_channel;                                                // rsp_demux_013:src2_channel -> rsp_mux_002:sink1_channel
	...
	wire   [13:0] jtag_master_master_limiter_cmd_valid_data;                                 // jtag_master_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	wire          avm_xcvr0_slave_agent_rdata_fifo_src_valid;                                // avm_xcvr0_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] avm_xcvr0_slave_agent_rdata_fifo_src_data;                                 // avm_xcvr0_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          avm_xcvr0_slave_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_009:in_0_ready -> avm_xcvr0_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> avm_xcvr0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> avm_xcvr0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                         // avm_xcvr0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> avm_xcvr0_slave_agent:rdata_fifo_sink_error
	wire          avm_xcvr1_slave_agent_rdata_fifo_src_valid;                                // avm_xcvr1_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] avm_xcvr1_slave_agent_rdata_fifo_src_data;                                 // avm_xcvr1_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          avm_xcvr1_slave_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_010:in_0_ready -> avm_xcvr1_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                         // avalon_st_adapter_010:out_0_valid -> avm_xcvr1_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                          // avalon_st_adapter_010:out_0_data -> avm_xcvr1_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                         // avm_xcvr1_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                         // avalon_st_adapter_010:out_0_error -> avm_xcvr1_slave_agent:rdata_fifo_sink_error
	wire          avm_sfp_slave_agent_rdata_fifo_src_valid;                                  // avm_sfp_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] avm_sfp_slave_agent_rdata_fifo_src_data;                                   // avm_sfp_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          avm_sfp_slave_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_011:in_0_ready -> avm_sfp_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> avm_sfp_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> avm_sfp_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // avm_sfp_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> avm_sfp_slave_agent:rdata_fifo_sink_error
	...
	wire          flash_uas_agent_rdata_fifo_src_valid;                                      // flash_uas_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] flash_uas_agent_rdata_fifo_src_data;                                       // flash_uas_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          flash_uas_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_013:in_0_ready -> flash_uas_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                         // avalon_st_adapter_013:out_0_valid -> flash_uas_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                          // avalon_st_adapter_013:out_0_data -> flash_uas_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                         // flash_uas_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                         // avalon_st_adapter_013:out_0_error -> flash_uas_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) avm_xcvr0_slave_translator (
		.clk                    (clk_clk_clk),                            //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset),  //                    reset.reset
		.uav_address            (avm_xcvr0_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (avm_xcvr0_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (avm_xcvr0_slave_agent_m0_read),          //                         .read
		.uav_write              (avm_xcvr0_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (avm_xcvr0_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (avm_xcvr0_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (avm_xcvr0_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (avm_xcvr0_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (avm_xcvr0_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (avm_xcvr0_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (avm_xcvr0_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (avm_xcvr0_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (avm_xcvr0_slave_write),                  //                         .write
		.av_read                (avm_xcvr0_slave_read),                   //                         .read
		.av_readdata            (avm_xcvr0_slave_readdata),               //                         .readdata
		.av_writedata           (avm_xcvr0_slave_writedata),              //                         .writedata
		.av_waitrequest         (avm_xcvr0_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                       //              (terminated)
		.av_beginbursttransfer  (),                                       //              (terminated)
		.av_burstcount          (),                                       //              (terminated)
		.av_byteenable          (),                                       //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) avm_xcvr1_slave_translator (
		.clk                    (clk_clk_clk),                            //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset),  //                    reset.reset
		.uav_address            (avm_xcvr1_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (avm_xcvr1_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (avm_xcvr1_slave_agent_m0_read),          //                         .read
		.uav_write              (avm_xcvr1_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (avm_xcvr1_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (avm_xcvr1_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (avm_xcvr1_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (avm_xcvr1_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (avm_xcvr1_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (avm_xcvr1_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (avm_xcvr1_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (avm_xcvr1_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (avm_xcvr1_slave_write),                  //                         .write
		.av_read                (avm_xcvr1_slave_read),                   //                         .read
		.av_readdata            (avm_xcvr1_slave_readdata),               //                         .readdata
		.av_writedata           (avm_xcvr1_slave_writedata),              //                         .writedata
		.av_waitrequest         (avm_xcvr1_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                       //              (terminated)
		.av_beginbursttransfer  (),                                       //              (terminated)
		.av_burstcount          (),                                       //              (terminated)
		.av_byteenable          (),                                       //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) avm_sfp_slave_translator (
		.clk                    (clk_clk_clk),                           //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (avm_sfp_slave_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (avm_sfp_slave_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (avm_sfp_slave_agent_m0_read),           //                         .read
		.uav_write              (avm_sfp_slave_agent_m0_write),          //                         .write
		.uav_waitrequest        (avm_sfp_slave_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (avm_sfp_slave_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (avm_sfp_slave_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (avm_sfp_slave_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (avm_sfp_slave_agent_m0_writedata),      //                         .writedata
		.uav_lock               (avm_sfp_slave_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (avm_sfp_slave_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (avm_sfp_slave_address),                 //      avalon_anti_slave_0.address
		.av_write               (avm_sfp_slave_write),                   //                         .write
		.av_read                (avm_sfp_slave_read),                    //                         .read
		.av_readdata            (avm_sfp_slave_readdata),                //                         .readdata
		.av_writedata           (avm_sfp_slave_writedata),               //                         .writedata
		.av_waitrequest         (avm_sfp_slave_waitrequest),             //                         .waitrequest
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
		.av_byteenable          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) flash_uas_translator (
		.clk                    (clk_clk_clk),                           //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (flash_uas_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (flash_uas_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (flash_uas_agent_m0_read),               //                         .read
		.uav_write              (flash_uas_agent_m0_write),              //                         .write
		.uav_waitrequest        (flash_uas_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (flash_uas_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (flash_uas_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (flash_uas_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (flash_uas_agent_m0_writedata),          //                         .writedata
		.uav_lock               (flash_uas_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (flash_uas_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (flash_uas_address),                     //      avalon_anti_slave_0.address
		.av_write               (flash_uas_write),                       //                         .write
		.av_read                (flash_uas_read),                        //                         .read
		.av_readdata            (flash_uas_readdata),                    //                         .readdata
		.av_writedata           (flash_uas_writedata),                   //                         .writedata
		.av_burstcount          (flash_uas_burstcount),                  //                         .burstcount
		.av_byteenable          (flash_uas_byteenable),                  //                         .byteenable
		.av_readdatavalid       (flash_uas_readdatavalid),               //                         .readdatavalid
		.av_waitrequest         (flash_uas_waitrequest),                 //                         .waitrequest
		.av_lock                (flash_uas_lock),                        //                         .lock
		.av_debugaccess         (flash_uas_debugaccess),                 //                         .debugaccess
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_writebyteenable     (),                                      //              (terminated)
		.av_chipselect          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) avm_xcvr0_slave_agent (
		.clk                     (clk_clk_clk),                                      //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),            //       clk_reset.reset
		.m0_address              (avm_xcvr0_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (avm_xcvr0_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (avm_xcvr0_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (avm_xcvr0_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (avm_xcvr0_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (avm_xcvr0_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (avm_xcvr0_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (avm_xcvr0_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (avm_xcvr0_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (avm_xcvr0_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (avm_xcvr0_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (avm_xcvr0_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (avm_xcvr0_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (avm_xcvr0_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (avm_xcvr0_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (avm_xcvr0_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (avm_xcvr0_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (avm_xcvr0_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (avm_xcvr0_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (avm_xcvr0_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (avm_xcvr0_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (avm_xcvr0_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (avm_xcvr0_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (avm_xcvr0_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (avm_xcvr0_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (avm_xcvr0_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),                //                .error
		.rdata_fifo_src_ready    (avm_xcvr0_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avm_xcvr0_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (avm_xcvr0_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) avm_xcvr0_slave_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                      //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_data           (avm_xcvr0_slave_agent_rf_source_data),             //        in.data
		.in_valid          (avm_xcvr0_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (avm_xcvr0_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avm_xcvr0_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avm_xcvr0_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avm_xcvr0_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avm_xcvr0_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avm_xcvr0_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avm_xcvr0_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avm_xcvr0_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) avm_xcvr1_slave_agent (
		.clk                     (clk_clk_clk),                                      //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),            //       clk_reset.reset
		.m0_address              (avm_xcvr1_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (avm_xcvr1_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (avm_xcvr1_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (avm_xcvr1_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (avm_xcvr1_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (avm_xcvr1_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (avm_xcvr1_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (avm_xcvr1_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (avm_xcvr1_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (avm_xcvr1_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (avm_xcvr1_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (avm_xcvr1_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (avm_xcvr1_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (avm_xcvr1_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (avm_xcvr1_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (avm_xcvr1_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (avm_xcvr1_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (avm_xcvr1_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (avm_xcvr1_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (avm_xcvr1_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (avm_xcvr1_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (avm_xcvr1_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (avm_xcvr1_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (avm_xcvr1_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (avm_xcvr1_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (avm_xcvr1_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),                //                .error
		.rdata_fifo_src_ready    (avm_xcvr1_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avm_xcvr1_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (avm_xcvr1_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) avm_xcvr1_slave_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                      //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_data           (avm_xcvr1_slave_agent_rf_source_data),             //        in.data
		.in_valid          (avm_xcvr1_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (avm_xcvr1_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avm_xcvr1_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avm_xcvr1_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avm_xcvr1_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avm_xcvr1_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avm_xcvr1_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avm_xcvr1_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avm_xcvr1_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                    //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (avm_sfp_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (avm_sfp_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (avm_sfp_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (avm_sfp_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (avm_sfp_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (avm_sfp_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (avm_sfp_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (avm_sfp_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (avm_sfp_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (avm_sfp_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (avm_sfp_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (avm_sfp_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (avm_sfp_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (avm_sfp_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (avm_sfp_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (avm_sfp_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (avm_sfp_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (avm_sfp_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (avm_sfp_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (avm_sfp_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (avm_sfp_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (avm_sfp_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (avm_sfp_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (avm_sfp_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (avm_sfp_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (avm_sfp_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_011_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_011_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_011_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_011_out_0_error),              //                .error
		.rdata_fifo_src_ready    (avm_sfp_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avm_sfp_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (avm_sfp_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) avm_sfp_slave_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                    //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (avm_sfp_slave_agent_rf_source_data),             //        in.data
		.in_valid          (avm_sfp_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (avm_sfp_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avm_sfp_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avm_sfp_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avm_sfp_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avm_sfp_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avm_sfp_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avm_sfp_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avm_sfp_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (flash_uas_agent_m0_address),                 //              m0.address
		.m0_burstcount           (flash_uas_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (flash_uas_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (flash_uas_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (flash_uas_agent_m0_lock),                    //                .lock
		.m0_readdata             (flash_uas_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (flash_uas_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (flash_uas_agent_m0_read),                    //                .read
		.m0_waitrequest          (flash_uas_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (flash_uas_agent_m0_writedata),               //                .writedata
		.m0_write                (flash_uas_agent_m0_write),                   //                .write
		.rp_endofpacket          (flash_uas_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (flash_uas_agent_rp_ready),                   //                .ready
		.rp_valid                (flash_uas_agent_rp_valid),                   //                .valid
		.rp_data                 (flash_uas_agent_rp_data),                    //                .data
		.rp_startofpacket        (flash_uas_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (flash_uas_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (flash_uas_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (flash_uas_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (flash_uas_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (flash_uas_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (flash_uas_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (flash_uas_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (flash_uas_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (flash_uas_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (flash_uas_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_013_out_0_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_013_out_0_valid),          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_013_out_0_data),           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_013_out_0_error),          //                .error
		.rdata_fifo_src_ready    (flash_uas_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (flash_uas_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (flash_uas_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) flash_uas_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (flash_uas_agent_rf_source_data),             //        in.data
		.in_valid          (flash_uas_agent_rf_source_valid),            //          .valid
		.in_ready          (flash_uas_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (flash_uas_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (flash_uas_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (flash_uas_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (flash_uas_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (flash_uas_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (flash_uas_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (flash_uas_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	nios_altera_merlin_router_181_rqpxm2q router (
	...
	nios_altera_merlin_router_181_6bvg2fi router_001 (
	...
	nios_altera_merlin_router_181_w2xdz4a router_002 (
	...
	nios_altera_merlin_router_181_rthbsnq router_003 (
	...
	nios_altera_merlin_router_181_rthbsnq router_004 (
	...
	nios_altera_merlin_router_181_rthbsnq router_005 (
	...
	nios_altera_merlin_router_181_7ivd32q router_006 (
	...
	nios_altera_merlin_router_181_axopw5q router_007 (
	...
	nios_altera_merlin_router_181_rthbsnq router_008 (
	...
	nios_altera_merlin_router_181_rthbsnq router_009 (
	...
	nios_altera_merlin_router_181_rthbsnq router_010 (
	...
	nios_altera_merlin_router_181_rthbsnq router_011 (
	...
	nios_altera_merlin_router_181_rthbsnq router_012 (
		.sink_ready         (avm_xcvr0_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (avm_xcvr0_slave_agent_rp_valid),         //          .valid
		.sink_data          (avm_xcvr0_slave_agent_rp_data),          //          .data
		.sink_startofpacket (avm_xcvr0_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (avm_xcvr0_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_clk_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	nios_altera_merlin_router_181_rthbsnq router_013 (
		.sink_ready         (avm_xcvr1_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (avm_xcvr1_slave_agent_rp_valid),         //          .valid
		.sink_data          (avm_xcvr1_slave_agent_rp_data),          //          .data
		.sink_startofpacket (avm_xcvr1_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (avm_xcvr1_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_clk_clk),                            //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	nios_altera_merlin_router_181_rthbsnq router_014 (
		.sink_ready         (avm_sfp_slave_agent_rp_ready),          //      sink.ready
		.sink_valid         (avm_sfp_slave_agent_rp_valid),          //          .valid
		.sink_data          (avm_sfp_slave_agent_rp_data),           //          .data
		.sink_startofpacket (avm_sfp_slave_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (avm_sfp_slave_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_router_181_rthbsnq router_015 (
	...
	nios_altera_merlin_router_181_axopw5q router_016 (
		.sink_ready         (flash_uas_agent_rp_ready),              //      sink.ready
		.sink_valid         (flash_uas_agent_rp_valid),              //          .valid
		.sink_data          (flash_uas_agent_rp_data),               //          .data
		.sink_startofpacket (flash_uas_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (flash_uas_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_rkum6iq cmd_demux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_vmq5kfq cmd_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_dcba5ei cmd_demux_002 (
		.clk                (clk_clk_clk),                                                     //        clk.clk
		.reset              (jtag_master_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_zfuqegi cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_wczosyy cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_006 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_007 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_008 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_009 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_010 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_011 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_5bheg4i cmd_mux_012 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_wczosyy cmd_mux_013 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_3ghbssi rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_vmq5kfq rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_006 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_007 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_008 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_009 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_010 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_011 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_o3yyitq rsp_demux_012 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_demultiplexer_181_vmq5kfq rsp_demux_013 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_2zlkfii rsp_mux (
		.clk                  (clk_clk_clk),                           //       clk.clk
		.reset                (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_n6nwmfa rsp_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_merlin_multiplexer_181_uemmdvq rsp_mux_002 (
		.clk                 (clk_clk_clk),                                                     //       clk.clk
		.reset               (jtag_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_altera_avalon_st_adapter_181_zi7x6ka #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	nios_altera_avalon_st_adapter_181_zi7x6ka #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
		.in_0_data      (avm_xcvr0_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (avm_xcvr0_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (avm_xcvr0_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	nios_altera_avalon_st_adapter_181_zi7x6ka #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
		.in_0_data      (avm_xcvr1_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (avm_xcvr1_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (avm_xcvr1_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	nios_altera_avalon_st_adapter_181_zi7x6ka #(
		...
		.in_clk_0_clk   (clk_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (avm_sfp_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (avm_sfp_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (avm_sfp_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	nios_altera_avalon_st_adapter_181_zi7x6ka #(
		...
		.in_clk_0_clk   (clk_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (flash_uas_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (flash_uas_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (flash_uas_agent_rdata_fifo_src_ready),  //         .ready
