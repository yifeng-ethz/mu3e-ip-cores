...
module  ip_clkctrl_altclkctrl_181_4ev4gqi_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //ip_clkctrl_altclkctrl_181_4ev4gqi_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  ip_clkctrl_altclkctrl_181_4ev4gqi  (
    inclk,
    outclk);
    ...
    ip_clkctrl_altclkctrl_181_4ev4gqi_sub  ip_clkctrl_altclkctrl_181_4ev4gqi_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
