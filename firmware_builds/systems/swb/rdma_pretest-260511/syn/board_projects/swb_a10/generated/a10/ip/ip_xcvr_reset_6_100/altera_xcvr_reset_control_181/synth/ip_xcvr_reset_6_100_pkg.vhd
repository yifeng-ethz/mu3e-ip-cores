...
package ip_xcvr_reset_6_100_pkg is
	component altera_xcvr_reset_control is
		...
		port (
			...
			tx_manual          : in  std_logic_vector(5 downto 0) := (others => 'X'); -- tx_reset_mode
			rx_manual          : in  std_logic_vector(5 downto 0) := (others => 'X'); -- rx_reset_mode
			tx_digitalreset_or : in  std_logic_vector(5 downto 0) := (others => 'X'); -- tx_digitalreset_or
			rx_digitalreset_or : in  std_logic_vector(5 downto 0) := (others => 'X')  -- rx_digitalreset_or
		);
	end component altera_xcvr_reset_control;

end ip_xcvr_reset_6_100_pkg;
