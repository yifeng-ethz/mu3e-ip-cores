...
package a10_counters is
    ...
    constant SWB_SKIP_SORTER_PACKAGE_CNT      :  integer := 16#02#;
    constant SWB_EVENT_CNT                    :  integer := 16#03#;
    constant SWB_SUB_HEADER_CNT               :  integer := 16#04#;
    constant SWB_FULL_SUBHEADER_OVERFLOW      :  integer := 16#05#;
    constant SWB_SKIP_HITS_CNT                :  integer := 16#06#;
    constant SWB_SKIP_SUBHEADER_CNT           :  integer := 16#07#;
    constant SWB_FULL_TS_OVERFLOW             :  integer := 16#08#;
    constant SWB_LINK_CNT                     :  integer := 16#09#;
