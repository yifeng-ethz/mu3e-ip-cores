...
| Good-ASIC FEB frame boundary | `PASS_COUNTERS` / `OPEN_STP_ALIGNMENT` | ASIC6/lane6 zero-VCO single-channel runs at 100 kHz pass with zero MTS discards, zero ring input errors, zero histogram drops, zero frame CRC errors, and zero LVDS/DPA deltas; SignalTap captures show FEB `hit_type3` frame output with nonzero subheader/hit content, but the same 1k-sample window does not yet align the matching nonempty RBCAM `hit_type2` beat; [`../systems/system_20260427_testplanphase5/reports/phase6_frame_boundary_lane6_vco000_100k_active_vcd_summary_20260430.md`](../systems/system_20260427_testplanphase5/reports/phase6_frame_boundary_lane6_vco000_100k_active_vcd_summary_20260430.md) |
...
| P6B013 | ASIC6/lane6 zero-VCO single-channel, pulse high 4, 100 kHz, FEB boundary STP | `PASS_COUNTERS` and `OPEN_STP_ALIGNMENT`: FEB counters and type-3 frame snapshot are clean; RBCAM and frame-assembly nonempty beats still need a same-window correlation | [`../systems/system_20260427_testplanphase5/reports/phase6_frame_boundary_lane6_vco000_100k_active_inject_20260430.md`](../systems/system_20260427_testplanphase5/reports/phase6_frame_boundary_lane6_vco000_100k_active_inject_20260430.md), [`../systems/system_20260427_testplanphase5/reports/phase6_frame_boundary_lane6_vco000_100k_active_vcd_summary_20260430.md`](../systems/system_20260427_testplanphase5/reports/phase6_frame_boundary_lane6_vco000_100k_active_vcd_summary_20260430.md) |
